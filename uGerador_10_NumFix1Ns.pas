...
type
  T_F_Gerador_10_NumFix1Ns = class(TForm)
  ...
  private
    ...
    procedure AnaliseComb2de7e3de7();
    procedure AnaliseComb3de7e2de7();
...
var
  _F_Gerador_10_NumFix1Ns: T_F_Gerador_10_NumFix1Ns;
...
procedure T_F_Gerador_10_NumFix1Ns.Set_MODALIDADE(const Value: STRING);
begin
  F_MODALIDADE := Value;
end;

procedure T_F_Gerador_10_NumFix1Ns.Setvi_final1E(const Value: INTEGER);
begin
  Fvi_final1 := Value;
end;

procedure T_F_Gerador_10_NumFix1Ns.Setvi_inicial1(const Value: INTEGER);
begin
  Fvi_inicial1 := Value;
end;
...
procedure T_F_Gerador_10_NumFix1Ns.GeradosFlag(vsFlag: String);
var
    vsQuery: String;
begin
    ...
    try
        DM1.IBQ_Combinacoes.SQL.Clear;
        if vsFlag='SIM' then
            vsQuery := 'UPDATE GERADOR_RESULT_10S1NS_DEF SET FLAG_FILTRAR =''S'', FLAG_GRAVAR= ''S'';'
        else
            vsQuery := 'UPDATE GERADOR_RESULT_10S1NS_DEF SET FLAG_FILTRAR =''N'', FLAG_GRAVAR= ''N'';' ;
...
procedure T_F_Gerador_10_NumFix1Ns.FormCreate(Sender: TObject);
var
...
procedure T_F_Gerador_10_NumFix1Ns.FormActivate(Sender: TObject);
begin
      IF (SELF._MODALIDADE ='GERADOR') then
      begin
          LA_Titulo.Caption             := 'GERADOR 10 Números Fixos 1 Não Sorteado';
       //   CB_Classificacao17.ItemIndex := 0;
       //   CB_Classificacao17.Enabled := True;
      END ELSE
      BEGIN
          LA_Titulo.Caption             := 'SIMULAR a Partir de 10 Números Fixos 1 Não Sorteado';
       //   CB_Classificacao17.Enabled := True;
...
procedure T_F_Gerador_10_NumFix1Ns.FormClose(Sender: TObject;
...
procedure T_F_Gerador_10_NumFix1Ns.BBT_CloseClick(Sender: TObject);
begin
     SELF.Close;
end;
...
procedure T_F_Gerador_10_NumFix1Ns.BTN_NovaSimulacaoClick(Sender: TObject);
begin
...
procedure T_F_Gerador_10_NumFix1Ns.BTN_SairClick(Sender: TObject);
begin
     SELF.Close;
end;
...
procedure T_F_Gerador_10_NumFix1Ns.BBT_CancelarClick(Sender: TObject);
begin
    Self.GeradosFlag('NAO');
    SELF.Close;
end;
...
procedure T_F_Gerador_10_NumFix1Ns.LimparGrid_7Comb15();
var
    viContaSel1: integer;
begin
...
procedure T_F_Gerador_10_NumFix1Ns.BBT_PrepararMenuClick(Sender: TObject);
begin
...
procedure T_F_Gerador_10_NumFix1Ns.BBT_Gerar_VoltarClick(Sender: TObject);
begin
...
procedure T_F_Gerador_10_NumFix1Ns.BBT_Preparar1Click(Sender: TObject);
var
...
Begin
    ...
    DM1.IBQ_Combinacoes.SQL.Clear;
    DM1.IBQ_Combinacoes.SQL.Add('DELETE FROM GERADOR_RESULT_10S1NS_DEF')  ;
    DM1.IBQ_Combinacoes.ExecSQL;
...
procedure T_F_Gerador_10_NumFix1Ns.BBT_GerarMenuClick(Sender: TObject);
begin
...
procedure T_F_Gerador_10_NumFix1Ns.AnaliseComb2de7e3de7();
var
    viComb02de7_01, viComb02de7_02 : integer;
    viComb03de7_01, viComb03de7_02, viComb03de7_03 : integer;
    viLinhas : integer;
begin
    viLinhas := 1;
    ...
    begin
        ...
        begin
            for viComb03de7_01 := 1 to 5 do
            begin
                for viComb03de7_02 := viComb03de7_01+1 to 6 do
                begin
                    for viComb03de7_03 := viComb03de7_02+1 to 7 do
                    begin
                        STGR_Etapa01_05.Cells[0,viLinhas] := IntToStr(viLinhas);
                        STGR_Etapa01_05.Cells[2,viLinhas] := STGR_Etapa01_07a.Cells[viComb02de7_01,1];
                        STGR_Etapa01_05.Cells[3,viLinhas] := STGR_Etapa01_07a.Cells[viComb02de7_02,1];
                        STGR_Etapa01_05.Cells[4,viLinhas] := STGR_Etapa01_07b.Cells[viComb03de7_01,1];
                        STGR_Etapa01_05.Cells[5,viLinhas] := STGR_Etapa01_07b.Cells[viComb03de7_02,1];
                        STGR_Etapa01_05.Cells[6,viLinhas] := STGR_Etapa01_07b.Cells[viComb03de7_03,1];
                        viLinhas := viLinhas + 1;
                    end; // viComb02de7_02
                end; // viComb02de7_02
            end; // viComb02de7_01
    ...
    STGR_Etapa01_05.RowCount := viLinhas;
    Self.Repaint;
end;



procedure T_F_Gerador_10_NumFix1Ns.AnaliseComb3de7e2de7();
var
    viComb02de7_01, viComb02de7_02 : integer;
    viComb03de7_01, viComb03de7_02, viComb03de7_03 : integer;
    viLinhas : integer;
begin
    viLinhas := STGR_Etapa01_05.RowCount;
    //viLinhas := 1;
    for viComb03de7_01 := 1 to 5 do
    begin
        for viComb03de7_02 := viComb03de7_01+1 to 6 do
        begin
            ...
            begin
                ...
                begin
                    ...
                    begin
                        STGR_Etapa01_05.Cells[0,viLinhas] := IntToStr(viLinhas);
                        STGR_Etapa01_05.Cells[2,viLinhas] := STGR_Etapa01_07a.Cells[viComb03de7_01,1];
                        STGR_Etapa01_05.Cells[3,viLinhas] := STGR_Etapa01_07a.Cells[viComb03de7_02,1];
                        STGR_Etapa01_05.Cells[4,viLinhas] := STGR_Etapa01_07a.Cells[viComb03de7_03,1];
                        STGR_Etapa01_05.Cells[5,viLinhas] := STGR_Etapa01_07b.Cells[viComb02de7_01,1];
                        STGR_Etapa01_05.Cells[6,viLinhas] := STGR_Etapa01_07b.Cells[viComb02de7_02,1];
                        viLinhas := viLinhas + 1;
                    end; // viComb02de7_01
                end; // viComb02de7_02
            end; // viComb02de7_01
...
procedure T_F_Gerador_10_NumFix1Ns.ClassificarAnalise();
var
    viCombinacoes, viColunas, viQtd, viLinha7d :integer;
begin
    for viCombinacoes := 1 to STGR_Etapa01_05.RowCount-1 do
    begin
        ...
        begin
            viQtd := 0;
            for viColunas :=2 to 6 do
            begin
                if StrToInt(STGR_Etapa01_05.Cells[viColunas,viCombinacoes]) = StrToInt(STGR_7Duplas.Cells[2,viLinha7d]) then
                    viQtd:= viQtd +1;
                if StrToInt(STGR_Etapa01_05.Cells[viColunas,viCombinacoes]) = StrToInt(STGR_7Duplas.Cells[3,viLinha7d]) then
                    viQtd:= viQtd +1;
        ...
        if (StrTOint(STGR_7Duplas.Cells[2,0]) = 1) and (StrTOint(STGR_7Duplas.Cells[1,0])=3) then
            STGR_Etapa01_05.Cells[1,viCombinacoes] := 'True'
        else
            STGR_Etapa01_05.Cells[1,viCombinacoes] := 'False';
...
Function T_F_Gerador_10_NumFix1Ns.Conferencia15em15(viLinhasPrimeiro: Integer; viLinhasSegundo: integer): boolean;
var
...
Function T_F_Gerador_10_NumFix1Ns.Conferencia15em10(viLinhasPrimeiro: Integer; viLinhasSegundo: integer): boolean;
var
    viCombinacoes, viContarCelulas, viContar :integer;
begin
    FOR viContarCelulas := 1 TO 25 DO
...
procedure T_F_Gerador_10_NumFix1Ns.Montar15Numeros(viLinhaDeOrigem: Integer);
...
var
    viCombinacoes: integer;
    viLinhas : integer;
begin
    viLinhas:= STGR_Etapa07_15.RowCount;
    for viCombinacoes := 1 to (STGR_Etapa01_05.RowCount-1) do
    begin
        if (StrToBool(STGR_Etapa01_05.Cells[1,viCombinacoes])) then
        begin
            STGR_Etapa07_15.Cells[00,viLinhas] := IntToStr(viLInhas);
            STGR_Etapa07_15.Cells[01,viLinhas] := '+'+IntToStr(viLinhaDeOrigem);
            STGR_Etapa07_15.Cells[02,viLinhas] := STGR_Etapa01_05.Cells[2,viCombinacoes];
            STGR_Etapa07_15.Cells[03,viLinhas] := STGR_Etapa01_05.Cells[3,viCombinacoes];
            STGR_Etapa07_15.Cells[04,viLinhas] := STGR_Etapa01_05.Cells[4,viCombinacoes];
            STGR_Etapa07_15.Cells[05,viLinhas] := STGR_Etapa01_05.Cells[5,viCombinacoes];
            STGR_Etapa07_15.Cells[06,viLinhas] := STGR_Etapa01_05.Cells[6,viCombinacoes];
            STGR_Etapa07_15.Cells[07,viLinhas] := STGR_Base10.Cells[01,viLinhaDeOrigem];
            STGR_Etapa07_15.Cells[08,viLinhas] := STGR_Base10.Cells[02,viLinhaDeOrigem];
            STGR_Etapa07_15.Cells[09,viLinhas] := STGR_Base10.Cells[03,viLinhaDeOrigem];
            STGR_Etapa07_15.Cells[10,viLinhas] := STGR_Base10.Cells[04,viLinhaDeOrigem];
            STGR_Etapa07_15.Cells[11,viLinhas] := STGR_Base10.Cells[05,viLinhaDeOrigem];
            STGR_Etapa07_15.Cells[12,viLinhas] := STGR_Base10.Cells[06,viLinhaDeOrigem];
            STGR_Etapa07_15.Cells[13,viLinhas] := STGR_Base10.Cells[07,viLinhaDeOrigem];
            STGR_Etapa07_15.Cells[14,viLinhas] := STGR_Base10.Cells[08,viLinhaDeOrigem];
            STGR_Etapa07_15.Cells[15,viLinhas] := STGR_Base10.Cells[09,viLinhaDeOrigem];
            STGR_Etapa07_15.Cells[16,viLinhas] := STGR_Base10.Cells[10,viLinhaDeOrigem];
...
PROCEDURE T_F_Gerador_10_NumFix1Ns.PR_ORDENAR_15 (viLinhas9: INTEGER);
var
...
PROCEDURE T_F_Gerador_10_NumFix1Ns.PR_Gravar_Dados_15 (vcNomeTabela : String);
VAR
...
procedure T_F_Gerador_10_NumFix1Ns.BBT_Etapa01Click(Sender: TObject);
var
...
begin
    ...
    PA_Gerar.Repaint;
     ...
     DM1.IBQ_Combinacoes.SQL.Clear;
     DM1.IBQ_Combinacoes.SQL.Add('DELETE FROM GERADOR_RESULT_10S1NS_102DEF_F')  ;
     DM1.IBQ_Combinacoes.ExecSQL;
     DM1.IBQ_Combinacoes.SQL.Clear;
     DM1.IBQ_Combinacoes.SQL.Add('insert INTO GERADOR_RESULT_10S1NS_DEF (FLAG_FILTRAR,FLAG_GRAVAR) values (''N'',''N'');')  ;
     DM1.IBQ_Combinacoes.ExecSQL;
     DM1.IBQ_Combinacoes.SQL.Clear;
     Self.GeradosFlag('NAO');
    STGR_Etapa01_05.ColWidths [0] := 50 ;
    ...
    begin
        ...
        begin
            ...
            Self.AnaliseComb2de7e3de7();
            Self.AnaliseComb3de7e2de7();
    ...
    try
        PR_Gravar_Dados_15 (' GERADOR_RESULT_10S1NS_102DEF_F ');
    except
        //
    end;
    SELF.WindowState := wsMinimized ;
    ...
    SELF.Repaint;
            ...
            DM1.IBQ_Combinacoes.SQL.Clear;
            DM1.IBQ_Combinacoes.SQL.Add('SELECT count(DISTINCT(DADOS)) as QTD FROM GERADOR_RESULT_10S1NS_102DEF_F;')  ;
            DM1.IBQ_Combinacoes.Prepare;
            DM1.IBQ_Combinacoes.Open;
    ...
    DM1.IBQ_Combinacoes.SQL.Clear;
    DM1.IBQ_Combinacoes.SQL.Add('UPDATE GERADOR_RESULT_10S1NS_DEF SET HORA_TERMINO ='''+FORMATDATETIME('h:n:s',time())+
                ''', MODO= '' Definição:'   +cb_InicioFimContador.Text+ 
                ''', QTD_DADOS= ''' +LA_rTOTAL_Comb.Caption+ ''';')  ;
    DM1.IBQ_Combinacoes.ExecSQL;

    DM1.IBQ_Combinacoes.SQL.Clear;
    DM1.IBQ_Combinacoes.SQL.Add('SELECT count(distinct(dados)) as quantidade FROM GERADOR_RESULT_10S1NS_102DEF_F  where tipo =''.8i/7p''') ;
    DM1.IBQ_Combinacoes.Prepare;
    DM1.IBQ_Combinacoes.Open;
            try
               DM1.IBQ_Combinacoes.SQL.Clear;
               vsQuery := 'UPDATE GERADOR_RESULT_10S1NS_DEF SET FIXOS_01= ''' + ED_Fixos01.Text  + #39 +
...
procedure T_F_Gerador_10_NumFix1Ns.BTN_ReajustarClick(Sender: TObject);
begin
     SCBX_Gabarito.Visible := TRUE;
     SCBX_Gabarito.Enabled := TRUE;
     PA_Resultado.Visible := TRUE;
...
procedure T_F_Gerador_10_NumFix1Ns.BBT_CARREGARClick(Sender: TObject);
begin
...
procedure T_F_Gerador_10_NumFix1Ns.BBT_VoltarClick(Sender: TObject);
begin
     PA_Gerar.Enabled := false;
     PA_Gerar.Left := 4500;    ;
     PA_Gerar.Repaint;
...
procedure T_F_Gerador_10_NumFix1Ns.BBT_BlocoNotasClick(Sender: TObject);
var
    viContar : INTEGER;
    vsCombinacoes2 : string;
begin
    GerarBlocoNotas1('GERADOR_RESULT_10S1NS_102DEF_F','GERADOR 10 Numeros Fixos 1 Nao Sorteado 5i10p','.5Ímpares e 10Pares.','.5i/10p');
    GerarBlocoNotas1('GERADOR_RESULT_10S1NS_102DEF_F','GERADOR 10 Numeros Fixos 1 Nao Sorteado 6i9p','.6Ímpares e 9Pares.','.6i/9p');
        GerarBlocoNotas1('GERADOR_RESULT_10S1NS_102DEF_F','GERADOR 10 Numeros Fixos 1 Nao Sorteado 7i8p', '.7Ímpares e 8Pares .','.8i/7p');
        GerarBlocoNotas1('GERADOR_RESULT_10S1NS_102DEF_F','GERADOR 10 Numeros Fixos 1 Nao Sorteado 8i7p',' - 8Ímpares e 7Pares .','.7i/8p') ;
        GerarBlocoNotas1('GERADOR_RESULT_10S1NS_102DEF_F','GERADOR 10 Numeros Fixos 1 Nao Sorteado 9i6p',' - 9Ímpares e 6Pares .','.9i/6p') ;
        GerarBlocoNotas1('GERADOR_RESULT_10S1NS_102DEF_F','GERADOR 10 Numeros Fixos 1 Nao Sorteado 10i5p',' - 10Ímpares e 5Pares .','.10i/5p') ;        
    SHOWMESSAGE('BLOCO DE NOTAS GERADO');
end;


procedure T_F_Gerador_10_NumFix1Ns.GerarBlocoNotas1(vcNomeTabela, vcTitulo, vcSubTitulo, vcTipo: string);
var
...
procedure T_F_Gerador_10_NumFix1Ns.btn_CarregarClick(Sender: TObject);
begin
      Self.GeradosFlag('SIM');
     SHOWMESSAGE('OK');
     SELF.Close;
...
procedure T_F_Gerador_10_NumFix1Ns.BBT_OKClick(Sender: TObject);
begin
    PGBR_Etapa_01.Position :=0 ;
    BBT_Etapa01.Click;
end;
...
procedure T_F_Gerador_10_NumFix1Ns.BBT_RemoveuRepetidosClick(
  Sender: TObject);
begin
     PA_RemoveuRepetidos.Left := 5000;
     BBT_PrepararMenu.Enabled := false;
...
procedure T_F_Gerador_10_NumFix1Ns.ED_Fixos02Change(
  Sender: TObject);
begin
    try
...
procedure T_F_Gerador_10_NumFix1Ns.ED_Fixos01Change(
  Sender: TObject);
begin
    try
...
procedure T_F_Gerador_10_NumFix1Ns.ED_Fixos03Change(Sender: TObject);
begin
    try
...
procedure T_F_Gerador_10_NumFix1Ns.ED_Fixos01ExcChange(Sender: TObject);
begin
    try
...
procedure T_F_Gerador_10_NumFix1Ns.ED_Fixos02ExcChange(Sender: TObject);
begin
    try
...
procedure T_F_Gerador_10_NumFix1Ns.ED_Fixos03ExcChange(Sender: TObject);
begin
    try
