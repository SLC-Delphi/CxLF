...
type
  T_F_SIM_01_FILTRO_05 = class(TForm)
    PA_TOPO: TPanel;
    BBT_CLOSE: TImage;
    Label34: TLabel;
    PA_GABARITO: TPanel;
    ...
    Label15: TLabel;
    LA_LINHA5_Comb6_1: TLabel;
    STGR_LINHA_5_Comb6_1: TStringGrid;
    LA_LINHA5_Comb5_1: TLabel;
    STGR_LINHA_5_Comb5_1: TStringGrid;
    Label19: TLabel;
    Label18: TLabel;
    LA_LINHA5_Comb4_1: TLabel;
    STGR_LINHA_5_Comb4_1: TStringGrid;
    STGR_LINHA_5_Comb8_3: TStringGrid;
    LA_LINHA5_Comb8_3: TLabel;
    Label22: TLabel;
...
var
  _F_SIM_01_FILTRO_05: T_F_SIM_01_FILTRO_05;
...
procedure T_F_SIM_01_FILTRO_05.BBT_CLICK_TUDOClick(Sender: TObject);
begin
     BBT_701.Click;
     BBT_706.Click;
     BBT_711.Click;
...
procedure T_F_SIM_01_FILTRO_05.FormCreate(Sender: TObject);
VAR
    VI_CONTAR : INTEGER;
begin
...
//     PA_EXCLUIDOS.Visible := TRUE;
  //   PA_EXCLUIDOS.Enabled := TRUE;
    // PA_EXCLUIDOS.SetFocus;
            ...
            SELF.IBQ_COMBINACOES.SQL.Add('UPDATE FILTRO_05_DEFINICAO SET FLAG_FILTRAR =''N'', FLAG_GRAVAR= ''N'';')  ;
...
procedure T_F_SIM_01_FILTRO_05.BBT_CLOSEClick(Sender: TObject);
begin
     SELF.Close;
end;
...
procedure T_F_SIM_01_FILTRO_05.BBT_701Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(1);
    BBT_701.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_05.BBT_702Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(2);
    BBT_702.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_05.BBT_703Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(3);
    BBT_703.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_05.BBT_704Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(4);
    BBT_704.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_05.BBT_705Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(5);
    BBT_705.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_05.BBT_706Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(6);
    BBT_706.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_05.BBT_707Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(7);
    BBT_707.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_05.BBT_708Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(8);
    BBT_708.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_05.BBT_710Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(10);
    BBT_710.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_05.BBT_709Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(9);
    BBT_709.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_05.BBT_711Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(11);
    BBT_711.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_05.BBT_712Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(12);
    BBT_712.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_05.BBT_713Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(13);
    BBT_713.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_05.BBT_714Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(14);
    BBT_714.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_05.BBT_715Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(15);
    BBT_715.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_05.BBT_716Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(16);
    BBT_716.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_05.BBT_717Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(17);
    BBT_717.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_05.BBT_718Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(18);
    BBT_718.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_05.BBT_719Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(19);
    BBT_719.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_05.BBT_720Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(20);
    BBT_720.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_05.BBT_721Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(21);
    BBT_721.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_05.BBT_722Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(22);
    BBT_722.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_05.BBT_723Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(23);
    BBT_723.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_05.BBT_724Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(24);
    BBT_724.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_05.BBT_725Click(Sender: TObject);
begin
...
PROCEDURE T_F_SIM_01_FILTRO_05.PR_BOTOES_MODELO_12345 (VI_NUMERO: INTEGER);
VAR
...
procedure T_F_SIM_01_FILTRO_05.BBT_RECOMECARClick(Sender: TObject);
VAR
    VI_CONTAR : INTEGER;
begin
...
procedure T_F_SIM_01_FILTRO_05.BBT_PREPARARClick(Sender: TObject);
var
     ...
     VSI_QTD1, VSI_QTD2, VSI_QTD3 : SMALLINT;
begin
     PA_PREPARAR_MENU.Enabled := false;
     PA_PREPARAR_MENU.Left := 4500;
     ...
     BEGIN
          CASE CB_MODO_LINHA4.ItemIndex OF
               0:
               BEGIN
                    IF (STGR_LINHA_4_C1.Cells[2,VI_COMBINACOES01] = '1') OR (STGR_LINHA_4_C1.Cells[2,VI_COMBINACOES01] = '4')
                    THEN
                              STGR_LINHA_4_C1.Cells[1,VI_COMBINACOES01] := 'F';
               END;
               1:
               BEGIN
                    IF (STGR_LINHA_4_C1.Cells[2,VI_COMBINACOES01] = '1')
                    THEN
                              STGR_LINHA_4_C1.Cells[1,VI_COMBINACOES01] := 'F';
               END;
               2:
               BEGIN
                    IF (STGR_LINHA_4_C1.Cells[2,VI_COMBINACOES01] = '4')
                    THEN
                              STGR_LINHA_4_C1.Cells[1,VI_COMBINACOES01] := 'F';
               END;
               3:
               BEGIN
                    IF (STGR_LINHA_4_C1.Cells[2,VI_COMBINACOES01] = '3')
                    THEN
                              STGR_LINHA_4_C1.Cells[1,VI_COMBINACOES01] := 'F';
               END;
               ...
               4:
               BEGIN
                    IF (STGR_LINHA_4_C1.Cells[2,VI_COMBINACOES01] = '2')
                    THEN
                              STGR_LINHA_4_C1.Cells[1,VI_COMBINACOES01] := 'F';
               END;
               5:
               BEGIN
                    IF (STGR_LINHA_4_C1.Cells[2,VI_COMBINACOES01] = '2') OR (STGR_LINHA_4_C1.Cells[2,VI_COMBINACOES01] = '3')
                    THEN
                              STGR_LINHA_4_C1.Cells[1,VI_COMBINACOES01] := 'F';
               END;
          END; // CASE
               ...
               BEGIN
                    ...
                    BEGIN
                       ...
                       //  VI_CNTCELULAS := 1; // UTILIZADO COMO FLAG PARA A LINHA 4
                         ...
                         END;
                         IF (STRtoINT(STGR_LINHA_1_C1.Cells[1,VI_COMBINACOES01])=1) THEN
                              VSI_QTD1:= VSI_QTD1 + 1;
                         IF (STRtoINT(STGR_LINHA_1_C1.Cells[1,VI_COMBINACOES01])=2) THEN
                              VSI_QTD2:= VSI_QTD2 + 1;
                         IF (STRtoINT(STGR_LINHA_1_C1.Cells[1,VI_COMBINACOES01])=3) THEN
                              VSI_QTD3:= VSI_QTD3 + 1;
                         ...
                         END;
                         IF (STRtoINT(STGR_LINHA_2_C1.Cells[1,VI_COMBINACOES02])=1) THEN
                              VSI_QTD1:= VSI_QTD1 + 1;
                         IF (STRtoINT(STGR_LINHA_2_C1.Cells[1,VI_COMBINACOES02])=2) THEN
                              VSI_QTD2:= VSI_QTD2 + 1;
                         IF (STRtoINT(STGR_LINHA_2_C1.Cells[1,VI_COMBINACOES02])=3) THEN
                              VSI_QTD3:= VSI_QTD3 + 1;
                         ...
                         END;
                         IF  (STRtoINT(STGR_LINHA_3_C1.Cells[1,VI_COMBINACOES03]) =1) THEN
                              VSI_QTD1:= VSI_QTD1 + 1;
                         IF  (STRtoINT(STGR_LINHA_3_C1.Cells[1,VI_COMBINACOES03]) =2) THEN
                              VSI_QTD2:= VSI_QTD2 + 1;
                         IF  (STRtoINT(STGR_LINHA_3_C1.Cells[1,VI_COMBINACOES03]) =3) THEN
                              VSI_QTD3:= VSI_QTD3 + 1;
                         ...
                         END;// FOR VI_CONTAR
                         IF (STRtoINT(STGR_LINHA_4_C1.Cells[2,VI_COMBINACOES04]) =1) THEN
                              VSI_QTD1:= VSI_QTD1 + 1;
                         IF (STRtoINT(STGR_LINHA_4_C1.Cells[2,VI_COMBINACOES04]) =2) THEN
                              VSI_QTD2:= VSI_QTD2 + 1;
                         IF (STRtoINT(STGR_LINHA_4_C1.Cells[2,VI_COMBINACOES04]) =3) THEN
                              VSI_QTD3:= VSI_QTD3 + 1;

                         STGR_LINHA_1234_TODOS.Cells[16,VI_LINHAS2] := INTtoSTR(VSI_QTD1);
                         STGR_LINHA_1234_TODOS.Cells[17,VI_LINHAS2] := INTtoSTR(VSI_QTD2);
                         STGR_LINHA_1234_TODOS.Cells[18,VI_LINHAS2] := INTtoSTR(VSI_QTD3);
          ...
          BEGIN
               ...
               BEGIN
                    IF  (STRtoINT(STGR_LINHA_1234_TODOS.Cells[3,VI_COMBINACOES01]) = STRtoINT(ED_EXC_01.Text)) OR
                        ...
                        (STRtoINT(STGR_LINHA_1234_TODOS.Cells[11,VI_COMBINACOES01]) = STRtoINT(ED_EXC_01.Text)) OR
                        (STRtoINT(STGR_LINHA_1234_TODOS.Cells[12,VI_COMBINACOES01]) = STRtoINT(ED_EXC_01.Text)) OR
                        (STRtoINT(STGR_LINHA_1234_TODOS.Cells[13,VI_COMBINACOES01]) = STRtoINT(ED_EXC_01.Text)) OR
                        (STRtoINT(STGR_LINHA_1234_TODOS.Cells[14,VI_COMBINACOES01]) = STRtoINT(ED_EXC_01.Text))
                        THEN
                    BEGIN
          ...
          BEGIN
               ...
               BEGIN
                    IF  (STRtoINT(STGR_LINHA_1234_TODOS.Cells[3,VI_COMBINACOES01]) = STRtoINT(ED_EXC_02.Text)) OR
                        ...
                        (STRtoINT(STGR_LINHA_1234_TODOS.Cells[11,VI_COMBINACOES01]) = STRtoINT(ED_EXC_02.Text)) OR
                        (STRtoINT(STGR_LINHA_1234_TODOS.Cells[12,VI_COMBINACOES01]) = STRtoINT(ED_EXC_02.Text)) OR
                        (STRtoINT(STGR_LINHA_1234_TODOS.Cells[13,VI_COMBINACOES01]) = STRtoINT(ED_EXC_02.Text)) OR
                        (STRtoINT(STGR_LINHA_1234_TODOS.Cells[14,VI_COMBINACOES01]) = STRtoINT(ED_EXC_02.Text))
                        THEN
                    BEGIN
                        STGR_LINHA_1234_TODOS.Cells [1,VI_COMBINACOES01] := 'F';
                    END; // if (STGR_LINHA_1_TODOS.Cells[1,VI_CONTAR]
          ...
          BEGIN
               ...
               BEGIN
                    IF  (STRtoINT(STGR_LINHA_1234_TODOS.Cells[3,VI_COMBINACOES01]) = STRtoINT(ED_EXC_03.Text)) OR
                        ...
                        (STRtoINT(STGR_LINHA_1234_TODOS.Cells[11,VI_COMBINACOES01]) = STRtoINT(ED_EXC_03.Text)) OR
                        (STRtoINT(STGR_LINHA_1234_TODOS.Cells[12,VI_COMBINACOES01]) = STRtoINT(ED_EXC_03.Text)) OR
                        (STRtoINT(STGR_LINHA_1234_TODOS.Cells[13,VI_COMBINACOES01]) = STRtoINT(ED_EXC_03.Text)) OR
                        (STRtoINT(STGR_LINHA_1234_TODOS.Cells[14,VI_COMBINACOES01]) = STRtoINT(ED_EXC_03.Text))
                        THEN
                    BEGIN
                        STGR_LINHA_1234_TODOS.Cells [1,VI_COMBINACOES01] := 'F';
                    END; // if (STGR_LINHA_1_TODOS.Cells[1,VI_CONTAR]
     ...
     FOR VI_COMBINACOES01:= 1 TO (STGR_LINHA_1234_TODOS.RowCount-1) DO
     BEGIN
          IF (STGR_LINHA_1234_TODOS.Cells [1,VI_COMBINACOES01] = 'V') THEN VI_CONTAR:=VI_CONTAR +1;
     END;
     ...
     BEGIN
          ...
          BEGIN
               ...
               STGR_LINHA_5_Comb6.Cells[3,VI_LINHAS2] := STGR_BASE_L5.Cells[1,VI_COMBINACOES01];
               STGR_LINHA_5_Comb6.Cells[4,VI_LINHAS2] := STGR_BASE_L5.Cells[2,VI_COMBINACOES01];
               STGR_LINHA_5_Comb6.Cells[5,VI_LINHAS2] := STGR_BASE_L5.Cells[1,VI_COMBINACOES02];
               STGR_LINHA_5_Comb6.Cells[6,VI_LINHAS2] := STGR_BASE_L5.Cells[2,VI_COMBINACOES02];
               FOR VI_COMBINACOES03:= 1 TO 6 DO
               BEGIN
                    FOR VI_COMBINACOES04:=1 TO 2 DO
                    BEGIN
                        { IF  (STGR_LINHA_5_Comb6.Cells[2,VI_LINHAS2] = STGR_BASE_L5.Cells[1,VI_COMBINACOES03]) OR (STGR_LINHA_5_Comb6.Cells[2,VI_LINHAS2] = STGR_BASE_L5.Cells[2,VI_COMBINACOES03]) OR
                              (STGR_LINHA_5_Comb6.Cells[3,VI_LINHAS2] = STGR_BASE_L5.Cells[1,VI_COMBINACOES03]) OR (STGR_LINHA_5_Comb6.Cells[3,VI_LINHAS2] = STGR_BASE_L5.Cells[2,VI_COMBINACOES03]) OR
                              (STGR_LINHA_5_Comb6.Cells[4,VI_LINHAS2] = STGR_BASE_L5.Cells[1,VI_COMBINACOES03]) OR (STGR_LINHA_5_Comb6.Cells[4,VI_LINHAS2] = STGR_BASE_L5.Cells[2,VI_COMBINACOES03]) OR
                              (STGR_LINHA_5_Comb6.Cells[5,VI_LINHAS2] = STGR_BASE_L5.Cells[1,VI_COMBINACOES03]) OR (STGR_LINHA_5_Comb6.Cells[5,VI_LINHAS2] = STGR_BASE_L5.Cells[2,VI_COMBINACOES03])
                         THEN
                              CONTINUE;
                         }STGR_LINHA_5_Comb6.Cells[2,VI_LINHAS2] := '6';
                         STGR_LINHA_5_Comb6.Cells[1,VI_LINHAS2] := 'V';
                         ...
                         STGR_LINHA_5_Comb6.Cells[5,VI_LINHAS2] := STGR_BASE_L5.Cells[1,VI_COMBINACOES02];
                         STGR_LINHA_5_Comb6.Cells[6,VI_LINHAS2] := STGR_BASE_L5.Cells[2,VI_COMBINACOES02];
                         STGR_LINHA_5_Comb6.Cells[7,VI_LINHAS2] := STGR_BASE_L5.Cells[VI_COMBINACOES04,VI_COMBINACOES03];
                         ...
                         BEGIN
                              ...
                              BEGIN     {
                                   IF  (STGR_LINHA_5_Comb6.Cells[2,VI_LINHAS2] = STGR_BASE_L5.Cells[1,VI_COMBINACOES05]) OR (STGR_LINHA_5_Comb6.Cells[2,VI_LINHAS2] = STGR_BASE_L5.Cells[2,VI_COMBINACOES05]) OR
                                        (STGR_LINHA_5_Comb6.Cells[3,VI_LINHAS2] = STGR_BASE_L5.Cells[1,VI_COMBINACOES05]) OR (STGR_LINHA_5_Comb6.Cells[3,VI_LINHAS2] = STGR_BASE_L5.Cells[2,VI_COMBINACOES05]) OR
                                        (STGR_LINHA_5_Comb6.Cells[4,VI_LINHAS2] = STGR_BASE_L5.Cells[1,VI_COMBINACOES05]) OR (STGR_LINHA_5_Comb6.Cells[4,VI_LINHAS2] = STGR_BASE_L5.Cells[2,VI_COMBINACOES05]) OR
                                        (STGR_LINHA_5_Comb6.Cells[5,VI_LINHAS2] = STGR_BASE_L5.Cells[1,VI_COMBINACOES05]) OR (STGR_LINHA_5_Comb6.Cells[5,VI_LINHAS2] = STGR_BASE_L5.Cells[2,VI_COMBINACOES05]) OR
                                        (STGR_LINHA_5_Comb6.Cells[6,VI_LINHAS2] = STGR_BASE_L5.Cells[1,VI_COMBINACOES05]) OR (STGR_LINHA_5_Comb6.Cells[6,VI_LINHAS2] = STGR_BASE_L5.Cells[2,VI_COMBINACOES05])
                                   THEN
                                        CONTINUE;}
                                   STGR_LINHA_5_Comb6.Cells[2,VI_LINHAS2] := '6';
                                   STGR_LINHA_5_Comb6.Cells[1,VI_LINHAS2] := 'V';
                                   ...
                                   STGR_LINHA_5_Comb6.Cells[6,VI_LINHAS2] := STGR_BASE_L5.Cells[2,VI_COMBINACOES02];
                                   STGR_LINHA_5_Comb6.Cells[7,VI_LINHAS2] := STGR_BASE_L5.Cells[VI_COMBINACOES04,VI_COMBINACOES03];
                                   STGR_LINHA_5_Comb6.Cells[8,VI_LINHAS2] := STGR_BASE_L5.Cells[VI_COMBINACOES06,VI_COMBINACOES05];
    ...
    STGR_LINHA_5_Comb6.RowCount := VI_LINHAS2;
     STGR_LINHA_5_Comb6.FixedRows := 1;
               ...
               // -------------------------------
     FOR VI_COMBINACOES01:= 1 TO (STGR_LINHA_5_Comb6.RowCount-1) DO
     BEGIN
          FOR VI_COMBINACOES02:= VI_COMBINACOES01+1 TO (STGR_LINHA_5_Comb6.RowCount-1) DO
          BEGIN
                IF  (STGR_LINHA_5_Comb6.Cells[3,VI_COMBINACOES01] = STGR_LINHA_5_Comb6.Cells[3,VI_COMBINACOES02]) AND
                    (STGR_LINHA_5_Comb6.Cells[4,VI_COMBINACOES01] = STGR_LINHA_5_Comb6.Cells[4,VI_COMBINACOES02])
                    THEN
                BEGIN
                    IF  (STGR_LINHA_5_Comb6.Cells[5,VI_COMBINACOES01] = STGR_LINHA_5_Comb6.Cells[5,VI_COMBINACOES02]) AND
                        (STGR_LINHA_5_Comb6.Cells[6,VI_COMBINACOES01] = STGR_LINHA_5_Comb6.Cells[6,VI_COMBINACOES02]) AND
                        (STGR_LINHA_5_Comb6.Cells[7,VI_COMBINACOES01] = STGR_LINHA_5_Comb6.Cells[7,VI_COMBINACOES02]) AND
                        (STGR_LINHA_5_Comb6.Cells[8,VI_COMBINACOES01] = STGR_LINHA_5_Comb6.Cells[8,VI_COMBINACOES02])
                        THEN
                    BEGIN
                        STGR_LINHA_5_Comb6.Cells [1,VI_COMBINACOES02] := 'F';
     ...
     END; // FOR VI_COMBINACOES01
          ...
          BEGIN
               IF  NOT( STRtoINT(ED_EXC_01.Text) = 0 ) THEN
               BEGIN
                    IF  (STRtoINT(STGR_LINHA_5_COMB6.Cells[3,VI_COMBINACOES01]) = STRtoINT(ED_EXC_01.Text)) OR
                        (STRtoINT(STGR_LINHA_5_COMB6.Cells[4,VI_COMBINACOES01]) = STRtoINT(ED_EXC_01.Text)) OR
                        (STRtoINT(STGR_LINHA_5_COMB6.Cells[5,VI_COMBINACOES01]) = STRtoINT(ED_EXC_01.Text)) OR
                        (STRtoINT(STGR_LINHA_5_COMB6.Cells[6,VI_COMBINACOES01]) = STRtoINT(ED_EXC_01.Text)) OR
                        (STRtoINT(STGR_LINHA_5_COMB6.Cells[7,VI_COMBINACOES01]) = STRtoINT(ED_EXC_01.Text)) OR
                        (STRtoINT(STGR_LINHA_5_COMB6.Cells[8,VI_COMBINACOES01]) = STRtoINT(ED_EXC_01.Text))
                        THEN
                    BEGIN
                        STGR_LINHA_5_COMB6.Cells [1,VI_COMBINACOES01] := 'F';
                    END; // if (STGR_LINHA_1_TODOS.Cells[1,VI_CONTAR]
               END; // IF NOT
          END; // FOR VI_COMBINACOES01
          FOR VI_COMBINACOES01:= 1 TO (STGR_LINHA_5_COMB6.RowCount-1) DO
          BEGIN
               IF  NOT( STRtoINT(ED_EXC_02.Text) = 0 ) THEN
               BEGIN
                    IF  (STRtoINT(STGR_LINHA_5_COMB6.Cells[3,VI_COMBINACOES01]) = STRtoINT(ED_EXC_02.Text)) OR
                        (STRtoINT(STGR_LINHA_5_COMB6.Cells[4,VI_COMBINACOES01]) = STRtoINT(ED_EXC_02.Text)) OR
                        (STRtoINT(STGR_LINHA_5_COMB6.Cells[5,VI_COMBINACOES01]) = STRtoINT(ED_EXC_02.Text)) OR
                        (STRtoINT(STGR_LINHA_5_COMB6.Cells[6,VI_COMBINACOES01]) = STRtoINT(ED_EXC_02.Text)) OR
                        (STRtoINT(STGR_LINHA_5_COMB6.Cells[7,VI_COMBINACOES01]) = STRtoINT(ED_EXC_02.Text)) OR
                        (STRtoINT(STGR_LINHA_5_COMB6.Cells[8,VI_COMBINACOES01]) = STRtoINT(ED_EXC_02.Text))
                        THEN
                    BEGIN
                        STGR_LINHA_5_COMB6.Cells [1,VI_COMBINACOES01] := 'F';
                    END; // if (STGR_LINHA_1_TODOS.Cells[1,VI_CONTAR]
          ...
          BEGIN
               IF  NOT( STRtoINT(ED_EXC_03.Text) = 0 ) THEN
               BEGIN
                    IF  (STRtoINT(STGR_LINHA_5_COMB6.Cells[3,VI_COMBINACOES01]) = STRtoINT(ED_EXC_03.Text)) OR
                        (STRtoINT(STGR_LINHA_5_COMB6.Cells[4,VI_COMBINACOES01]) = STRtoINT(ED_EXC_03.Text)) OR
                        (STRtoINT(STGR_LINHA_5_COMB6.Cells[5,VI_COMBINACOES01]) = STRtoINT(ED_EXC_03.Text)) OR
                        (STRtoINT(STGR_LINHA_5_COMB6.Cells[6,VI_COMBINACOES01]) = STRtoINT(ED_EXC_03.Text)) OR
                        (STRtoINT(STGR_LINHA_5_COMB6.Cells[7,VI_COMBINACOES01]) = STRtoINT(ED_EXC_03.Text)) OR
                        (STRtoINT(STGR_LINHA_5_COMB6.Cells[8,VI_COMBINACOES01]) = STRtoINT(ED_EXC_03.Text))
                        THEN
                    BEGIN
                        STGR_LINHA_5_COMB6.Cells [1,VI_COMBINACOES01] := 'F';
                    END; // if (STGR_LINHA_1_TODOS.Cells[1,VI_CONTAR]
     ...
     FOR VI_COMBINACOES01:= 1 TO (STGR_LINHA_5_Comb6.RowCount-1) DO
     BEGIN
          IF (STGR_LINHA_5_Comb6.Cells [1,VI_COMBINACOES01] = 'V') THEN VI_CONTAR:=VI_CONTAR +1;
     END;
     ...
     FOR VI_COMBINACOES01:= 1 TO (STGR_LINHA_5_Comb7.RowCount-1) DO
     BEGIN
          IF (STGR_LINHA_5_Comb7.Cells [1,VI_COMBINACOES01] = 'V') THEN VI_CONTAR:=VI_CONTAR +1;
     END;
     ...
     BEGIN
          ...
          BEGIN
               ...
               STGR_LINHA_5_Comb8.Cells[3,VI_LINHAS2] := STGR_BASE_L5.Cells[1,VI_COMBINACOES01];
               STGR_LINHA_5_Comb8.Cells[4,VI_LINHAS2] := STGR_BASE_L5.Cells[2,VI_COMBINACOES01];
               STGR_LINHA_5_Comb8.Cells[5,VI_LINHAS2] := STGR_BASE_L5.Cells[1,VI_COMBINACOES02];
               STGR_LINHA_5_Comb8.Cells[6,VI_LINHAS2] := STGR_BASE_L5.Cells[2,VI_COMBINACOES02];
               FOR VI_COMBINACOES03:= 1 TO 6 DO
               BEGIN
                    FOR VI_COMBINACOES04:=1 TO 2 DO
                    BEGIN
                         ...
                         STGR_LINHA_5_Comb8.Cells[5,VI_LINHAS2] := STGR_BASE_L5.Cells[1,VI_COMBINACOES02];
                         STGR_LINHA_5_Comb8.Cells[6,VI_LINHAS2] := STGR_BASE_L5.Cells[2,VI_COMBINACOES02];
                         STGR_LINHA_5_Comb8.Cells[7,VI_LINHAS2] := STGR_BASE_L5.Cells[VI_COMBINACOES04,VI_COMBINACOES03];
                         ...
                         BEGIN
                              ...
                              BEGIN
                                   ...
                                   STGR_LINHA_5_Comb8.Cells[6,VI_LINHAS2] := STGR_BASE_L5.Cells[2,VI_COMBINACOES02];
                                   STGR_LINHA_5_Comb8.Cells[7,VI_LINHAS2] := STGR_BASE_L5.Cells[VI_COMBINACOES04,VI_COMBINACOES03];
                                   STGR_LINHA_5_Comb8.Cells[8,VI_LINHAS2] := STGR_BASE_L5.Cells[VI_COMBINACOES06,VI_COMBINACOES05];
                                   ...
                                   BEGIN
                                        ...
                                        BEGIN
                                             ...
                                             STGR_LINHA_5_Comb8.Cells[7,VI_LINHAS2] := STGR_BASE_L5.Cells[VI_COMBINACOES04,VI_COMBINACOES03];
                                             STGR_LINHA_5_Comb8.Cells[8,VI_LINHAS2] := STGR_BASE_L5.Cells[VI_COMBINACOES06,VI_COMBINACOES05];
                                             STGR_LINHA_5_Comb8.Cells[9,VI_LINHAS2] := STGR_BASE_L5.Cells[VI_COMBINACOES08,VI_COMBINACOES07];
                                             ...
                                             BEGIN
                                                  ...
                                                  BEGIN
                                                       ...
                                                       STGR_LINHA_5_Comb8.Cells[8,VI_LINHAS2] := STGR_BASE_L5.Cells[VI_COMBINACOES06,VI_COMBINACOES05];
                                                       STGR_LINHA_5_Comb8.Cells[9,VI_LINHAS2] := STGR_BASE_L5.Cells[VI_COMBINACOES08,VI_COMBINACOES07];
                                                       STGR_LINHA_5_Comb8.Cells[10,VI_LINHAS2] := STGR_BASE_L5.Cells[VI_COMBINACOES10,VI_COMBINACOES09];
                                                       ...
                                                       STGR_LINHA_5_Comb8.Cells[0,VI_LINHAS2] := INTtoSTR(VI_LINHAS2);
                                             // ------------------------------------------------
                                             // --  Ordena os dados DAS 8 primeiras células   --
                                             // ------------------------------------------------
                                             FOR VI_CONTAR :=1 TO 25 DO
                                             BEGIN
                                                  STRGR_TODOS_NUMEROS.Cells[VI_CONTAR,0] :=INTtoSTR(VI_CONTAR);
     ...
     STGR_LINHA_5_Comb8.FixedRows := 1;
               ...
               // --  Removendo os repetidos   --
               // -------------------------------
     FOR VI_COMBINACOES01:= 1 TO (STGR_LINHA_5_Comb8.RowCount-1) DO
     BEGIN
          FOR VI_COMBINACOES02:= VI_COMBINACOES01+1 TO TRUNC((STGR_LINHA_5_Comb8.RowCount-1)/1) DO
          BEGIN
                IF  (STGR_LINHA_5_Comb8.Cells[3,VI_COMBINACOES01] = STGR_LINHA_5_Comb8.Cells[3,VI_COMBINACOES02]) AND
                    (STGR_LINHA_5_Comb8.Cells[4,VI_COMBINACOES01] = STGR_LINHA_5_Comb8.Cells[4,VI_COMBINACOES02])
                    THEN
                BEGIN
                    IF  (STGR_LINHA_5_Comb8.Cells[5,VI_COMBINACOES01] = STGR_LINHA_5_Comb8.Cells[5,VI_COMBINACOES02]) AND
                        (STGR_LINHA_5_Comb8.Cells[6,VI_COMBINACOES01] = STGR_LINHA_5_Comb8.Cells[6,VI_COMBINACOES02]) AND
                        (STGR_LINHA_5_Comb8.Cells[7,VI_COMBINACOES01] = STGR_LINHA_5_Comb8.Cells[7,VI_COMBINACOES02]) AND
                        (STGR_LINHA_5_Comb8.Cells[8,VI_COMBINACOES01] = STGR_LINHA_5_Comb8.Cells[8,VI_COMBINACOES02]) AND
                        (STGR_LINHA_5_Comb8.Cells[9,VI_COMBINACOES01] = STGR_LINHA_5_Comb8.Cells[9,VI_COMBINACOES02]) AND
                        (STGR_LINHA_5_Comb8.Cells[10,VI_COMBINACOES01] = STGR_LINHA_5_Comb8.Cells[10,VI_COMBINACOES02])
                        THEN
                    BEGIN
                        STGR_LINHA_5_Comb8.Cells [1,VI_COMBINACOES02] := 'F';
     ...
     END; // FOR VI_COMBINACOES01
          ...
          BEGIN
               IF  NOT( STRtoINT(ED_EXC_01.Text) = 0 ) THEN
               BEGIN
                    IF  (STRtoINT(STGR_LINHA_5_COMB8.Cells[3,VI_COMBINACOES01]) = STRtoINT(ED_EXC_01.Text)) OR
                        (STRtoINT(STGR_LINHA_5_COMB8.Cells[4,VI_COMBINACOES01]) = STRtoINT(ED_EXC_01.Text)) OR
                        (STRtoINT(STGR_LINHA_5_COMB8.Cells[5,VI_COMBINACOES01]) = STRtoINT(ED_EXC_01.Text)) OR
                        (STRtoINT(STGR_LINHA_5_COMB8.Cells[6,VI_COMBINACOES01]) = STRtoINT(ED_EXC_01.Text)) OR
                        (STRtoINT(STGR_LINHA_5_COMB8.Cells[7,VI_COMBINACOES01]) = STRtoINT(ED_EXC_01.Text)) OR
                        (STRtoINT(STGR_LINHA_5_COMB8.Cells[8,VI_COMBINACOES01]) = STRtoINT(ED_EXC_01.Text)) OR
                        (STRtoINT(STGR_LINHA_5_COMB8.Cells[9,VI_COMBINACOES01]) = STRtoINT(ED_EXC_01.Text)) OR
                        (STRtoINT(STGR_LINHA_5_COMB8.Cells[10,VI_COMBINACOES01]) = STRtoINT(ED_EXC_01.Text))
                        THEN
                    BEGIN
                        STGR_LINHA_5_COMB8.Cells [1,VI_COMBINACOES01] := 'F';
                    END; // if (STGR_LINHA_1_TODOS.Cells[1,VI_CONTAR]
               END; // IF NOT
          END; // FOR VI_COMBINACOES01
          FOR VI_COMBINACOES01:= 1 TO (STGR_LINHA_5_COMB8.RowCount-1) DO
          BEGIN
               IF  NOT( STRtoINT(ED_EXC_02.Text) = 0 ) THEN
               BEGIN
                    IF  (STRtoINT(STGR_LINHA_5_COMB8.Cells[3,VI_COMBINACOES01]) = STRtoINT(ED_EXC_02.Text)) OR
                        (STRtoINT(STGR_LINHA_5_COMB8.Cells[4,VI_COMBINACOES01]) = STRtoINT(ED_EXC_02.Text)) OR
                        (STRtoINT(STGR_LINHA_5_COMB8.Cells[5,VI_COMBINACOES01]) = STRtoINT(ED_EXC_02.Text)) OR
                        (STRtoINT(STGR_LINHA_5_COMB8.Cells[6,VI_COMBINACOES01]) = STRtoINT(ED_EXC_02.Text)) OR
                        (STRtoINT(STGR_LINHA_5_COMB8.Cells[7,VI_COMBINACOES01]) = STRtoINT(ED_EXC_02.Text)) OR
                        (STRtoINT(STGR_LINHA_5_COMB8.Cells[8,VI_COMBINACOES01]) = STRtoINT(ED_EXC_02.Text)) OR
                        (STRtoINT(STGR_LINHA_5_COMB8.Cells[9,VI_COMBINACOES01]) = STRtoINT(ED_EXC_02.Text)) OR
                        (STRtoINT(STGR_LINHA_5_COMB8.Cells[10,VI_COMBINACOES01]) = STRtoINT(ED_EXC_02.Text))
                        THEN
                    BEGIN
                        STGR_LINHA_5_COMB8.Cells [1,VI_COMBINACOES01] := 'F';
                    END; // if (STGR_LINHA_1_TODOS.Cells[1,VI_CONTAR]
          ...
          BEGIN
               IF  NOT( STRtoINT(ED_EXC_03.Text) = 0 ) THEN
               BEGIN
                    IF  (STRtoINT(STGR_LINHA_5_COMB8.Cells[3,VI_COMBINACOES01]) = STRtoINT(ED_EXC_03.Text)) OR
                        (STRtoINT(STGR_LINHA_5_COMB8.Cells[4,VI_COMBINACOES01]) = STRtoINT(ED_EXC_03.Text)) OR
                        (STRtoINT(STGR_LINHA_5_COMB8.Cells[5,VI_COMBINACOES01]) = STRtoINT(ED_EXC_03.Text)) OR
                        (STRtoINT(STGR_LINHA_5_COMB8.Cells[6,VI_COMBINACOES01]) = STRtoINT(ED_EXC_03.Text)) OR
                        (STRtoINT(STGR_LINHA_5_COMB8.Cells[7,VI_COMBINACOES01]) = STRtoINT(ED_EXC_03.Text)) OR
                        (STRtoINT(STGR_LINHA_5_COMB8.Cells[8,VI_COMBINACOES01]) = STRtoINT(ED_EXC_03.Text)) OR
                        (STRtoINT(STGR_LINHA_5_COMB8.Cells[9,VI_COMBINACOES01]) = STRtoINT(ED_EXC_03.Text)) OR
                        (STRtoINT(STGR_LINHA_5_COMB8.Cells[10,VI_COMBINACOES01]) = STRtoINT(ED_EXC_03.Text))
                        THEN
                    BEGIN
                        STGR_LINHA_5_COMB8.Cells [1,VI_COMBINACOES01] := 'F';
                    END; // if (STGR_LINHA_1_TODOS.Cells[1,VI_CONTAR]
     ...
     FOR VI_COMBINACOES01:= 1 TO (STGR_LINHA_5_Comb8.RowCount-1) DO
     BEGIN
          IF (STGR_LINHA_5_Comb8.Cells [1,VI_COMBINACOES01] = 'V') THEN VI_CONTAR:=VI_CONTAR +1;
     END;
     LA_LINHA5_Comb8.Caption := INTtOSTR(VI_CONTAR);
        ...
        // ******************************
        // **  LINHA_5 - 8 combinações - 3 DUPLAS + 2**
        // ******************************
     VI_LINHAS2:= 1;
     FOR VI_COMBINACOES01:= 1 TO 6 DO
     BEGIN
          FOR VI_COMBINACOES02:= VI_COMBINACOES01+1 TO 6 DO
          BEGIN
               FOR VI_COMBINACOES10:= VI_COMBINACOES02+1 TO 6 DO
               BEGIN
                    STGR_LINHA_5_Comb8_3.Cells[2,VI_LINHAS2] := '8';
                    STGR_LINHA_5_Comb8_3.Cells[1,VI_LINHAS2] := 'V';
                    STGR_LINHA_5_Comb8_3.Cells[3,VI_LINHAS2] := STGR_BASE_L5.Cells[1,VI_COMBINACOES01];
                    STGR_LINHA_5_Comb8_3.Cells[4,VI_LINHAS2] := STGR_BASE_L5.Cells[2,VI_COMBINACOES01];
                    STGR_LINHA_5_Comb8_3.Cells[5,VI_LINHAS2] := STGR_BASE_L5.Cells[1,VI_COMBINACOES02];
                    STGR_LINHA_5_Comb8_3.Cells[6,VI_LINHAS2] := STGR_BASE_L5.Cells[2,VI_COMBINACOES02];
                    STGR_LINHA_5_Comb8_3.Cells[7,VI_LINHAS2] := STGR_BASE_L5.Cells[1,VI_COMBINACOES10];
                    STGR_LINHA_5_Comb8_3.Cells[8,VI_LINHAS2] := STGR_BASE_L5.Cells[2,VI_COMBINACOES10];
                    FOR VI_COMBINACOES03:= 1 TO 6 DO
                    BEGIN
                         FOR VI_COMBINACOES04:=1 TO 2 DO
                         BEGIN

                             { IF  (STGR_LINHA_5_Comb8_3.Cells[2,VI_LINHAS2] = STGR_BASE_L5.Cells[1,VI_COMBINACOES03]) OR (STGR_LINHA_5_Comb8_3.Cells[2,VI_LINHAS2] = STGR_BASE_L5.Cells[2,VI_COMBINACOES03]) OR
                                   (STGR_LINHA_5_Comb8_3.Cells[3,VI_LINHAS2] = STGR_BASE_L5.Cells[1,VI_COMBINACOES03]) OR (STGR_LINHA_5_Comb8_3.Cells[3,VI_LINHAS2] = STGR_BASE_L5.Cells[2,VI_COMBINACOES03]) OR
                                   (STGR_LINHA_5_Comb8_3.Cells[4,VI_LINHAS2] = STGR_BASE_L5.Cells[1,VI_COMBINACOES03]) OR (STGR_LINHA_5_Comb8_3.Cells[4,VI_LINHAS2] = STGR_BASE_L5.Cells[2,VI_COMBINACOES03]) OR
                                   (STGR_LINHA_5_Comb8_3.Cells[5,VI_LINHAS2] = STGR_BASE_L5.Cells[1,VI_COMBINACOES03]) OR (STGR_LINHA_5_Comb8_3.Cells[5,VI_LINHAS2] = STGR_BASE_L5.Cells[2,VI_COMBINACOES03])
                              THEN
                                   CONTINUE;
                              }STGR_LINHA_5_Comb8_3.Cells[2,VI_LINHAS2] := '8';
                              STGR_LINHA_5_Comb8_3.Cells[1,VI_LINHAS2] := 'V';
                              ...
                              STGR_LINHA_5_Comb8_3.Cells[7,VI_LINHAS2] := STGR_BASE_L5.Cells[1,VI_COMBINACOES10];
                              STGR_LINHA_5_Comb8_3.Cells[8,VI_LINHAS2] := STGR_BASE_L5.Cells[2,VI_COMBINACOES10];
                              STGR_LINHA_5_Comb8_3.Cells[9,VI_LINHAS2] := STGR_BASE_L5.Cells[VI_COMBINACOES04,VI_COMBINACOES03];
                              IF  (STGR_LINHA_5_Comb8_3.Cells[9,VI_LINHAS2] = STGR_LINHA_5_Comb8_3.Cells[3,VI_LINHAS2]) OR (STGR_LINHA_5_Comb8_3.Cells[9,VI_LINHAS2] = STGR_LINHA_5_Comb8_3.Cells[4,VI_LINHAS2]) OR
                                  (STGR_LINHA_5_Comb8_3.Cells[9,VI_LINHAS2] = STGR_LINHA_5_Comb8_3.Cells[5,VI_LINHAS2]) OR (STGR_LINHA_5_Comb8_3.Cells[9,VI_LINHAS2] = STGR_LINHA_5_Comb8_3.Cells[6,VI_LINHAS2]) OR
                                  (STGR_LINHA_5_Comb8_3.Cells[9,VI_LINHAS2] = STGR_LINHA_5_Comb8_3.Cells[7,VI_LINHAS2]) OR (STGR_LINHA_5_Comb8_3.Cells[9,VI_LINHAS2] = STGR_LINHA_5_Comb8_3.Cells[8,VI_LINHAS2])
                              THEN
                                   CONTINUE;
                              STGR_LINHA_5_Comb8_3.Cells[0,VI_LINHAS2] := INTtoSTR(VI_LINHAS2);
                              FOR VI_COMBINACOES05:=1 TO 6 DO
                              BEGIN
                                   FOR VI_COMBINACOES06:=1 TO 2 DO
                                   BEGIN     {
                                        IF  (STGR_LINHA_5_Comb8_3.Cells[2,VI_LINHAS2] = STGR_BASE_L5.Cells[1,VI_COMBINACOES05]) OR (STGR_LINHA_5_Comb8_3.Cells[2,VI_LINHAS2] = STGR_BASE_L5.Cells[2,VI_COMBINACOES05]) OR
                                             (STGR_LINHA_5_Comb8_3.Cells[3,VI_LINHAS2] = STGR_BASE_L5.Cells[1,VI_COMBINACOES05]) OR (STGR_LINHA_5_Comb8_3.Cells[3,VI_LINHAS2] = STGR_BASE_L5.Cells[2,VI_COMBINACOES05]) OR
                                             (STGR_LINHA_5_Comb8_3.Cells[4,VI_LINHAS2] = STGR_BASE_L5.Cells[1,VI_COMBINACOES05]) OR (STGR_LINHA_5_Comb8_3.Cells[4,VI_LINHAS2] = STGR_BASE_L5.Cells[2,VI_COMBINACOES05]) OR
                                             (STGR_LINHA_5_Comb8_3.Cells[5,VI_LINHAS2] = STGR_BASE_L5.Cells[1,VI_COMBINACOES05]) OR (STGR_LINHA_5_Comb8_3.Cells[5,VI_LINHAS2] = STGR_BASE_L5.Cells[2,VI_COMBINACOES05]) OR
                                             (STGR_LINHA_5_Comb8_3.Cells[6,VI_LINHAS2] = STGR_BASE_L5.Cells[1,VI_COMBINACOES05]) OR (STGR_LINHA_5_Comb8_3.Cells[6,VI_LINHAS2] = STGR_BASE_L5.Cells[2,VI_COMBINACOES05])
                                        THEN
                                             CONTINUE;}
                                        STGR_LINHA_5_Comb8_3.Cells[2,VI_LINHAS2] := '8';
                                        STGR_LINHA_5_Comb8_3.Cells[1,VI_LINHAS2] := 'V';
                                        ...
                                        STGR_LINHA_5_Comb8_3.Cells[8,VI_LINHAS2] := STGR_BASE_L5.Cells[2,VI_COMBINACOES10];
                                        STGR_LINHA_5_Comb8_3.Cells[9,VI_LINHAS2] := STGR_BASE_L5.Cells[VI_COMBINACOES04,VI_COMBINACOES03];
                                        STGR_LINHA_5_Comb8_3.Cells[10,VI_LINHAS2] := STGR_BASE_L5.Cells[VI_COMBINACOES06,VI_COMBINACOES05];
                                        IF  (STGR_LINHA_5_Comb8_3.Cells[10,VI_LINHAS2] = STGR_LINHA_5_Comb8_3.Cells[3,VI_LINHAS2]) OR (STGR_LINHA_5_Comb8_3.Cells[10,VI_LINHAS2] = STGR_LINHA_5_Comb8_3.Cells[4,VI_LINHAS2]) OR
                                            (STGR_LINHA_5_Comb8_3.Cells[10,VI_LINHAS2] = STGR_LINHA_5_Comb8_3.Cells[5,VI_LINHAS2]) OR (STGR_LINHA_5_Comb8_3.Cells[10,VI_LINHAS2] = STGR_LINHA_5_Comb8_3.Cells[6,VI_LINHAS2]) OR
                                            (STGR_LINHA_5_Comb8_3.Cells[10,VI_LINHAS2] = STGR_LINHA_5_Comb8_3.Cells[7,VI_LINHAS2]) OR (STGR_LINHA_5_Comb8_3.Cells[10,VI_LINHAS2] = STGR_LINHA_5_Comb8_3.Cells[8,VI_LINHAS2]) OR
                                            (STGR_LINHA_5_Comb8_3.Cells[10,VI_LINHAS2] = STGR_LINHA_5_Comb8_3.Cells[9,VI_LINHAS2])
                                        THEN
                                             CONTINUE;
                                        IF (VI_COMBINACOES03 = VI_COMBINACOES05) THEN
                                             CONTINUE;
                                        STGR_LINHA_5_Comb8_3.Cells[0,VI_LINHAS2] := INTtoSTR(VI_LINHAS2);
                                                  // ------------------------------------------------
                                                  // --  Ordena os dados DAS 10 primeiras células   --
                                                  // ------------------------------------------------
                                                  FOR VI_CONTAR :=1 TO 25 DO
                                                  BEGIN
                                                       STRGR_TODOS_NUMEROS.Cells[VI_CONTAR,0] :=INTtoSTR(VI_CONTAR);
                                                  ...
                                                  FOR VI_CONTAR :=3 TO 10 DO
                                                  BEGIN
                                                       STRGR_TODOS_NUMEROS.Cells [ (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[VI_CONTAR,VI_LINHAS2])) ,1]:='V';
                                                  END; // FOR VI_CONTAR1
                                                  VI_CNTCELULAS := 3;
                                                  FOR VI_CONTAR :=1 TO 25 DO
                                                  BEGIN
                                                    IF (STRGR_TODOS_NUMEROS.Cells[VI_CONTAR,1]='V') THEN
                                                    BEGIN
                                                        STGR_LINHA_5_Comb8_3.Cells [VI_CNTCELULAS, VI_LINHAS2] := RIGHTSTR ('0'+(STRGR_TODOS_NUMEROS.Cells[VI_CONTAR,0]),2) ;
                                                        VI_CNTCELULAS := VI_CNTCELULAS + 1;
                                                    END; // IF (STRGR_TODOS_NUMEROS
                                                  END; // FOR VI_CONTAR
                                        VI_LINHAS2 := VI_LINHAS2+1;
                         ...
                         END; // FOR VI_COMBINACOES04
                    END; // FOR VI_COMBINACOES03
                   STGR_LINHA_5_Comb8_3.RowCount := VI_LINHAS2;
               end; //  FOR VI_COMBINACOES10
          end; //  FOR VI_COMBINACOES02
     end; // FOR VI_COMBINACOES01
    STGR_LINHA_5_Comb8_3.RowCount := VI_LINHAS2;
     STGR_LINHA_5_Comb8_3.FixedRows := 1;
               // -------------------------------
               // --  Removendo os repetidos   --
               // -------------------------------
     FOR VI_COMBINACOES01:= 1 TO (STGR_LINHA_5_Comb8_3.RowCount-1) DO
     BEGIN
          FOR VI_COMBINACOES02:= VI_COMBINACOES01+1 TO (STGR_LINHA_5_Comb8_3.RowCount-1) DO
          BEGIN
                IF  (STGR_LINHA_5_Comb8_3.Cells[3,VI_COMBINACOES01] = STGR_LINHA_5_Comb8_3.Cells[3,VI_COMBINACOES02]) AND
                    (STGR_LINHA_5_Comb8_3.Cells[4,VI_COMBINACOES01] = STGR_LINHA_5_Comb8_3.Cells[4,VI_COMBINACOES02])
                    THEN
                BEGIN
                    IF  (STGR_LINHA_5_Comb8_3.Cells[5,VI_COMBINACOES01] = STGR_LINHA_5_Comb8_3.Cells[5,VI_COMBINACOES02]) AND
                        (STGR_LINHA_5_Comb8_3.Cells[6,VI_COMBINACOES01] = STGR_LINHA_5_Comb8_3.Cells[6,VI_COMBINACOES02]) AND
                        (STGR_LINHA_5_Comb8_3.Cells[7,VI_COMBINACOES01] = STGR_LINHA_5_Comb8_3.Cells[7,VI_COMBINACOES02]) AND
                        (STGR_LINHA_5_Comb8_3.Cells[8,VI_COMBINACOES01] = STGR_LINHA_5_Comb8_3.Cells[8,VI_COMBINACOES02]) AND
                        (STGR_LINHA_5_Comb8_3.Cells[7,VI_COMBINACOES01] = STGR_LINHA_5_Comb8_3.Cells[9,VI_COMBINACOES02]) AND
                        (STGR_LINHA_5_Comb8_3.Cells[8,VI_COMBINACOES01] = STGR_LINHA_5_Comb8_3.Cells[10,VI_COMBINACOES02])
                        THEN
                    BEGIN
                        STGR_LINHA_5_Comb8_3.Cells [1,VI_COMBINACOES02] := 'F';
                    END; // if (STGR_LINHA_5_Comb8_3.Cells[1,VI_CONTAR]
                END; // if (STGR_LINHA_5_Comb8_3.Cells[1,VI_CONTAR]
          END; // FOR VI_COMBINACOES02
     END; // FOR VI_COMBINACOES01
                    // -------------------------------
          ...
          BEGIN
               IF  NOT( STRtoINT(ED_EXC_01.Text) = 0 ) THEN
               BEGIN
                    IF  (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[3,VI_COMBINACOES01]) = STRtoINT(ED_EXC_01.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[4,VI_COMBINACOES01]) = STRtoINT(ED_EXC_01.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[5,VI_COMBINACOES01]) = STRtoINT(ED_EXC_01.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[6,VI_COMBINACOES01]) = STRtoINT(ED_EXC_01.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[7,VI_COMBINACOES01]) = STRtoINT(ED_EXC_01.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[8,VI_COMBINACOES01]) = STRtoINT(ED_EXC_01.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[9,VI_COMBINACOES01]) = STRtoINT(ED_EXC_01.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[10,VI_COMBINACOES01]) = STRtoINT(ED_EXC_01.Text))
                        THEN
                    BEGIN
                        STGR_LINHA_5_Comb8_3.Cells [1,VI_COMBINACOES01] := 'F';
                    END; // if (STGR_LINHA_1_TODOS.Cells[1,VI_CONTAR]
               END; // IF NOT
          END; // FOR VI_COMBINACOES01
          FOR VI_COMBINACOES01:= 1 TO (STGR_LINHA_5_Comb8_3.RowCount-1) DO
          BEGIN
               IF  NOT( STRtoINT(ED_EXC_02.Text) = 0 ) THEN
               BEGIN
                    IF  (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[3,VI_COMBINACOES01]) = STRtoINT(ED_EXC_02.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[4,VI_COMBINACOES01]) = STRtoINT(ED_EXC_02.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[5,VI_COMBINACOES01]) = STRtoINT(ED_EXC_02.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[6,VI_COMBINACOES01]) = STRtoINT(ED_EXC_02.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[7,VI_COMBINACOES01]) = STRtoINT(ED_EXC_02.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[8,VI_COMBINACOES01]) = STRtoINT(ED_EXC_02.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[9,VI_COMBINACOES01]) = STRtoINT(ED_EXC_02.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[10,VI_COMBINACOES01]) = STRtoINT(ED_EXC_02.Text))
                        THEN
                    BEGIN
                        STGR_LINHA_5_Comb8_3.Cells [1,VI_COMBINACOES01] := 'F';
                    END; // if (STGR_LINHA_1_TODOS.Cells[1,VI_CONTAR]
          ...
          BEGIN
               IF  NOT( STRtoINT(ED_EXC_03.Text) = 0 ) THEN
               BEGIN
                    IF  (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[3,VI_COMBINACOES01]) = STRtoINT(ED_EXC_03.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[4,VI_COMBINACOES01]) = STRtoINT(ED_EXC_03.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[5,VI_COMBINACOES01]) = STRtoINT(ED_EXC_03.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[6,VI_COMBINACOES01]) = STRtoINT(ED_EXC_03.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[7,VI_COMBINACOES01]) = STRtoINT(ED_EXC_03.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[8,VI_COMBINACOES01]) = STRtoINT(ED_EXC_03.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[9,VI_COMBINACOES01]) = STRtoINT(ED_EXC_03.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[10,VI_COMBINACOES01]) = STRtoINT(ED_EXC_03.Text))
                        THEN
                    BEGIN
                        STGR_LINHA_5_Comb8_3.Cells [1,VI_COMBINACOES01] := 'F';
                    END; // if (STGR_LINHA_1_TODOS.Cells[1,VI_CONTAR]
     ...
     FOR VI_COMBINACOES01:= 1 TO (STGR_LINHA_5_Comb8_3.RowCount-1) DO
     BEGIN
          IF (STGR_LINHA_5_Comb8_3.Cells [1,VI_COMBINACOES01] = 'V') THEN VI_CONTAR:=VI_CONTAR +1;
     END;
     LA_LINHA5_Comb8_3.Caption := INTtoSTR(VI_CONTAR);
     ...
     FOR VI_COMBINACOES01:= 1 TO (STGR_LINHA_5_Comb7_1.RowCount-1) DO
     BEGIN
          IF (STGR_LINHA_5_Comb7_1.Cells [1,VI_COMBINACOES01] = 'V') THEN VI_CONTAR:=VI_CONTAR +1;
     END;
     ...
     BEGIN
          //FOR VI_COMBINACOES02:= VI_COMBINACOES01+1 TO 6 DO
          //BEGIN
               STGR_LINHA_5_Comb6_1.Cells[2,VI_LINHAS2] := '6';
               STGR_LINHA_5_Comb6_1.Cells[1,VI_LINHAS2] := 'V';
               STGR_LINHA_5_Comb6_1.Cells[3,VI_LINHAS2] := STGR_BASE_L5.Cells[1,VI_COMBINACOES01];
               STGR_LINHA_5_Comb6_1.Cells[4,VI_LINHAS2] := STGR_BASE_L5.Cells[2,VI_COMBINACOES01];
               FOR VI_COMBINACOES03:= 1 TO 6 DO
               BEGIN
                    FOR VI_COMBINACOES04:=1 TO 2 DO
                    BEGIN
                         ...
                         STGR_LINHA_5_Comb6_1.Cells[3,VI_LINHAS2] := STGR_BASE_L5.Cells[1,VI_COMBINACOES01];
                         STGR_LINHA_5_Comb6_1.Cells[4,VI_LINHAS2] := STGR_BASE_L5.Cells[2,VI_COMBINACOES01];
                         STGR_LINHA_5_Comb6_1.Cells[5,VI_LINHAS2] := STGR_BASE_L5.Cells[VI_COMBINACOES04,VI_COMBINACOES03];
                         IF  (STGR_LINHA_5_Comb6_1.Cells[5,VI_LINHAS2] = STGR_LINHA_5_Comb6_1.Cells[3,VI_LINHAS2]) OR (STGR_LINHA_5_Comb6_1.Cells[5,VI_LINHAS2] = STGR_LINHA_5_Comb6_1.Cells[4,VI_LINHAS2])
                         THEN
                              CONTINUE;
                         STGR_LINHA_5_Comb6_1.Cells[0,VI_LINHAS2] := INTtoSTR(VI_LINHAS2);
                         FOR VI_COMBINACOES05:=1 TO 6 DO
                         BEGIN
                              FOR VI_COMBINACOES06:=1 TO 2 DO
                              BEGIN
                                   ...
                                   STGR_LINHA_5_Comb6_1.Cells[4,VI_LINHAS2] := STGR_BASE_L5.Cells[2,VI_COMBINACOES01];
                                   STGR_LINHA_5_Comb6_1.Cells[5,VI_LINHAS2] := STGR_BASE_L5.Cells[VI_COMBINACOES04,VI_COMBINACOES03];
                                   STGR_LINHA_5_Comb6_1.Cells[6,VI_LINHAS2] := STGR_BASE_L5.Cells[VI_COMBINACOES06,VI_COMBINACOES05];
                                   IF  (STGR_LINHA_5_Comb6_1.Cells[6,VI_LINHAS2] = STGR_LINHA_5_Comb6_1.Cells[3,VI_LINHAS2]) OR (STGR_LINHA_5_Comb6_1.Cells[6,VI_LINHAS2] = STGR_LINHA_5_Comb6_1.Cells[4,VI_LINHAS2]) OR
                                       (STGR_LINHA_5_Comb6_1.Cells[6,VI_LINHAS2] = STGR_LINHA_5_Comb6_1.Cells[5,VI_LINHAS2]) 
                                   THEN
                                        CONTINUE;
                                   IF (VI_COMBINACOES03 = VI_COMBINACOES05) THEN
                                        CONTINUE;
                                   ...
                                   BEGIN
                                        ...
                                        BEGIN
                                             ...
                                             STGR_LINHA_5_Comb6_1.Cells[5,VI_LINHAS2] := STGR_BASE_L5.Cells[VI_COMBINACOES04,VI_COMBINACOES03];
                                             STGR_LINHA_5_Comb6_1.Cells[6,VI_LINHAS2] := STGR_BASE_L5.Cells[VI_COMBINACOES06,VI_COMBINACOES05];
                                             STGR_LINHA_5_Comb6_1.Cells[7,VI_LINHAS2] := STGR_BASE_L5.Cells[VI_COMBINACOES08,VI_COMBINACOES07];
                                             IF  (STGR_LINHA_5_Comb6_1.Cells[7,VI_LINHAS2] = STGR_LINHA_5_Comb6_1.Cells[3,VI_LINHAS2]) OR (STGR_LINHA_5_Comb6_1.Cells[7,VI_LINHAS2] = STGR_LINHA_5_Comb6_1.Cells[4,VI_LINHAS2]) OR
                                                 (STGR_LINHA_5_Comb6_1.Cells[7,VI_LINHAS2] = STGR_LINHA_5_Comb6_1.Cells[5,VI_LINHAS2]) OR (STGR_LINHA_5_Comb6_1.Cells[7,VI_LINHAS2] = STGR_LINHA_5_Comb6_1.Cells[6,VI_LINHAS2])
                                             THEN
                                                  CONTINUE;
                                             IF (VI_COMBINACOES03 = VI_COMBINACOES05) or (VI_COMBINACOES05 = VI_COMBINACOES07) or (VI_COMBINACOES03 = VI_COMBINACOES07) THEN
                                                  CONTINUE;
                                             ...
                                             BEGIN
                                                  ...
                                                  BEGIN
                                                       ...
                                                       STGR_LINHA_5_Comb6_1.Cells[6,VI_LINHAS2] := STGR_BASE_L5.Cells[VI_COMBINACOES06,VI_COMBINACOES05];
                                                       STGR_LINHA_5_Comb6_1.Cells[7,VI_LINHAS2] := STGR_BASE_L5.Cells[VI_COMBINACOES08,VI_COMBINACOES07];
                                                       STGR_LINHA_5_Comb6_1.Cells[8,VI_LINHAS2] := STGR_BASE_L5.Cells[VI_COMBINACOES10,VI_COMBINACOES09];
                                                       IF  (STGR_LINHA_5_Comb6_1.Cells[8,VI_LINHAS2] = STGR_LINHA_5_Comb6_1.Cells[3,VI_LINHAS2]) OR (STGR_LINHA_5_Comb6_1.Cells[8,VI_LINHAS2] = STGR_LINHA_5_Comb6_1.Cells[4,VI_LINHAS2]) OR
                                                           (STGR_LINHA_5_Comb6_1.Cells[8,VI_LINHAS2] = STGR_LINHA_5_Comb6_1.Cells[5,VI_LINHAS2]) OR (STGR_LINHA_5_Comb6_1.Cells[8,VI_LINHAS2] = STGR_LINHA_5_Comb6_1.Cells[6,VI_LINHAS2]) OR
                                                           (STGR_LINHA_5_Comb6_1.Cells[8,VI_LINHAS2] = STGR_LINHA_5_Comb6_1.Cells[7,VI_LINHAS2])
                                                       THEN
                                                            CONTINUE;
                                                       IF (VI_COMBINACOES03 = VI_COMBINACOES05) or (VI_COMBINACOES03 = VI_COMBINACOES07) or (VI_COMBINACOES03 = VI_COMBINACOES09)
                                                          or (VI_COMBINACOES05 = VI_COMBINACOES07) or (VI_COMBINACOES05 = VI_COMBINACOES09) or (VI_COMBINACOES07= VI_COMBINACOES09)
                                                       ...
                                                       FOR VI_CONTAR :=3 TO 8 DO
                                                       BEGIN
                                                            STRGR_TODOS_NUMEROS.Cells [ (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[VI_CONTAR,VI_LINHAS2])) ,1]:='V';
                                                       END; // FOR VI_CONTAR1
                                                       VI_CNTCELULAS := 3;
                                                       FOR VI_CONTAR :=1 TO 25 DO
                                                       BEGIN
                                                         IF (STRGR_TODOS_NUMEROS.Cells[VI_CONTAR,1]='V') THEN
                                                         BEGIN
                                                             STGR_LINHA_5_Comb6_1.Cells [VI_CNTCELULAS, VI_LINHAS2] := RIGHTSTR ('0'+(STRGR_TODOS_NUMEROS.Cells[VI_CONTAR,0]),2) ;
                                                             VI_CNTCELULAS := VI_CNTCELULAS + 1;
                                                         END; // IF (STRGR_TODOS_NUMEROS
                                                       END; // FOR VI_CONTAR
                                                                 VI_LINHAS2 := VI_LINHAS2+1;
                    ...
                    END; // FOR VI_COMBINACOES04
               END; // FOR VI_COMBINACOES03
               STGR_LINHA_5_Comb6_1.RowCount := VI_LINHAS2;               
         // end; //  FOR VI_COMBINACOES02
     end; // FOR VI_COMBINACOES01
     STGR_LINHA_5_Comb6_1.RowCount := VI_LINHAS2;
     STGR_LINHA_5_Comb6_1.FixedRows := 1;
               // -------------------------------
               // --  Removendo os repetidos   --
               // -------------------------------
     FOR VI_COMBINACOES01:= 1 TO (STGR_LINHA_5_Comb6_1.RowCount-1) DO
     BEGIN
          FOR VI_COMBINACOES02:= VI_COMBINACOES01+1 TO {(STGR_LINHA_5_Comb6_1.RowCount-1)} VI_COMBINACOES01+900  DO
          BEGIN
                IF  (STGR_LINHA_5_Comb6_1.Cells[3,VI_COMBINACOES01] = STGR_LINHA_5_Comb6_1.Cells[3,VI_COMBINACOES02]) AND
                    (STGR_LINHA_5_Comb6_1.Cells[4,VI_COMBINACOES01] = STGR_LINHA_5_Comb6_1.Cells[4,VI_COMBINACOES02])
                    THEN
                BEGIN
                    IF  (STGR_LINHA_5_Comb6_1.Cells[5,VI_COMBINACOES01] = STGR_LINHA_5_Comb6_1.Cells[5,VI_COMBINACOES02]) AND
                        (STGR_LINHA_5_Comb6_1.Cells[6,VI_COMBINACOES01] = STGR_LINHA_5_Comb6_1.Cells[6,VI_COMBINACOES02]) AND
                        (STGR_LINHA_5_Comb6_1.Cells[7,VI_COMBINACOES01] = STGR_LINHA_5_Comb6_1.Cells[7,VI_COMBINACOES02]) AND
                        (STGR_LINHA_5_Comb6_1.Cells[8,VI_COMBINACOES01] = STGR_LINHA_5_Comb6_1.Cells[8,VI_COMBINACOES02]) 
                        THEN
                    BEGIN
                        STGR_LINHA_5_Comb6_1.Cells [1,VI_COMBINACOES02] := 'F';
                    END; // if (STGR_LINHA_5_Comb6_1.Cells[1,VI_CONTAR]
                END; // if (STGR_LINHA_5_Comb6_1.Cells[1,VI_CONTAR]
          END; // FOR VI_COMBINACOES02
     END; // FOR VI_COMBINACOES01
                    // -------------------------------
          ...
          BEGIN
               IF  NOT( STRtoINT(ED_EXC_01.Text) = 0 ) THEN
               BEGIN
                    IF  (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[3,VI_COMBINACOES01]) = STRtoINT(ED_EXC_01.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[4,VI_COMBINACOES01]) = STRtoINT(ED_EXC_01.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[5,VI_COMBINACOES01]) = STRtoINT(ED_EXC_01.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[6,VI_COMBINACOES01]) = STRtoINT(ED_EXC_01.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[7,VI_COMBINACOES01]) = STRtoINT(ED_EXC_01.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[8,VI_COMBINACOES01]) = STRtoINT(ED_EXC_01.Text))
                        THEN
                    BEGIN
                        STGR_LINHA_5_Comb6_1.Cells [1,VI_COMBINACOES01] := 'F';
                    END; // if (STGR_LINHA_1_TODOS.Cells[1,VI_CONTAR]
               END; // IF NOT
          END; // FOR VI_COMBINACOES01
          FOR VI_COMBINACOES01:= 1 TO (STGR_LINHA_5_Comb6_1.RowCount-1) DO
          BEGIN
               IF  NOT( STRtoINT(ED_EXC_02.Text) = 0 ) THEN
               BEGIN
                    IF  (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[3,VI_COMBINACOES01]) = STRtoINT(ED_EXC_02.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[4,VI_COMBINACOES01]) = STRtoINT(ED_EXC_02.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[5,VI_COMBINACOES01]) = STRtoINT(ED_EXC_02.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[6,VI_COMBINACOES01]) = STRtoINT(ED_EXC_02.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[7,VI_COMBINACOES01]) = STRtoINT(ED_EXC_02.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[8,VI_COMBINACOES01]) = STRtoINT(ED_EXC_02.Text))
                        THEN
                    BEGIN
                        STGR_LINHA_5_Comb6_1.Cells [1,VI_COMBINACOES01] := 'F';
                    END; // if (STGR_LINHA_1_TODOS.Cells[1,VI_CONTAR]
          ...
          BEGIN
               IF  NOT( STRtoINT(ED_EXC_03.Text) = 0 ) THEN
               BEGIN
                    IF  (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[3,VI_COMBINACOES01]) = STRtoINT(ED_EXC_03.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[4,VI_COMBINACOES01]) = STRtoINT(ED_EXC_03.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[5,VI_COMBINACOES01]) = STRtoINT(ED_EXC_03.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[6,VI_COMBINACOES01]) = STRtoINT(ED_EXC_03.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[7,VI_COMBINACOES01]) = STRtoINT(ED_EXC_03.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[8,VI_COMBINACOES01]) = STRtoINT(ED_EXC_03.Text))
                        THEN
                    BEGIN
                        STGR_LINHA_5_Comb6_1.Cells [1,VI_COMBINACOES01] := 'F';
                    END; // if (STGR_LINHA_1_TODOS.Cells[1,VI_CONTAR]
     ...
     FOR VI_COMBINACOES01:= 1 TO (STGR_LINHA_5_Comb6_1.RowCount-1) DO
     BEGIN
          IF (STGR_LINHA_5_Comb6_1.Cells [1,VI_COMBINACOES01] = 'V') THEN VI_CONTAR:=VI_CONTAR +1;
     END;
     LA_LINHA5_Comb6_1.Caption := INTtOSTR(VI_CONTAR);




        // ******************************
        // **  LINHA_5 - 5 combinações 1DP + 3 **
        // ******************************
     VI_LINHAS2:= 1;
     FOR VI_COMBINACOES01:= 1 TO 6 DO
     BEGIN
          //FOR VI_COMBINACOES02:= VI_COMBINACOES01+1 TO 6 DO
          //BEGIN
               STGR_LINHA_5_Comb5_1.Cells[2,VI_LINHAS2] := '5';
               STGR_LINHA_5_Comb5_1.Cells[1,VI_LINHAS2] := 'V';
               STGR_LINHA_5_Comb5_1.Cells[3,VI_LINHAS2] := STGR_BASE_L5.Cells[1,VI_COMBINACOES01];
               STGR_LINHA_5_Comb5_1.Cells[4,VI_LINHAS2] := STGR_BASE_L5.Cells[2,VI_COMBINACOES01];
               FOR VI_COMBINACOES03:= 1 TO 6 DO
               BEGIN
                    FOR VI_COMBINACOES04:=1 TO 2 DO
                    BEGIN
                         ...
                         STGR_LINHA_5_Comb5_1.Cells[3,VI_LINHAS2] := STGR_BASE_L5.Cells[1,VI_COMBINACOES01];
                         STGR_LINHA_5_Comb5_1.Cells[4,VI_LINHAS2] := STGR_BASE_L5.Cells[2,VI_COMBINACOES01];
                         STGR_LINHA_5_Comb5_1.Cells[5,VI_LINHAS2] := STGR_BASE_L5.Cells[VI_COMBINACOES04,VI_COMBINACOES03];
                         IF  (STGR_LINHA_5_Comb5_1.Cells[5,VI_LINHAS2] = STGR_LINHA_5_Comb5_1.Cells[3,VI_LINHAS2]) OR (STGR_LINHA_5_Comb5_1.Cells[5,VI_LINHAS2] = STGR_LINHA_5_Comb5_1.Cells[4,VI_LINHAS2])
                         THEN
                              CONTINUE;
                         STGR_LINHA_5_Comb5_1.Cells[0,VI_LINHAS2] := INTtoSTR(VI_LINHAS2);
                         FOR VI_COMBINACOES05:=1 TO 6 DO
                         BEGIN
                              FOR VI_COMBINACOES06:=1 TO 2 DO
                              BEGIN
                                   ...
                                   STGR_LINHA_5_Comb5_1.Cells[4,VI_LINHAS2] := STGR_BASE_L5.Cells[2,VI_COMBINACOES01];
                                   STGR_LINHA_5_Comb5_1.Cells[5,VI_LINHAS2] := STGR_BASE_L5.Cells[VI_COMBINACOES04,VI_COMBINACOES03];
                                   STGR_LINHA_5_Comb5_1.Cells[6,VI_LINHAS2] := STGR_BASE_L5.Cells[VI_COMBINACOES06,VI_COMBINACOES05];
                                   IF  (STGR_LINHA_5_Comb5_1.Cells[6,VI_LINHAS2] = STGR_LINHA_5_Comb5_1.Cells[3,VI_LINHAS2]) OR (STGR_LINHA_5_Comb5_1.Cells[6,VI_LINHAS2] = STGR_LINHA_5_Comb5_1.Cells[4,VI_LINHAS2]) OR
                                       (STGR_LINHA_5_Comb5_1.Cells[6,VI_LINHAS2] = STGR_LINHA_5_Comb5_1.Cells[5,VI_LINHAS2]) 
                                   THEN
                                        CONTINUE;
                                   IF (VI_COMBINACOES03 = VI_COMBINACOES05) THEN
                                        CONTINUE;
                                   ...
                                   BEGIN
                                        ...
                                        BEGIN
                                             ...
                                             STGR_LINHA_5_Comb5_1.Cells[5,VI_LINHAS2] := STGR_BASE_L5.Cells[VI_COMBINACOES04,VI_COMBINACOES03];
                                             STGR_LINHA_5_Comb5_1.Cells[6,VI_LINHAS2] := STGR_BASE_L5.Cells[VI_COMBINACOES06,VI_COMBINACOES05];
                                             STGR_LINHA_5_Comb5_1.Cells[7,VI_LINHAS2] := STGR_BASE_L5.Cells[VI_COMBINACOES08,VI_COMBINACOES07];
                                             IF  (STGR_LINHA_5_Comb5_1.Cells[7,VI_LINHAS2] = STGR_LINHA_5_Comb5_1.Cells[3,VI_LINHAS2]) OR (STGR_LINHA_5_Comb5_1.Cells[7,VI_LINHAS2] = STGR_LINHA_5_Comb5_1.Cells[4,VI_LINHAS2]) OR
                                                 (STGR_LINHA_5_Comb5_1.Cells[7,VI_LINHAS2] = STGR_LINHA_5_Comb5_1.Cells[5,VI_LINHAS2]) OR (STGR_LINHA_5_Comb5_1.Cells[7,VI_LINHAS2] = STGR_LINHA_5_Comb5_1.Cells[6,VI_LINHAS2]) 
                                             THEN
                                                  CONTINUE;
                                             IF (VI_COMBINACOES03 = VI_COMBINACOES05) or (VI_COMBINACOES05 = VI_COMBINACOES07) or (VI_COMBINACOES03 = VI_COMBINACOES07) THEN
                                                  CONTINUE;
                                             STGR_LINHA_5_Comb5_1.Cells[0,VI_LINHAS2] := INTtoSTR(VI_LINHAS2);
                                                       ...
                                                       END; // FOR VI_CONTAR
                                                       // ----> MONTADO E VERIFICANDO TODOS OS 25 DÍGITOS
                                                       FOR VI_CONTAR :=3 TO 7 DO
                                                       BEGIN
                                                            STRGR_TODOS_NUMEROS.Cells [ (STRtoINT(STGR_LINHA_5_Comb5_1.Cells[VI_CONTAR,VI_LINHAS2])) ,1]:='V';
                                                       END; // FOR VI_CONTAR1
                                                       VI_CNTCELULAS := 3;
                                                       FOR VI_CONTAR :=1 TO 25 DO
                                                       BEGIN
                                                         IF (STRGR_TODOS_NUMEROS.Cells[VI_CONTAR,1]='V') THEN
                                                         BEGIN
                                                             STGR_LINHA_5_Comb5_1.Cells [VI_CNTCELULAS, VI_LINHAS2] := RIGHTSTR ('0'+(STRGR_TODOS_NUMEROS.Cells[VI_CONTAR,0]),2) ;
                                                             VI_CNTCELULAS := VI_CNTCELULAS + 1;
                                                         END; // IF (STRGR_TODOS_NUMEROS
                                                       END; // FOR VI_CONTAR
                                                                 VI_LINHAS2 := VI_LINHAS2+1;
                    ...
                    END; // FOR VI_COMBINACOES04
               END; // FOR VI_COMBINACOES03
               STGR_LINHA_5_Comb5_1.RowCount := VI_LINHAS2;               
         // end; //  FOR VI_COMBINACOES02
     end; // FOR VI_COMBINACOES01
     STGR_LINHA_5_Comb5_1.RowCount := VI_LINHAS2;
     STGR_LINHA_5_Comb5_1.FixedRows := 1;
               // -------------------------------
               // --  Removendo os repetidos   --
               // -------------------------------
     FOR VI_COMBINACOES01:= 1 TO (STGR_LINHA_5_Comb5_1.RowCount-1) DO
     BEGIN
          FOR VI_COMBINACOES02:= VI_COMBINACOES01+1 TO (STGR_LINHA_5_Comb5_1.RowCount-1) {VI_COMBINACOES01+900}  DO
          BEGIN
                IF  (STGR_LINHA_5_Comb5_1.Cells[3,VI_COMBINACOES01] = STGR_LINHA_5_Comb5_1.Cells[3,VI_COMBINACOES02]) AND
                    (STGR_LINHA_5_Comb5_1.Cells[4,VI_COMBINACOES01] = STGR_LINHA_5_Comb5_1.Cells[4,VI_COMBINACOES02])
                    THEN
                BEGIN
                    IF  (STGR_LINHA_5_Comb5_1.Cells[5,VI_COMBINACOES01] = STGR_LINHA_5_Comb5_1.Cells[5,VI_COMBINACOES02]) AND
                        (STGR_LINHA_5_Comb5_1.Cells[6,VI_COMBINACOES01] = STGR_LINHA_5_Comb5_1.Cells[6,VI_COMBINACOES02]) AND
                        (STGR_LINHA_5_Comb5_1.Cells[7,VI_COMBINACOES01] = STGR_LINHA_5_Comb5_1.Cells[7,VI_COMBINACOES02])
                        THEN
                    BEGIN
                        STGR_LINHA_5_Comb5_1.Cells [1,VI_COMBINACOES02] := 'F';
                    END; // if (STGR_LINHA_5_Comb5_1.Cells[1,VI_CONTAR]
                END; // if (STGR_LINHA_5_Comb5_1.Cells[1,VI_CONTAR]
          END; // FOR VI_COMBINACOES02
     END; // FOR VI_COMBINACOES01
                    // -------------------------------
          ...
          BEGIN
               IF  NOT( STRtoINT(ED_EXC_01.Text) = 0 ) THEN
               BEGIN
                    IF  (STRtoINT(STGR_LINHA_5_Comb5_1.Cells[3,VI_COMBINACOES01]) = STRtoINT(ED_EXC_01.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb5_1.Cells[4,VI_COMBINACOES01]) = STRtoINT(ED_EXC_01.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb5_1.Cells[5,VI_COMBINACOES01]) = STRtoINT(ED_EXC_01.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb5_1.Cells[6,VI_COMBINACOES01]) = STRtoINT(ED_EXC_01.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb5_1.Cells[7,VI_COMBINACOES01]) = STRtoINT(ED_EXC_01.Text)) 
                        THEN
                    BEGIN
                        STGR_LINHA_5_Comb5_1.Cells [1,VI_COMBINACOES01] := 'F';
                    END; // if (STGR_LINHA_1_TODOS.Cells[1,VI_CONTAR]
               END; // IF NOT
          END; // FOR VI_COMBINACOES01
          FOR VI_COMBINACOES01:= 1 TO (STGR_LINHA_5_Comb5_1.RowCount-1) DO
          BEGIN
               IF  NOT( STRtoINT(ED_EXC_02.Text) = 0 ) THEN
               BEGIN
                    IF  (STRtoINT(STGR_LINHA_5_Comb5_1.Cells[3,VI_COMBINACOES01]) = STRtoINT(ED_EXC_02.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb5_1.Cells[4,VI_COMBINACOES01]) = STRtoINT(ED_EXC_02.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb5_1.Cells[5,VI_COMBINACOES01]) = STRtoINT(ED_EXC_02.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb5_1.Cells[6,VI_COMBINACOES01]) = STRtoINT(ED_EXC_02.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb5_1.Cells[7,VI_COMBINACOES01]) = STRtoINT(ED_EXC_02.Text)) 
                        THEN
                    BEGIN
                        STGR_LINHA_5_Comb5_1.Cells [1,VI_COMBINACOES01] := 'F';
                    END; // if (STGR_LINHA_1_TODOS.Cells[1,VI_CONTAR]
          ...
          BEGIN
               IF  NOT( STRtoINT(ED_EXC_03.Text) = 0 ) THEN
               BEGIN
                    IF  (STRtoINT(STGR_LINHA_5_Comb5_1.Cells[3,VI_COMBINACOES01]) = STRtoINT(ED_EXC_03.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb5_1.Cells[4,VI_COMBINACOES01]) = STRtoINT(ED_EXC_03.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb5_1.Cells[5,VI_COMBINACOES01]) = STRtoINT(ED_EXC_03.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb5_1.Cells[6,VI_COMBINACOES01]) = STRtoINT(ED_EXC_03.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb5_1.Cells[7,VI_COMBINACOES01]) = STRtoINT(ED_EXC_03.Text)) 
                        THEN
                    BEGIN
                        STGR_LINHA_5_Comb5_1.Cells [1,VI_COMBINACOES01] := 'F';
                    END; // if (STGR_LINHA_1_TODOS.Cells[1,VI_CONTAR]
     ...
     FOR VI_COMBINACOES01:= 1 TO (STGR_LINHA_5_Comb5_1.RowCount-1) DO
     BEGIN
          IF (STGR_LINHA_5_Comb5_1.Cells [1,VI_COMBINACOES01] = 'V') THEN VI_CONTAR:=VI_CONTAR +1;
     END;
     LA_LINHA5_Comb5_1.Caption := INTtOSTR(VI_CONTAR);



        // ******************************
        // **  LINHA_5 - 4 combinações 1DP + 2 **
        // ******************************
     VI_LINHAS2:= 1;
     FOR VI_COMBINACOES01:= 1 TO 6 DO
     BEGIN
          //FOR VI_COMBINACOES02:= VI_COMBINACOES01+1 TO 6 DO
          //BEGIN
               STGR_LINHA_5_Comb4_1.Cells[2,VI_LINHAS2] := '4';
               STGR_LINHA_5_Comb4_1.Cells[1,VI_LINHAS2] := 'V';
               STGR_LINHA_5_Comb4_1.Cells[3,VI_LINHAS2] := STGR_BASE_L5.Cells[1,VI_COMBINACOES01];
               STGR_LINHA_5_Comb4_1.Cells[4,VI_LINHAS2] := STGR_BASE_L5.Cells[2,VI_COMBINACOES01];
               FOR VI_COMBINACOES03:= 1 TO 6 DO
               BEGIN
                    FOR VI_COMBINACOES04:=1 TO 2 DO
                    BEGIN
                         ...
                         STGR_LINHA_5_Comb4_1.Cells[3,VI_LINHAS2] := STGR_BASE_L5.Cells[1,VI_COMBINACOES01];
                         STGR_LINHA_5_Comb4_1.Cells[4,VI_LINHAS2] := STGR_BASE_L5.Cells[2,VI_COMBINACOES01];
                         STGR_LINHA_5_Comb4_1.Cells[5,VI_LINHAS2] := STGR_BASE_L5.Cells[VI_COMBINACOES04,VI_COMBINACOES03];
                         IF  (STGR_LINHA_5_Comb4_1.Cells[5,VI_LINHAS2] = STGR_LINHA_5_Comb4_1.Cells[3,VI_LINHAS2]) OR (STGR_LINHA_5_Comb4_1.Cells[5,VI_LINHAS2] = STGR_LINHA_5_Comb4_1.Cells[4,VI_LINHAS2])
                         THEN
                              CONTINUE;
                         STGR_LINHA_5_Comb4_1.Cells[0,VI_LINHAS2] := INTtoSTR(VI_LINHAS2);
                         FOR VI_COMBINACOES05:=1 TO 6 DO
                         BEGIN
                              FOR VI_COMBINACOES06:=1 TO 2 DO
                              BEGIN
                                   ...
                                   STGR_LINHA_5_Comb4_1.Cells[4,VI_LINHAS2] := STGR_BASE_L5.Cells[2,VI_COMBINACOES01];
                                   STGR_LINHA_5_Comb4_1.Cells[5,VI_LINHAS2] := STGR_BASE_L5.Cells[VI_COMBINACOES04,VI_COMBINACOES03];
                                   STGR_LINHA_5_Comb4_1.Cells[6,VI_LINHAS2] := STGR_BASE_L5.Cells[VI_COMBINACOES06,VI_COMBINACOES05];
                                   IF  (STGR_LINHA_5_Comb4_1.Cells[6,VI_LINHAS2] = STGR_LINHA_5_Comb4_1.Cells[3,VI_LINHAS2]) OR (STGR_LINHA_5_Comb4_1.Cells[6,VI_LINHAS2] = STGR_LINHA_5_Comb4_1.Cells[4,VI_LINHAS2]) OR
                                       (STGR_LINHA_5_Comb4_1.Cells[6,VI_LINHAS2] = STGR_LINHA_5_Comb4_1.Cells[5,VI_LINHAS2]) 
                                   THEN
                                        CONTINUE;
                                   IF (VI_COMBINACOES03 = VI_COMBINACOES05) THEN
                                        CONTINUE;
                                   STGR_LINHA_5_Comb4_1.Cells[0,VI_LINHAS2] := INTtoSTR(VI_LINHAS2);
                                                       ...
                                                       BEGIN
                                                            STRGR_TODOS_NUMEROS.Cells [ (STRtoINT(STGR_LINHA_5_Comb4_1.Cells[VI_CONTAR,VI_LINHAS2])) ,1]:='V';
                                                       END; // FOR VI_CONTAR1
                                                       VI_CNTCELULAS := 3;
                                                       FOR VI_CONTAR :=1 TO 25 DO
                                                       BEGIN
                                                         IF (STRGR_TODOS_NUMEROS.Cells[VI_CONTAR,1]='V') THEN
                                                         BEGIN
                                                             STGR_LINHA_5_Comb4_1.Cells [VI_CNTCELULAS, VI_LINHAS2] := RIGHTSTR ('0'+(STRGR_TODOS_NUMEROS.Cells[VI_CONTAR,0]),2) ;
                                                             VI_CNTCELULAS := VI_CNTCELULAS + 1;
                                                         END; // IF (STRGR_TODOS_NUMEROS
                                                       END; // FOR VI_CONTAR
                                                                 VI_LINHAS2 := VI_LINHAS2+1;
                    ...
                    END; // FOR VI_COMBINACOES04
               END; // FOR VI_COMBINACOES03
               STGR_LINHA_5_Comb4_1.RowCount := VI_LINHAS2;               
         // end; //  FOR VI_COMBINACOES02
     end; // FOR VI_COMBINACOES01
     STGR_LINHA_5_Comb4_1.RowCount := VI_LINHAS2;
     STGR_LINHA_5_Comb4_1.FixedRows := 1;
               // -------------------------------
               // --  Removendo os repetidos   --
               // -------------------------------
     FOR VI_COMBINACOES01:= 1 TO (STGR_LINHA_5_Comb4_1.RowCount-1) DO
     BEGIN
          FOR VI_COMBINACOES02:= VI_COMBINACOES01+1 TO (STGR_LINHA_5_Comb4_1.RowCount-1) {VI_COMBINACOES01+900}  DO
          BEGIN
                IF  (STGR_LINHA_5_Comb4_1.Cells[3,VI_COMBINACOES01] = STGR_LINHA_5_Comb4_1.Cells[3,VI_COMBINACOES02]) AND
                    (STGR_LINHA_5_Comb4_1.Cells[4,VI_COMBINACOES01] = STGR_LINHA_5_Comb4_1.Cells[4,VI_COMBINACOES02])
                    THEN
                BEGIN
                    IF  (STGR_LINHA_5_Comb4_1.Cells[5,VI_COMBINACOES01] = STGR_LINHA_5_Comb4_1.Cells[5,VI_COMBINACOES02]) AND
                        (STGR_LINHA_5_Comb4_1.Cells[6,VI_COMBINACOES01] = STGR_LINHA_5_Comb4_1.Cells[6,VI_COMBINACOES02])
                        THEN
                    BEGIN
                        STGR_LINHA_5_Comb4_1.Cells [1,VI_COMBINACOES02] := 'F';
                    END; // if (STGR_LINHA_5_Comb4_1.Cells[1,VI_CONTAR]
                END; // if (STGR_LINHA_5_Comb4_1.Cells[1,VI_CONTAR]
          END; // FOR VI_COMBINACOES02
     END; // FOR VI_COMBINACOES01
                    // -------------------------------
          ...
          BEGIN
               IF  NOT( STRtoINT(ED_EXC_01.Text) = 0 ) THEN
               BEGIN
                    IF  (STRtoINT(STGR_LINHA_5_Comb4_1.Cells[3,VI_COMBINACOES01]) = STRtoINT(ED_EXC_01.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb4_1.Cells[4,VI_COMBINACOES01]) = STRtoINT(ED_EXC_01.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb4_1.Cells[5,VI_COMBINACOES01]) = STRtoINT(ED_EXC_01.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb4_1.Cells[6,VI_COMBINACOES01]) = STRtoINT(ED_EXC_01.Text))
                        THEN
                    BEGIN
                        STGR_LINHA_5_Comb4_1.Cells [1,VI_COMBINACOES01] := 'F';
                    END; // if (STGR_LINHA_1_TODOS.Cells[1,VI_CONTAR]
               END; // IF NOT
          END; // FOR VI_COMBINACOES01
          FOR VI_COMBINACOES01:= 1 TO (STGR_LINHA_5_Comb4_1.RowCount-1) DO
          BEGIN
               IF  NOT( STRtoINT(ED_EXC_02.Text) = 0 ) THEN
               BEGIN
                    IF  (STRtoINT(STGR_LINHA_5_Comb4_1.Cells[3,VI_COMBINACOES01]) = STRtoINT(ED_EXC_02.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb4_1.Cells[4,VI_COMBINACOES01]) = STRtoINT(ED_EXC_02.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb4_1.Cells[5,VI_COMBINACOES01]) = STRtoINT(ED_EXC_02.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb4_1.Cells[6,VI_COMBINACOES01]) = STRtoINT(ED_EXC_02.Text))
                        THEN
                    BEGIN
                        STGR_LINHA_5_Comb4_1.Cells [1,VI_COMBINACOES01] := 'F';
                    END; // if (STGR_LINHA_1_TODOS.Cells[1,VI_CONTAR]
          ...
          BEGIN
               IF  NOT( STRtoINT(ED_EXC_03.Text) = 0 ) THEN
               BEGIN
                    IF  (STRtoINT(STGR_LINHA_5_Comb4_1.Cells[3,VI_COMBINACOES01]) = STRtoINT(ED_EXC_03.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb4_1.Cells[4,VI_COMBINACOES01]) = STRtoINT(ED_EXC_03.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb4_1.Cells[5,VI_COMBINACOES01]) = STRtoINT(ED_EXC_03.Text)) OR
                        (STRtoINT(STGR_LINHA_5_Comb4_1.Cells[6,VI_COMBINACOES01]) = STRtoINT(ED_EXC_03.Text))
                        THEN
                    BEGIN
                        STGR_LINHA_5_Comb4_1.Cells [1,VI_COMBINACOES01] := 'F';
                    END; // if (STGR_LINHA_1_TODOS.Cells[1,VI_CONTAR]
     ...
     FOR VI_COMBINACOES01:= 1 TO (STGR_LINHA_5_Comb4_1.RowCount-1) DO
     BEGIN
          IF (STGR_LINHA_5_Comb4_1.Cells [1,VI_COMBINACOES01] = 'V') THEN VI_CONTAR:=VI_CONTAR +1;
     END;
     LA_LINHA5_Comb4_1.Caption := INTtOSTR(VI_CONTAR);
     ...
     SELF.Repaint;
            ...
            SELF.IBQ_COMBINACOES.SQL.Clear;
            SELF.IBQ_COMBINACOES.SQL.Add('DELETE FROM FILTRO_05_DEFINICAO')  ;
            SELF.IBQ_COMBINACOES.ExecSQL;
            SELF.IBQ_COMBINACOES.SQL.Clear;
            SELF.IBQ_COMBINACOES.SQL.Add('DELETE FROM FILTRO_05_DADOS')  ;
            SELF.IBQ_COMBINACOES.ExecSQL;
            SELF.IBQ_COMBINACOES.SQL.Clear;
            SELF.IBQ_COMBINACOES.SQL.Add('DELETE FROM FILTRO_05_DADOS_TEMP')  ;
            SELF.IBQ_COMBINACOES.ExecSQL;
            SELF.IBQ_COMBINACOES.SQL.Clear;
            SELF.IBQ_COMBINACOES.SQL.Add('UPDATE FILTRO_05_DEFINICAO SET FLAG_FILTRAR =''N'', FLAG_GRAVAR= ''N'';')  ;
            SELF.IBQ_COMBINACOES.ExecSQL;
...
procedure T_F_SIM_01_FILTRO_05.BBT_GERAR_FILTROClick(Sender: TObject);
begin
...
procedure T_F_SIM_01_FILTRO_05.BBT_GERARClick(Sender: TObject);
    ...
    BEGIN
        ...
        BEGIN
            ...
            VC_DADOS56 := RIGHTSTR ('0'+STGR_BASE_L5.Cells[1,6],2) + ' ' + RIGHTSTR ('0'+STGR_BASE_L5.Cells[2,6],2) ;
                SELF.IBQ_COMBINACOES.SQL.Clear;
            VC_QUERY  := 'INSERT INTO FILTRO_05_DEFINICAO (LINHA_1, LINHA_2, LINHA_3, LINHA_4, LINHA_5_1, LINHA_5_2, LINHA_5_3, LINHA_5_4, LINHA_5_5, LINHA_5_6, ';
        ...
        BEGIN
           ...
           // SHOWMESSAGE ('DADOS-1 -> Gerar o Banco de Dados');
            ...
            BEGIN
                ...
                SELF.IBQ_COMBINACOES.SQL.Clear;
                VC_QUERY  := 'INSERT INTO FILTRO_05_DADOS_TEMP (DADOS) VALUES(' +#39+ VC_COMBINACOES + #39 +');';
                SELF.IBQ_COMBINACOES.SQL.Add(VC_QUERY)  ;
                SELF.IBQ_COMBINACOES.ExecSQL;
            END;
            SELF.IBQ_COMBINACOES.SQL.Clear;
            VC_QUERY  := 'UPDATE FILTRO_05_DEFINICAO SET CONTADOR_C1 =' + #39+ INTtoSTR(VI_COMBINACOES0_C1) +#39+';';
            SELF.IBQ_COMBINACOES.SQL.Add(VC_QUERY)  ;
            SELF.IBQ_COMBINACOES.ExecSQL;
            VI_LINHAS2:=1;
            STGR_COMB15.RowCount := VI_LINHAS2;
             ...
             BEGIN
                  SELF.IBQ_COMBINACOES.SQL.Clear;
                  SELF.IBQ_COMBINACOES.SQL.Add('execute procedure FILTRO_05_100repet01' )  ;
                  SELF.IBQ_COMBINACOES.ExecSQL;
                  SELF.IBQ_COMBINACOES.SQL.Clear;
                  SELF.IBQ_COMBINACOES.SQL.Add('DELETE FROM FILTRO_05_DADOS_TEMP')  ;
                  SELF.IBQ_COMBINACOES.ExecSQL;
...
begin
    ...
    // =================== AQUI
     ...
     BEGIN
          ...
          IF (CB_MODO_FILTRO.ItemIndex =3) AND (STRtoINT(STGR_LINHA_1234_TODOS.Cells[2,VI_COMBINACOES01]) = 11) THEN
          BEGIN
               FOR VI_COMBINACOES02 := 1{16} TO {18} (STGR_LINHA_5_Comb4_1.RowCount-1) DO
               BEGIN
                   // **********************
                   // **   5 - 1 dupla + 3
                   // **********************
                   IF (STGR_LINHA_1234_TODOS.Cells[1,VI_COMBINACOES01]='V') AND (STGR_LINHA_5_Comb4_1.Cells[1,VI_COMBINACOES02]='V') THEN
                    BEGIN
                    // ***************************************************************************************************
                    // **   VERIFICANDO OS FIXOS NOS 10   PRIMEIROS NUMEROS DA LINHS_1234 E NAS 4 DA STGR_LINHA_5_Comb4_1  **
                    // ***************************************************************************************************
                         if NOT(STRtoINT(ED_fixoS_01.Text)=0) AND
                             ...
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[11,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_01.Text)) OR
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[12,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_01.Text)) OR
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[13,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_05.Text)) OR                              
                             (STRtoINT(STGR_LINHA_5_Comb4_1.Cells[3,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_01.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb4_1.Cells[4,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_01.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb4_1.Cells[5,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_01.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb4_1.Cells[6,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_01.Text))
                             ))
                         THEN
                              CONTINUE;
                         if NOT(STRtoINT(ED_fixoS_02.Text)=0) AND
                             ...
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[11,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_02.Text))  OR
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[12,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_02.Text)) OR
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[13,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_05.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb4_1.Cells[3,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_02.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb4_1.Cells[4,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_02.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb4_1.Cells[5,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_02.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb4_1.Cells[6,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_02.Text))
                             ))
                         THEN
                              CONTINUE;
                         if NOT(STRtoINT(ED_fixoS_03.Text)=0) AND
                             ...
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[11,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_03.Text))  OR
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[12,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_03.Text)) OR
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[13,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_05.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb4_1.Cells[3,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_03.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb4_1.Cells[4,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_03.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb4_1.Cells[5,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_03.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb4_1.Cells[6,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_03.Text))
                              ))
                         THEN
                              CONTINUE;
                         if NOT(STRtoINT(ED_fixoS_04.Text)=0) AND
                             ...
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[11,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_04.Text))  OR
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[12,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_04.Text)) OR
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[13,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_05.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb4_1.Cells[3,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_04.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb4_1.Cells[4,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_04.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb4_1.Cells[5,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_04.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb4_1.Cells[6,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_04.Text))
                             ))
                         THEN
                              CONTINUE;
                         if NOT(STRtoINT(ED_fixoS_05.Text)=0) AND
                             ...
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[11,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_05.Text))  OR
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[12,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_05.Text)) OR
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[13,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_05.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb4_1.Cells[3,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_05.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb4_1.Cells[4,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_05.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb4_1.Cells[5,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_05.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb4_1.Cells[6,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_05.Text))
                             ))
                         THEN
                              CONTINUE;
                         // ===> PEGA 10 NUMEROS
                         ...
                         STGR_COMB15.Cells[3,VI_LINHAS2] := '(5/1DP)';
                         ...
                         STGR_COMB15.Cells[12,VI_LINHAS2] := STGR_LINHA_1234_TODOS.Cells[11,VI_COMBINACOES01];
                         STGR_COMB15.Cells[13,VI_LINHAS2] := STGR_LINHA_1234_TODOS.Cells[12,VI_COMBINACOES01];
                         STGR_COMB15.Cells[14,VI_LINHAS2] := STGR_LINHA_1234_TODOS.Cells[13,VI_COMBINACOES01];
                         // ===> PEGA 5 NUMEROS
                         STGR_COMB15.Cells[15,VI_LINHAS2] := STGR_LINHA_5_Comb4_1.Cells[3,VI_COMBINACOES02];
                         STGR_COMB15.Cells[16,VI_LINHAS2] := STGR_LINHA_5_Comb4_1.Cells[4,VI_COMBINACOES02];
                         STGR_COMB15.Cells[17,VI_LINHAS2] := STGR_LINHA_5_Comb4_1.Cells[5,VI_COMBINACOES02];
                         STGR_COMB15.Cells[18,VI_LINHAS2] := STGR_LINHA_5_Comb4_1.Cells[6,VI_COMBINACOES02];
          ...
          STGR_COMB15.RowCount := VI_LINHAS2;
          STGR_COMB15.Repaint;
          end; //IF (CB_MODO_FILTRO.ItemIndex <> 0




          IF (CB_MODO_FILTRO.ItemIndex <> 0) AND (CB_MODO_FILTRO.ItemIndex <> 4) AND (STRtoINT(STGR_LINHA_1234_TODOS.Cells[2,VI_COMBINACOES01]) = 10) THEN
          BEGIN
               FOR VI_COMBINACOES02 := 1{16} TO {18} (STGR_LINHA_5_Comb5_1.RowCount-1) DO
               BEGIN
                   // **********************
                   // **   5 - 1 dupla + 3
                   // **********************
                   IF (STGR_LINHA_1234_TODOS.Cells[1,VI_COMBINACOES01]='V') AND (STGR_LINHA_5_Comb5_1.Cells[1,VI_COMBINACOES02]='V') THEN
                    BEGIN
                    // ***************************************************************************************************
                    // **   VERIFICANDO OS FIXOS NOS 10   PRIMEIROS NUMEROS DA LINHS_1234 E NAS 4 DA STGR_LINHA_5_Comb5_1  **
                    // ***************************************************************************************************
                         if NOT(STRtoINT(ED_fixoS_01.Text)=0) AND
                             (NOT(
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[3,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_01.Text)) OR
                             ...
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[11,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_01.Text)) OR
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[12,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_01.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb5_1.Cells[3,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_01.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb5_1.Cells[4,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_01.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb5_1.Cells[5,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_01.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb5_1.Cells[6,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_01.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb5_1.Cells[7,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_01.Text))
                             ))
                         THEN
                              CONTINUE;
                         if NOT(STRtoINT(ED_fixoS_02.Text)=0) AND
                             ...
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[11,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_02.Text))  OR
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[12,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_02.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb5_1.Cells[3,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_02.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb5_1.Cells[4,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_02.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb5_1.Cells[5,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_02.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb5_1.Cells[6,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_02.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb5_1.Cells[7,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_02.Text))
                             ))
                         THEN
                              CONTINUE;
                         if NOT(STRtoINT(ED_fixoS_03.Text)=0) AND
                             ...
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[11,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_03.Text))  OR
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[12,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_03.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb5_1.Cells[3,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_03.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb5_1.Cells[4,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_03.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb5_1.Cells[5,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_03.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb5_1.Cells[6,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_03.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb5_1.Cells[7,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_03.Text))
                              ))
                         THEN
                              CONTINUE;
                         if NOT(STRtoINT(ED_fixoS_04.Text)=0) AND
                             ...
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[11,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_04.Text))  OR
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[12,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_04.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb5_1.Cells[3,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_04.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb5_1.Cells[4,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_04.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb5_1.Cells[5,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_04.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb5_1.Cells[6,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_04.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb5_1.Cells[7,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_04.Text))
                             ))
                         THEN
                              CONTINUE;
                         if NOT(STRtoINT(ED_fixoS_05.Text)=0) AND
                             ...
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[11,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_05.Text))  OR
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[12,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_05.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb5_1.Cells[3,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_05.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb5_1.Cells[4,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_05.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb5_1.Cells[5,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_05.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb5_1.Cells[6,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_05.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb5_1.Cells[7,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_05.Text))
                             ))
                         THEN
                              CONTINUE;
                         // ===> PEGA 10 NUMEROS
                         ...
                         STGR_COMB15.Cells[13,VI_LINHAS2] := STGR_LINHA_1234_TODOS.Cells[12,VI_COMBINACOES01];
                         // ===> PEGA 5 NUMEROS
                         STGR_COMB15.Cells[14,VI_LINHAS2] := STGR_LINHA_5_Comb5_1.Cells[3,VI_COMBINACOES02];
                         STGR_COMB15.Cells[15,VI_LINHAS2] := STGR_LINHA_5_Comb5_1.Cells[4,VI_COMBINACOES02];
                         STGR_COMB15.Cells[16,VI_LINHAS2] := STGR_LINHA_5_Comb5_1.Cells[5,VI_COMBINACOES02];
                         STGR_COMB15.Cells[17,VI_LINHAS2] := STGR_LINHA_5_Comb5_1.Cells[6,VI_COMBINACOES02];
                         STGR_COMB15.Cells[18,VI_LINHAS2] := STGR_LINHA_5_Comb5_1.Cells[7,VI_COMBINACOES02];
                         PR_ORDENAR_SIMULACAO_15 (VI_LINHAS2);
                         PR_GRAVAR_DADOS ('NAO', VI_LINHAS2, VI_COMBINACOES01, TRUNC(STGR_LINHA_1234_TODOS.RowCount-1));
                         VI_LINHAS2 := VI_LINHAS2+1;
                         VI_LINHAS1 := VI_LINHAS1+1;
          ...
          IF (CB_MODO_FILTRO.ItemIndex <> 4) THEN
          BEGIN
               FOR VI_COMBINACOES02 := 1{16} TO {18} (STGR_LINHA_5_Comb6_1.RowCount-1) DO
               BEGIN
                   // **********************
                   // **   6 - 1 dupla + 4
                   // **********************
                   IF (STRtoINT(STGR_LINHA_1234_TODOS.Cells[2,VI_COMBINACOES01]) = 9) AND (STGR_LINHA_1234_TODOS.Cells[1,VI_COMBINACOES01]='V') AND (STGR_LINHA_5_Comb6_1.Cells[1,VI_COMBINACOES02]='V') THEN
                    BEGIN
                    // ***************************************************************************************************
                    // **   VERIFICANDO OS FIXOS NOS 9   PRIMEIROS NUMEROS DA LINHS_1234 E NAS 6 DA STGR_LINHA_5_Comb6_1  **
                    // ***************************************************************************************************
                         if NOT(STRtoINT(ED_fixoS_01.Text)=0) AND
                             (NOT(
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[3,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_01.Text)) OR
                             ...
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[10,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_01.Text)) OR
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[11,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_01.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[3,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_01.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[4,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_01.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[5,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_01.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[6,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_01.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[7,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_01.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[8,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_01.Text))
                             ))
                         THEN
                              CONTINUE;
                         if NOT(STRtoINT(ED_fixoS_02.Text)=0) AND
                             ...
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[10,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_02.Text)) OR
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[11,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_02.Text))  OR
                             (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[3,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_02.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[4,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_02.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[5,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_02.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[6,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_02.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[7,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_02.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[8,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_02.Text))
                             ))
                         THEN
                              CONTINUE;
                         if NOT(STRtoINT(ED_fixoS_03.Text)=0) AND
                             ...
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[10,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_03.Text))  OR
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[11,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_03.Text))  OR
                             (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[3,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_03.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[4,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_03.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[5,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_03.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[6,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_03.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[7,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_03.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[8,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_03.Text))
                              ))
                         THEN
                              CONTINUE;
                         if NOT(STRtoINT(ED_fixoS_04.Text)=0) AND
                             ...
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[10,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_04.Text))  OR
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[11,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_04.Text))  OR
                             (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[3,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_04.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[4,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_04.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[5,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_04.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[6,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_04.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[7,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_04.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[8,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_04.Text))
                             ))
                         THEN
                              CONTINUE;
                         if NOT(STRtoINT(ED_fixoS_05.Text)=0) AND
                             ...
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[10,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_05.Text))  OR
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[11,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_05.Text))  OR
                             (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[3,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_05.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[4,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_05.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[5,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_05.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[6,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_05.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[7,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_05.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6_1.Cells[8,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_05.Text))
                             ))
                         THEN
                              CONTINUE;
                         // ===> PEGA 9 NUMEROS
                         ...
                         STGR_COMB15.Cells[1,VI_LINHAS2] := 'V';
                         STGR_COMB15.Cells[2,VI_LINHAS2] := 'F';
                         STGR_COMB15.Cells[3,VI_LINHAS2] := '(6/1DP)';
                         STGR_COMB15.Cells[4,VI_LINHAS2] := STGR_LINHA_1234_TODOS.Cells[3,VI_COMBINACOES01];
                         STGR_COMB15.Cells[5,VI_LINHAS2] := STGR_LINHA_1234_TODOS.Cells[4,VI_COMBINACOES01];
                         STGR_COMB15.Cells[6,VI_LINHAS2] := STGR_LINHA_1234_TODOS.Cells[5,VI_COMBINACOES01];
                         STGR_COMB15.Cells[7,VI_LINHAS2] := STGR_LINHA_1234_TODOS.Cells[6,VI_COMBINACOES01];
                         ...
                         STGR_COMB15.Cells[12,VI_LINHAS2] := STGR_LINHA_1234_TODOS.Cells[11,VI_COMBINACOES01];
                         // ===> PEGA 6 NUMEROS
                         STGR_COMB15.Cells[13,VI_LINHAS2] := STGR_LINHA_5_Comb6_1.Cells[3,VI_COMBINACOES02];
                         STGR_COMB15.Cells[14,VI_LINHAS2] := STGR_LINHA_5_Comb6_1.Cells[4,VI_COMBINACOES02];
                         STGR_COMB15.Cells[15,VI_LINHAS2] := STGR_LINHA_5_Comb6_1.Cells[5,VI_COMBINACOES02];
                         STGR_COMB15.Cells[16,VI_LINHAS2] := STGR_LINHA_5_Comb6_1.Cells[6,VI_COMBINACOES02];
                         STGR_COMB15.Cells[17,VI_LINHAS2] := STGR_LINHA_5_Comb6_1.Cells[7,VI_COMBINACOES02];
                         STGR_COMB15.Cells[18,VI_LINHAS2] := STGR_LINHA_5_Comb6_1.Cells[8,VI_COMBINACOES02];
                         PR_ORDENAR_SIMULACAO_15 (VI_LINHAS2);
                         PR_GRAVAR_DADOS ('NAO', VI_LINHAS2, VI_COMBINACOES01, TRUNC(STGR_LINHA_1234_TODOS.RowCount-1));
                         VI_LINHAS2 := VI_LINHAS2+1;
                         VI_LINHAS1 := VI_LINHAS1+1;
          ...
          IF (CB_MODO_FILTRO.ItemIndex = 3 ) AND (STRtoINT(STGR_LINHA_1234_TODOS.Cells[2,VI_COMBINACOES01]) = 9) THEN
          BEGIN
               FOR VI_COMBINACOES02 := 1{16} TO {18} (STGR_LINHA_5_Comb6.RowCount-1) DO
               BEGIN
               // **********************
               // **   6 - 2 duplas + 2
               // **********************
                    IF (STGR_LINHA_1234_TODOS.Cells[1,VI_COMBINACOES01]='V') AND (STGR_LINHA_5_Comb6.Cells[1,VI_COMBINACOES02]='V') THEN
                    BEGIN
                    // ***************************************************************************************************
                    ...
                    // ***************************************************************************************************
                         if NOT(STRtoINT(ED_fixoS_01.Text)=0) AND
                             ...
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[10,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_01.Text)) OR
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[11,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_01.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6.Cells[3,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_01.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6.Cells[4,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_01.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6.Cells[5,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_01.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6.Cells[6,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_01.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6.Cells[7,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_01.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6.Cells[8,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_01.Text))
                             ))
                         THEN
                              CONTINUE;
                         if NOT(STRtoINT(ED_fixoS_02.Text)=0) AND
                             ...
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[10,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_02.Text)) OR
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[11,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_02.Text))  OR
                             (STRtoINT(STGR_LINHA_5_Comb6.Cells[3,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_02.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6.Cells[4,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_02.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6.Cells[5,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_02.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6.Cells[6,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_02.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6.Cells[7,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_02.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6.Cells[8,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_02.Text))
                             ))
                         THEN
                              CONTINUE;
                         if NOT(STRtoINT(ED_fixoS_03.Text)=0) AND
                             ...
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[10,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_03.Text))  OR
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[11,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_03.Text))  OR
                             (STRtoINT(STGR_LINHA_5_Comb6.Cells[3,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_03.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6.Cells[4,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_03.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6.Cells[5,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_03.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6.Cells[6,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_03.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6.Cells[7,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_03.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6.Cells[8,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_03.Text))
                              ))
                         THEN
                              CONTINUE;
                         if NOT(STRtoINT(ED_fixoS_04.Text)=0) AND
                             ...
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[10,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_04.Text))  OR
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[11,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_04.Text))  OR
                             (STRtoINT(STGR_LINHA_5_Comb6.Cells[3,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_04.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6.Cells[4,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_04.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6.Cells[5,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_04.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6.Cells[6,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_04.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6.Cells[7,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_04.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6.Cells[8,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_04.Text))
                             ))
                         THEN
                              CONTINUE;
                         if NOT(STRtoINT(ED_fixoS_05.Text)=0) AND
                             ...
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[10,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_05.Text))  OR
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[11,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_05.Text))  OR
                             (STRtoINT(STGR_LINHA_5_Comb6.Cells[3,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_05.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6.Cells[4,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_05.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6.Cells[5,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_05.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6.Cells[6,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_05.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6.Cells[7,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_05.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb6.Cells[8,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_05.Text))
                             ))
                         THEN
                              CONTINUE;
                         // ===> PEGA 9 NUMEROS
                         ...
                         STGR_COMB15.Cells[12,VI_LINHAS2] := STGR_LINHA_1234_TODOS.Cells[11,VI_COMBINACOES01];
                         // ===> PEGA 6 NUMEROS
                         STGR_COMB15.Cells[13,VI_LINHAS2] := STGR_LINHA_5_Comb6.Cells[3,VI_COMBINACOES02];
                         STGR_COMB15.Cells[14,VI_LINHAS2] := STGR_LINHA_5_Comb6.Cells[4,VI_COMBINACOES02];
                         STGR_COMB15.Cells[15,VI_LINHAS2] := STGR_LINHA_5_Comb6.Cells[5,VI_COMBINACOES02];
                         STGR_COMB15.Cells[16,VI_LINHAS2] := STGR_LINHA_5_Comb6.Cells[6,VI_COMBINACOES02];
                         STGR_COMB15.Cells[17,VI_LINHAS2] := STGR_LINHA_5_Comb6.Cells[7,VI_COMBINACOES02];
                         STGR_COMB15.Cells[18,VI_LINHAS2] := STGR_LINHA_5_Comb6.Cells[8,VI_COMBINACOES02];
                         PR_ORDENAR_SIMULACAO_15 (VI_LINHAS2);
                         PR_GRAVAR_DADOS ('NAO', VI_LINHAS2, VI_COMBINACOES01, TRUNC(STGR_LINHA_1234_TODOS.RowCount-1));
                         VI_LINHAS2 := VI_LINHAS2+1;
                         VI_LINHAS1 := VI_LINHAS1+1;
          ...
          VI_CONTAR_COMB1 := VI_CONTAR_COMB1 +1 ;
          IF (CB_MODO_FILTRO.ItemIndex <> 0) AND (STRtoINT(STGR_LINHA_1234_TODOS.Cells[2,VI_COMBINACOES01]) = 8) THEN
          BEGIN
               ...
               // **   7 - 2 duplas + 3
               // **********************
                    IF (STGR_LINHA_1234_TODOS.Cells[1,VI_COMBINACOES01]='V') AND (STGR_LINHA_5_Comb7.Cells[1,VI_COMBINACOES02]='V') THEN
                    BEGIN
                    // ***************************************************************************************************
                    ...
                    // ***************************************************************************************************
                         ...
                         THEN
                              CONTINUE;
                          IF (CB_MODO_FILTRO.ItemIndex = 4) AND (STRtoINT(STGR_LINHA_1234_TODOS.Cells[16,VI_COMBINACOES01]) <>1) THEN
                              CONTINUE;
                          IF (CB_MODO_FILTRO.ItemIndex = 4) AND (STRtoINT(STGR_LINHA_1234_TODOS.Cells[17,VI_COMBINACOES01]) <>2) THEN
                              CONTINUE;
                          IF (CB_MODO_FILTRO.ItemIndex = 4) AND (STRtoINT(STGR_LINHA_1234_TODOS.Cells[18,VI_COMBINACOES01]) <>1) THEN
                              CONTINUE;
                         // ===> PEGA 8 NUMEROS
                         STGR_COMB15.Cells[0,VI_LINHAS2] := INTtoSTR(VI_LINHAS2);
                         STGR_COMB15.Cells[1,VI_LINHAS2] := 'V';
          ...
          BEGIN
               ...
               // **   7 - 1 dupla + 5
               // **********************
                    IF (STRtoINT(STGR_LINHA_1234_TODOS.Cells[2,VI_COMBINACOES01]) = 8) AND (STGR_LINHA_1234_TODOS.Cells[1,VI_COMBINACOES01]='V') AND (STGR_LINHA_5_Comb7_1.Cells[1,VI_COMBINACOES02]='V') THEN
                    BEGIN
                    // ***************************************************************************************************
          ...
          BEGIN
               ...
               // **   8 - 3 duplas + 2
               // **********************
               FOR VI_COMBINACOES02 := 1{16} TO {18} (STGR_LINHA_5_Comb8_3.RowCount-1) DO
               BEGIN
                    IF (STRtoINT(STGR_LINHA_1234_TODOS.Cells[2,VI_COMBINACOES01]) = 7) AND (STGR_LINHA_1234_TODOS.Cells[1,VI_COMBINACOES01]='V') AND (STGR_LINHA_5_Comb8_3.Cells[1,VI_COMBINACOES02]='V') THEN
                    BEGIN
                    // ***************************************************************************************************
                    // **   VERIFICANDO OS FIXOS NOS 7   PRIMEIROS NUMEROS DA LINHS_1234 E NAS 8 DA STGR_LINHA_5_Comb8_3  **
                    // ***************************************************************************************************
                         if NOT(STRtoINT(ED_fixoS_01.Text)=0) AND
                             (NOT(
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[3,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_01.Text)) OR
                             ...
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[8,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_01.Text)) OR
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[9,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_01.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[3,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_01.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[4,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_01.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[5,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_01.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[6,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_01.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[7,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_01.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[8,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_01.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[9,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_01.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[10,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_01.Text))
                             ))
                         THEN
                              CONTINUE;
                         if NOT(STRtoINT(ED_fixoS_02.Text)=0) AND
                             ...
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[8,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_02.Text)) OR
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[9,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_02.Text))  OR
                             (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[3,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_02.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[4,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_02.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[5,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_02.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[6,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_02.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[7,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_02.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[8,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_02.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[9,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_02.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[10,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_02.Text))
                             ))
                         THEN
                              CONTINUE;
                         if NOT(STRtoINT(ED_fixoS_03.Text)=0) AND
                             ...
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[8,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_03.Text)) OR
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[9,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_03.Text))  OR
                             (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[3,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_03.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[4,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_03.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[5,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_03.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[6,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_03.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[7,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_03.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[8,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_03.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[9,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_03.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[10,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_03.Text))
                              ))
                         THEN
                              CONTINUE;
                         if NOT(STRtoINT(ED_fixoS_04.Text)=0) AND
                             ...
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[8,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_04.Text)) OR
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[9,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_04.Text))  OR
                             (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[3,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_04.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[4,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_04.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[5,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_04.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[6,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_04.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[7,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_04.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[8,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_04.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[9,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_04.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[10,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_04.Text))
                             ))
                         THEN
                              CONTINUE;
                         if NOT(STRtoINT(ED_fixoS_05.Text)=0) AND
                             ...
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[8,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_05.Text)) OR
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[9,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_05.Text))  OR
                             (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[3,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_05.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[4,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_05.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[5,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_05.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[6,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_05.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[7,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_05.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[8,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_05.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[9,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_05.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8_3.Cells[10,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_05.Text))
                             ))
                         THEN
                              CONTINUE;
                         // ===> PEGA 7 NUMEROS
                         ...
                         STGR_COMB15.Cells[1,VI_LINHAS2] := 'V';
                         STGR_COMB15.Cells[2,VI_LINHAS2] := 'F';
                         STGR_COMB15.Cells[3,VI_LINHAS2] := '<8-3DP>';
                         STGR_COMB15.Cells[4,VI_LINHAS2] := STGR_LINHA_1234_TODOS.Cells[3,VI_COMBINACOES01];
                         STGR_COMB15.Cells[5,VI_LINHAS2] := STGR_LINHA_1234_TODOS.Cells[4,VI_COMBINACOES01];
                         STGR_COMB15.Cells[6,VI_LINHAS2] := STGR_LINHA_1234_TODOS.Cells[5,VI_COMBINACOES01];
                         STGR_COMB15.Cells[7,VI_LINHAS2] := STGR_LINHA_1234_TODOS.Cells[6,VI_COMBINACOES01];
                         ...
                         STGR_COMB15.Cells[10,VI_LINHAS2] := STGR_LINHA_1234_TODOS.Cells[9,VI_COMBINACOES01];
                         // ===> PEGA 8 NUMEROS
                         STGR_COMB15.Cells[11,VI_LINHAS2] := STGR_LINHA_5_Comb8_3.Cells[3,VI_COMBINACOES02];
                         STGR_COMB15.Cells[12,VI_LINHAS2] := STGR_LINHA_5_Comb8_3.Cells[4,VI_COMBINACOES02];
                         STGR_COMB15.Cells[13,VI_LINHAS2] := STGR_LINHA_5_Comb8_3.Cells[5,VI_COMBINACOES02];
                         STGR_COMB15.Cells[14,VI_LINHAS2] := STGR_LINHA_5_Comb8_3.Cells[6,VI_COMBINACOES02];
                         STGR_COMB15.Cells[15,VI_LINHAS2] := STGR_LINHA_5_Comb8_3.Cells[7,VI_COMBINACOES02];
                         STGR_COMB15.Cells[16,VI_LINHAS2] := STGR_LINHA_5_Comb8_3.Cells[8,VI_COMBINACOES02];
                         STGR_COMB15.Cells[17,VI_LINHAS2] := STGR_LINHA_5_Comb8_3.Cells[9,VI_COMBINACOES02];
                         STGR_COMB15.Cells[18,VI_LINHAS2] := STGR_LINHA_5_Comb8_3.Cells[10,VI_COMBINACOES02];
                         PR_ORDENAR_SIMULACAO_15 (VI_LINHAS2);
                         PR_GRAVAR_DADOS ('NAO', VI_LINHAS2, VI_COMBINACOES01, TRUNC(STGR_LINHA_1234_TODOS.RowCount-1));
                         VI_LINHAS2 := VI_LINHAS2+1;
                         VI_LINHAS1 := VI_LINHAS1+1;
          ...
          IF (CB_MODO_FILTRO.ItemIndex <> 4) THEN
          BEGIN
               FOR VI_COMBINACOES02 := 1{16} TO {18} (STGR_LINHA_5_Comb8.RowCount-1) DO
               BEGIN
               // **********************
               // **   8 - 2 duplas + 3
               // **********************
                    IF (STRtoINT(STGR_LINHA_1234_TODOS.Cells[2,VI_COMBINACOES01]) = 7) AND (STGR_LINHA_1234_TODOS.Cells[1,VI_COMBINACOES01]='V') AND (STGR_LINHA_5_Comb8.Cells[1,VI_COMBINACOES02]='V') THEN
                    BEGIN
                    // ***************************************************************************************************
                    ...
                    // ***************************************************************************************************
                         if NOT(STRtoINT(ED_fixoS_01.Text)=0) AND
                             ...
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[8,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_01.Text)) OR
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[9,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_01.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8.Cells[3,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_01.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8.Cells[4,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_01.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8.Cells[5,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_01.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8.Cells[6,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_01.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8.Cells[7,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_01.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8.Cells[8,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_01.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8.Cells[9,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_01.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8.Cells[10,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_01.Text))
                             ))
                         THEN
                              CONTINUE;
                         if NOT(STRtoINT(ED_fixoS_02.Text)=0) AND
                             ...
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[8,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_02.Text)) OR
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[9,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_02.Text))  OR
                             (STRtoINT(STGR_LINHA_5_Comb8.Cells[3,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_02.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8.Cells[4,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_02.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8.Cells[5,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_02.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8.Cells[6,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_02.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8.Cells[7,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_02.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8.Cells[8,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_02.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8.Cells[9,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_02.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8.Cells[10,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_02.Text))
                             ))
                         THEN
                              CONTINUE;
                         if NOT(STRtoINT(ED_fixoS_03.Text)=0) AND
                             ...
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[8,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_03.Text)) OR
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[9,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_03.Text))  OR
                             (STRtoINT(STGR_LINHA_5_Comb8.Cells[3,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_03.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8.Cells[4,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_03.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8.Cells[5,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_03.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8.Cells[6,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_03.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8.Cells[7,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_03.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8.Cells[8,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_03.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8.Cells[9,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_03.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8.Cells[10,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_03.Text))
                              ))
                         THEN
                              CONTINUE;
                         if NOT(STRtoINT(ED_fixoS_04.Text)=0) AND
                             ...
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[8,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_04.Text)) OR
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[9,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_04.Text))  OR
                             (STRtoINT(STGR_LINHA_5_Comb8.Cells[3,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_04.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8.Cells[4,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_04.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8.Cells[5,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_04.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8.Cells[6,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_04.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8.Cells[7,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_04.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8.Cells[8,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_04.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8.Cells[9,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_04.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8.Cells[10,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_04.Text))
                             ))
                         THEN
                              CONTINUE;
                         if NOT(STRtoINT(ED_fixoS_05.Text)=0) AND
                             ...
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[8,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_05.Text)) OR
                             (STRtoINT(STGR_LINHA_1234_TODOS.Cells[9,VI_COMBINACOES01]) = STRtoINT(ED_fixoS_05.Text))  OR
                             (STRtoINT(STGR_LINHA_5_Comb8.Cells[3,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_05.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8.Cells[4,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_05.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8.Cells[5,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_05.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8.Cells[6,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_05.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8.Cells[7,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_05.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8.Cells[8,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_05.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8.Cells[9,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_05.Text)) OR
                             (STRtoINT(STGR_LINHA_5_Comb8.Cells[10,VI_COMBINACOES02]) = STRtoINT(ED_fixoS_05.Text))
                             ))
                         THEN
                              CONTINUE;
                         // ===> PEGA 7 NUMEROS
                         ...
                         STGR_COMB15.Cells[10,VI_LINHAS2] := STGR_LINHA_1234_TODOS.Cells[9,VI_COMBINACOES01];
                         // ===> PEGA 8 NUMEROS
                         STGR_COMB15.Cells[11,VI_LINHAS2] := STGR_LINHA_5_Comb8.Cells[3,VI_COMBINACOES02];
                         STGR_COMB15.Cells[12,VI_LINHAS2] := STGR_LINHA_5_Comb8.Cells[4,VI_COMBINACOES02];
                         STGR_COMB15.Cells[13,VI_LINHAS2] := STGR_LINHA_5_Comb8.Cells[5,VI_COMBINACOES02];
                         STGR_COMB15.Cells[14,VI_LINHAS2] := STGR_LINHA_5_Comb8.Cells[6,VI_COMBINACOES02];
                         STGR_COMB15.Cells[15,VI_LINHAS2] := STGR_LINHA_5_Comb8.Cells[7,VI_COMBINACOES02];
                         STGR_COMB15.Cells[16,VI_LINHAS2] := STGR_LINHA_5_Comb8.Cells[8,VI_COMBINACOES02];
                         STGR_COMB15.Cells[17,VI_LINHAS2] := STGR_LINHA_5_Comb8.Cells[9,VI_COMBINACOES02];
                         STGR_COMB15.Cells[18,VI_LINHAS2] := STGR_LINHA_5_Comb8.Cells[10,VI_COMBINACOES02];
                         PR_ORDENAR_SIMULACAO_15 (VI_LINHAS2);
                         PR_GRAVAR_DADOS ('NAO', VI_LINHAS2, VI_COMBINACOES01, TRUNC(STGR_LINHA_1234_TODOS.RowCount-1));
                         VI_LINHAS2 := VI_LINHAS2+1;
                         VI_LINHAS1 := VI_LINHAS1+1;
               ...
               END; // FOR VI_COMBINACOES02
                    ...
                    LA_QTD_COMB.Repaint;
                    //SLEEP(30);
          END; // IF  IF (CB_MODO_FILTRO.ItemIndex
     ...
     SELF.PR_SIMULAR_RECUPERANDODADOS('');
               SELF.IBQ_COMBINACOES.SQL.Clear;
               SELF.IBQ_COMBINACOES.SQL.Add('SELECT COUNT(distinct(dados)) AS SOMADADOS FROM FILTRO_05_DADOS;')  ;
               SELF.IBQ_COMBINACOES.Open;
               IBQ_COMBINACOES.First;
               VI_CONTASEL1 := IBQ_COMBINACOES.FIELDBYNAME('SOMADADOS').AsInteger;
            SELF.IBQ_COMBINACOES.SQL.Clear;
            SELF.IBQ_COMBINACOES.SQL.Add('UPDATE FILTRO_05_DEFINICAO SET HORA_TERMINO ='''+FORMATDATETIME('h:n:s',time())+''', QTD_DADOS= ''' +INTtoSTR(VI_CONTASEL1)+ ''';')  ;
            SELF.IBQ_COMBINACOES.ExecSQL;
            SELF.IBQ_COMBINACOES.SQL.Clear;
            SELF.IBQ_COMBINACOES.SQL.Add('COMMIT')  ;
            SELF.IBQ_COMBINACOES.ExecSQL;
     ...
     LA_rTOTAL_100REPET.Caption := LA_TOTAL_100REPET.Caption+ '    ';
            SELF.IBQ_COMBINACOES.SQL.Clear;
            SELF.IBQ_COMBINACOES.SQL.Add('UPDATE FILTRO_05_DEFINICAO SET FLAG_FILTRAR =''S'', FLAG_GRAVAR= ''S'';')  ;
            SELF.IBQ_COMBINACOES.ExecSQL;
            SELF.IBQ_COMBINACOES.SQL.Clear;
            SELF.IBQ_COMBINACOES.SQL.Add('COMMIT')  ;
            SELF.IBQ_COMBINACOES.ExecSQL;
...
PROCEDURE T_F_SIM_01_FILTRO_05.PR_SIMULAR_RECUPERANDODADOS(VC_TIPO: STRING);
VAR
...
BEGIN
       ...
       SELF.IBQ_COMBINACOES.SQL.Clear;
       SELF.IBQ_COMBINACOES.SQL.Add('SELECT DADOS FROM FILTRO_05_DADOS GROUP BY DADOS ORDER BY DADOS;')  ;
       SELF.IBQ_COMBINACOES.Open;
       ...
       STGR_COMB15.RowCount := VI_AN_COMB1;       
       SELF.IBQ_COMBINACOES.SQL.Clear;
       SELF.IBQ_COMBINACOES.SQL.Add('SELECT * FROM FILTRO_05_DEFINICAO;')  ;
       SELF.IBQ_COMBINACOES.Open;
       STGR_COMB15.REPAINT;
...
procedure T_F_SIM_01_FILTRO_05.BBT_ENCERRARClick(Sender: TObject);
VAR
...
procedure T_F_SIM_01_FILTRO_05.BBT_PA_REMOVEUREPETClick(Sender: TObject);
begin
...
procedure T_F_SIM_01_FILTRO_05.BBT_FIMFILTROClick(Sender: TObject);
begin
...
procedure T_F_SIM_01_FILTRO_05.BBT_GERAR_VOLTARClick(Sender: TObject);
begin
     PA_GERAR.Enabled := TRUE;
     PA_GERAR.Left := 4500;
...
procedure T_F_SIM_01_FILTRO_05.BT_NOVA_SIMULACAOClick(Sender: TObject);
begin
...
procedure T_F_SIM_01_FILTRO_05.BT_CARREGAR_SIMULACAOClick(Sender: TObject);
begin
     BBT_RECOMECAR.Click;
...
procedure T_F_SIM_01_FILTRO_05.FormClose(Sender: TObject;
...
procedure T_F_SIM_01_FILTRO_05.BBT_PREPARAR_MENUClick(Sender: TObject);
begin
     PA_PREPARAR_MENU.Enabled := TRUE;
...
procedure T_F_SIM_01_FILTRO_05.BBT_CANCELARClick(Sender: TObject);
begin
            SELF.IBQ_COMBINACOES.SQL.Clear;
            SELF.IBQ_COMBINACOES.SQL.Add('UPDATE FILTRO_05_DEFINICAO SET FLAG_FILTRAR =''N'', FLAG_GRAVAR= ''N'';')  ;
            SELF.IBQ_COMBINACOES.ExecSQL;
...
procedure T_F_SIM_01_FILTRO_05.Set_SET_FLAG_AUTOEXECUTAR(
  const Value: STRING);
begin
