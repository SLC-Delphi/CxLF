...
type
  T_F_EMULADOR_10_EXC_2 = class(TForm)
...
var
  _F_EMULADOR_10_EXC_2: T_F_EMULADOR_10_EXC_2;

implementation

{$R *.dfm}

procedure T_F_EMULADOR_10_EXC_2.FormCreate(Sender: TObject);
VAR
    VI_CONTAR : INTEGER;
begin
...
procedure T_F_EMULADOR_10_EXC_2.FormClose(Sender: TObject;
...
procedure T_F_EMULADOR_10_EXC_2.BBT_CLOSEClick(Sender: TObject);
begin
     SELF.Close;
end;


procedure T_F_EMULADOR_10_EXC_2.BBT_701Click(Sender: TObject);
begin
...
procedure T_F_EMULADOR_10_EXC_2.BBT_702Click(Sender: TObject);
begin
...
procedure T_F_EMULADOR_10_EXC_2.BBT_703Click(Sender: TObject);
begin
...
procedure T_F_EMULADOR_10_EXC_2.BBT_704Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(4);
    BBT_704.Enabled := FALSE;
end;

procedure T_F_EMULADOR_10_EXC_2.BBT_705Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(5);
    BBT_705.Enabled := FALSE;
end;

procedure T_F_EMULADOR_10_EXC_2.BBT_706Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(6);
    BBT_706.Enabled := FALSE;
end;

procedure T_F_EMULADOR_10_EXC_2.BBT_707Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(7);
    BBT_707.Enabled := FALSE;
end;

procedure T_F_EMULADOR_10_EXC_2.BBT_708Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(8);
    BBT_708.Enabled := FALSE;
end;

procedure T_F_EMULADOR_10_EXC_2.BBT_710Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(10);
    BBT_710.Enabled := FALSE;
end;

procedure T_F_EMULADOR_10_EXC_2.BBT_709Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(9);
    BBT_709.Enabled := FALSE;
end;

procedure T_F_EMULADOR_10_EXC_2.BBT_711Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(11);
    BBT_711.Enabled := FALSE;
end;

procedure T_F_EMULADOR_10_EXC_2.BBT_712Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(12);
    BBT_712.Enabled := FALSE;
end;

procedure T_F_EMULADOR_10_EXC_2.BBT_713Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(13);
    BBT_713.Enabled := FALSE;
end;

procedure T_F_EMULADOR_10_EXC_2.BBT_714Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(14);
    BBT_714.Enabled := FALSE;
end;

procedure T_F_EMULADOR_10_EXC_2.BBT_715Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(15);
    BBT_715.Enabled := FALSE;
end;

procedure T_F_EMULADOR_10_EXC_2.BBT_716Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(16);
    BBT_716.Enabled := FALSE;
end;

procedure T_F_EMULADOR_10_EXC_2.BBT_717Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(17);
    BBT_717.Enabled := FALSE;
end;

procedure T_F_EMULADOR_10_EXC_2.BBT_718Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(18);
    BBT_718.Enabled := FALSE;
end;

procedure T_F_EMULADOR_10_EXC_2.BBT_719Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(19);
    BBT_719.Enabled := FALSE;
end;

procedure T_F_EMULADOR_10_EXC_2.BBT_720Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(20);
    BBT_720.Enabled := FALSE;
end;

procedure T_F_EMULADOR_10_EXC_2.BBT_721Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(21);
    BBT_721.Enabled := FALSE;
end;

procedure T_F_EMULADOR_10_EXC_2.BBT_722Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(22);
    BBT_722.Enabled := FALSE;
end;

procedure T_F_EMULADOR_10_EXC_2.BBT_723Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(23);
    BBT_723.Enabled := FALSE;
end;

procedure T_F_EMULADOR_10_EXC_2.BBT_724Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(24);
    BBT_724.Enabled := FALSE;
end;

procedure T_F_EMULADOR_10_EXC_2.BBT_725Click(Sender: TObject);
begin
...
PROCEDURE T_F_EMULADOR_10_EXC_2.PR_BOTOES_MODELO_12345 (VI_NUMERO: INTEGER);
VAR
...
procedure T_F_EMULADOR_10_EXC_2.BT_NOVA_SIMULACAOClick(Sender: TObject);
VAR
     VsI_CONTAR : SMALLINT;
begin
...
procedure T_F_EMULADOR_10_EXC_2.RB_RES_GABARITOSClick(Sender: TObject);
begin
...
procedure T_F_EMULADOR_10_EXC_2.RB_GABARITOClick(Sender: TObject);
begin
{
     WITH SCBX_GABARITO DO
     BEGIN
     ...
     BEGIN
           ...
           Visible := TRUE;
       END; // WITH
     STGR_LINHA_1_C1.Height := 445;
     STGR_LINHA_1_C2.Height := 445;
     STGR_LINHA_1_C3.Height := 445;
     STGR_LINHA_2_C1.Height := 445;
     STGR_LINHA_2_C2.Height := 445;
     STGR_LINHA_2_C3.Height := 445;
     STGR_LINHA_3_C1.Height := 445;
     STGR_LINHA_3_C2.Height := 445;
     STGR_LINHA_3_C3.Height := 445;
     STGR_LINHA_4_C1.Height := 445;
     STGR_LINHA_4_C2.Height := 445;
     STGR_LINHA_4_C3.Height := 445;
     STGR_LINHA_5_C1.Height := 445;
     STGR_LINHA_5_C2.Height := 445;
     STGR_LINHA_5_C3.Height := 445;
     STGR_LINHA_1_TODOS.Height := 445  ;
     STGR_LINHA_2_TODOS.Height := 445   ;
     STGR_LINHA_3_TODOS.Height := 445   ;
     STGR_LINHA_4_TODOS.Height := 445  ;
     STGR_LINHA_5_TODOS.Height := 445  ; 
     STGR_FLAG_cmbCOL3x4.Height := 275;     
     PA_RESULTADO.Visible  := false;
end;


procedure T_F_EMULADOR_10_EXC_2.RB_RESULTADOSClick(Sender: TObject);
begin
     SCBX_GABARITO.Visible := false;
     PA_RESULTADO.Visible  := TRUE;
end;
...
procedure T_F_EMULADOR_10_EXC_2.TRB_C1_INIChange(Sender: TObject);
begin
...
procedure T_F_EMULADOR_10_EXC_2.TRB_C1_FINALChange(Sender: TObject);
begin
...
procedure T_F_EMULADOR_10_EXC_2.TRB_C2_INIChange(Sender: TObject);
begin
     IF TRB_C2_INI.Position = 1 THEN
          ED_SOMAS_C2_INI.Text := '125';
     IF TRB_C2_INI.Position = 2 THEN
          ED_SOMAS_C2_INI.Text := '126';
     IF TRB_C2_INI.Position = 3 THEN
          ED_SOMAS_C2_INI.Text := '127';
     IF TRB_C2_INI.Position = 4 THEN
          ED_SOMAS_C2_INI.Text := '128';
     IF TRB_C2_INI.Position = 5 THEN
          ED_SOMAS_C2_INI.Text := '129';
     IF TRB_C2_INI.Position = 6 THEN
          ED_SOMAS_C2_INI.Text := '130';
     IF TRB_C2_INI.Position = 7 THEN
          ED_SOMAS_C2_INI.Text := '131';
     IF TRB_C2_INI.Position = 8 THEN
          ED_SOMAS_C2_INI.Text := '132';
     IF TRB_C2_INI.Position = 9 THEN
          ED_SOMAS_C2_INI.Text := '133';
     IF TRB_C2_INI.Position = 10 THEN
          ED_SOMAS_C2_INI.Text := '134';
     IF TRB_C2_INI.Position = 11 THEN
          ED_SOMAS_C2_INI.Text := '135';
END;



procedure T_F_EMULADOR_10_EXC_2.TRB_C2_FINALChange(Sender: TObject);
begin
     IF TRB_C2_FINAL.Position = 1 THEN
          ED_SOMAS_C2_FINAL.Text := '125';
     IF TRB_C2_FINAL.Position = 2 THEN
          ED_SOMAS_C2_FINAL.Text := '126';
     IF TRB_C2_FINAL.Position = 3 THEN
          ED_SOMAS_C2_FINAL.Text := '127';
     IF TRB_C2_FINAL.Position = 4 THEN
          ED_SOMAS_C2_FINAL.Text := '128';
     IF TRB_C2_FINAL.Position = 5 THEN
          ED_SOMAS_C2_FINAL.Text := '129';
     IF TRB_C2_FINAL.Position = 6 THEN
          ED_SOMAS_C2_FINAL.Text := '130';
     IF TRB_C2_FINAL.Position = 7 THEN
          ED_SOMAS_C2_FINAL.Text := '131';
     IF TRB_C2_FINAL.Position = 8 THEN
          ED_SOMAS_C2_FINAL.Text := '132';
     IF TRB_C2_FINAL.Position = 9 THEN
          ED_SOMAS_C2_FINAL.Text := '133';
     IF TRB_C2_FINAL.Position = 10 THEN
          ED_SOMAS_C2_FINAL.Text := '134';
     IF TRB_C2_FINAL.Position = 11 THEN
          ED_SOMAS_C2_FINAL.Text := '135';
end;


procedure T_F_EMULADOR_10_EXC_2.TRB_C3_INIChange(Sender: TObject);
begin
     IF TRB_C3_INI.Position = 1 THEN
          ED_SOMAS_C3_INI.Text := '125';
     IF TRB_C3_INI.Position = 2 THEN
          ED_SOMAS_C3_INI.Text := '126';
     IF TRB_C3_INI.Position = 3 THEN
          ED_SOMAS_C3_INI.Text := '127';
     IF TRB_C3_INI.Position = 4 THEN
          ED_SOMAS_C3_INI.Text := '128';
     IF TRB_C3_INI.Position = 5 tHEN
          ED_SOMAS_C3_INI.Text := '129';
     IF TRB_C3_INI.Position = 6 THEN
          ED_SOMAS_C3_INI.Text := '130';
     IF TRB_C3_INI.Position = 7 THEN
          ED_SOMAS_C3_INI.Text := '131';
     IF TRB_C3_INI.Position = 8 THEN
          ED_SOMAS_C3_INI.Text := '132';
     IF TRB_C3_INI.Position = 9 THEN
          ED_SOMAS_C3_INI.Text := '133';
     IF TRB_C3_INI.Position = 10 THEN
          ED_SOMAS_C3_INI.Text := '134';
     IF TRB_C3_INI.Position = 11 THEN
          ED_SOMAS_C3_INI.Text := '135';
end;


procedure T_F_EMULADOR_10_EXC_2.TRB_C3_FINALChange(Sender: TObject);
begin
     IF TRB_C3_FINAL.Position = 1 THEN
          ED_SOMAS_C3_FINAL.Text := '125';
     IF TRB_C3_FINAL.Position = 2 THEN
          ED_SOMAS_C3_FINAL.Text := '126';
     IF TRB_C3_FINAL.Position = 3 THEN
          ED_SOMAS_C3_FINAL.Text := '127';
     IF TRB_C3_FINAL.Position = 4 THEN
          ED_SOMAS_C3_FINAL.Text := '128';
     IF TRB_C3_FINAL.Position = 5 THEN
          ED_SOMAS_C3_FINAL.Text := '129';
     IF TRB_C3_FINAL.Position = 6 THEN
          ED_SOMAS_C3_FINAL.Text := '130';
     IF TRB_C3_FINAL.Position = 7 THEN
          ED_SOMAS_C3_FINAL.Text := '131';
     IF TRB_C3_FINAL.Position = 8 THEN
          ED_SOMAS_C3_FINAL.Text := '132';
     IF TRB_C3_FINAL.Position = 9 THEN
          ED_SOMAS_C3_FINAL.Text := '133';
     IF TRB_C3_FINAL.Position = 10 THEN
          ED_SOMAS_C3_FINAL.Text := '134';
     IF TRB_C3_FINAL.Position = 11 THEN
          ED_SOMAS_C3_FINAL.Text := '135';
end;


procedure T_F_EMULADOR_10_EXC_2.BBT_RECOMECARClick(Sender: TObject);
VAR
    VI_CONTAR : INTEGER;
begin
...
procedure T_F_EMULADOR_10_EXC_2.BBT_CLICK_TUDOClick(Sender: TObject);
begin
     BBT_701.Click;
     BBT_702.Click;
     BBT_713.Click;
...
procedure T_F_EMULADOR_10_EXC_2.BBT_PREPARARClick(Sender: TObject);
var
    ...
    // ======================================================
     ...
     BEGIN
          ...
          BEGIN
               ...
               BEGIN
                         ...
                         IF (POS(STGR_BASE_L1.Cells[VI_COMBINACOES2,0], VS_NUMEROSPRINCIPAIS)=0) AND (VI_COMBINACOES1<>VI_COMBINACOES3) THEN
                         BEGIN
                              STGR_LINHA_1_C2.Cells[1,VI_LINHAS2] := STGR_BASE_L1.Cells[VI_COMBINACOES2,0];
                              STGR_LINHA_1_C2.Cells[2,VI_LINHAS2] := STGR_BASE_L1.Cells[VI_COMBINACOES3,0];
                         END;
                              ...
                              STGR_BASE_L1.Cells[VI_COMBINACOES3,0];
                                   ...
                                   BEGIN
                                        ...
                                        BEGIN
                                             ...
                                             IF (VI_CONTAR=1) THEN
                                             BEGIN
                                                  STGR_LINHA_1_C3.Cells[1,VI_LINHAS2] := STGR_BASE_L1.Cells[VI_CONTADOR,0];
                                   ...
                                   BEGIN
                                        ...
                                        BEGIN
                                             VI_CONTAR := VI_CONTAR +1;
                                             IF (VI_CONTAR=1) THEN
                                                  STGR_LINHA_1_C3.Cells[2,VI_LINHAS2] := STGR_BASE_L1.Cells[VI_CONTADOR,0];
                                        END;
                                   END; // FOR VI_CONTADOR
                              // ---------------------------------------
     ...
     BEGIN
          ...
          BEGIN
               ...
               STGR_LINHA_1_TODOS.Cells [4, VI_LINHAS2] := STGR_LINHA_1_C2.Cells[2,VI_COMBINACOES1];
                    ...
                    STGR_LINHA_1_TODOS.Cells [10, VI_LINHAS2] := STGR_LINHA_1_C2.Cells[2,VI_COMBINACOES1];
                    STGR_LINHA_1_TODOS.Cells [11, VI_LINHAS2] := STGR_LINHA_1_C3.Cells[1,VI_COMBINACOES1];
                    STGR_LINHA_1_TODOS.Cells [12, VI_LINHAS2] := STGR_LINHA_1_C3.Cells[2,VI_COMBINACOES1];
               VI_LINHAS2 := VI_LINHAS2 +1;
     ...
     BEGIN
          ...
          BEGIN
               ...
               BEGIN
                         ...
                         IF (POS(STGR_BASE_L2.Cells[VI_COMBINACOES2,0], VS_NUMEROSPRINCIPAIS)=0) AND (VI_COMBINACOES1<>VI_COMBINACOES3) THEN
                         BEGIN
                              STGR_LINHA_2_C2.Cells[1,VI_LINHAS2] := STGR_BASE_L2.Cells[VI_COMBINACOES2,0];
                              STGR_LINHA_2_C2.Cells[2,VI_LINHAS2] := STGR_BASE_L2.Cells[VI_COMBINACOES3,0];
                         END;
                              ...
                              STGR_BASE_L2.Cells[VI_COMBINACOES3,0];
                                   ...
                                   BEGIN
                                        ...
                                        BEGIN
                                             ...
                                             IF (VI_CONTAR=1) THEN
                                             BEGIN
                                                  STGR_LINHA_2_C3.Cells[1,VI_LINHAS2] := STGR_BASE_L2.Cells[VI_CONTADOR,0];
                                                  VS_NUMEROSPRINCIPAIS:= VS_NUMEROSPRINCIPAIS+ '-' +
                                   ...
                                   BEGIN
                                        ...
                                        BEGIN
                                             VI_CONTAR := VI_CONTAR +1;
                                             IF (VI_CONTAR=1) THEN
                                                  STGR_LINHA_2_C3.Cells[2,VI_LINHAS2] := STGR_BASE_L2.Cells[VI_CONTADOR,0];
                                        END;
                                   END; // FOR VI_CONTADOR
                              // ---------------------------------------
                              VI_LINHAS2 := VI_LINHAS2 +1;
     ...
     STGR_LINHA_2_C3.Repaint;
          ...
          FOR VI_COMBINACOES1:= 1 TO (STGR_LINHA_2_C1.RowCount-1) DO
          BEGIN
               IF  (STRtoINT(STGR_LINHA_2_C1.Cells[2,VI_COMBINACOES1]) = STRtoINT(ED_EXC_04.Text))
                   THEN
               BEGIN
                   STGR_LINHA_2_C1.Cells [1,VI_COMBINACOES1] := 'F';
               END; // if (STGR_LINHA_2_TODOS.Cells[1,VI_CONTAR]
          ...
          FOR VI_COMBINACOES1:= 1 TO (STGR_LINHA_2_C1.RowCount-1) DO
          BEGIN
               IF  (STRtoINT(STGR_LINHA_2_C1.Cells[2,VI_COMBINACOES1]) = STRtoINT(ED_EXC_05.Text))
                   THEN
               BEGIN
                   STGR_LINHA_2_C1.Cells [1,VI_COMBINACOES1] := 'F';
               END; // if (STGR_LINHA_2_TODOS.Cells[1,VI_CONTAR]
     ...
     BEGIN
          ...
          BEGIN
               ...
               STGR_LINHA_2_TODOS.Cells [4, VI_LINHAS2] := STGR_LINHA_2_C2.Cells[2,VI_COMBINACOES1];
                    // ==> os numeros das próximas celulas não são visiveis, poreém não saõ ordenados, pois correspondem as
                         // as colunas N.LINHA, bC1,bC2,bC3,bC4,bC5,bC6,bC6
                    ...
                    STGR_LINHA_2_TODOS.Cells [10, VI_LINHAS2] := STGR_LINHA_2_C2.Cells[2,VI_COMBINACOES1];
                    STGR_LINHA_2_TODOS.Cells [11, VI_LINHAS2] := STGR_LINHA_2_C3.Cells[1,VI_COMBINACOES1];
                    STGR_LINHA_2_TODOS.Cells [12, VI_LINHAS2] := STGR_LINHA_2_C3.Cells[2,VI_COMBINACOES1];
               VI_LINHAS2 := VI_LINHAS2 +1;
     ...
     BEGIN
          ...
          BEGIN
               ...
               BEGIN
                         ...
                         IF (POS(STGR_BASE_L3.Cells[VI_COMBINACOES2,0], VS_NUMEROSPRINCIPAIS)=0) AND (VI_COMBINACOES1<>VI_COMBINACOES3) THEN
                         BEGIN
                              STGR_LINHA_3_C2.Cells[1,VI_LINHAS2] := STGR_BASE_L3.Cells[VI_COMBINACOES2,0];
                              STGR_LINHA_3_C2.Cells[2,VI_LINHAS2] := STGR_BASE_L3.Cells[VI_COMBINACOES3,0];
                         END;
                              ...
                              STGR_BASE_L3.Cells[VI_COMBINACOES3,0];
                                   ...
                                   BEGIN
                                        ...
                                        BEGIN
                                             ...
                                             IF (VI_CONTAR=1) THEN
                                             BEGIN
                                                  STGR_LINHA_3_C3.Cells[1,VI_LINHAS2] := STGR_BASE_L3.Cells[VI_CONTADOR,0];
                                                  VS_NUMEROSPRINCIPAIS:= VS_NUMEROSPRINCIPAIS+ '-' +
                                   ...
                                   BEGIN
                                        ...
                                        BEGIN
                                             VI_CONTAR := VI_CONTAR +1;
                                             IF (VI_CONTAR=1) THEN
                                                  STGR_LINHA_3_C3.Cells[2,VI_LINHAS2] := STGR_BASE_L3.Cells[VI_CONTADOR,0];
                                        END;
                                   END; // FOR VI_CONTADOR
                              // ---------------------------------------
                              VI_LINHAS2 := VI_LINHAS2 +1;
     ...
     STGR_LINHA_3_C3.Repaint;
          ...
          FOR VI_COMBINACOES1:= 1 TO (STGR_LINHA_3_C1.RowCount-1) DO
          BEGIN
               IF  (STRtoINT(STGR_LINHA_3_C1.Cells[2,VI_COMBINACOES1]) = STRtoINT(ED_EXC_04.Text))
                   THEN
               BEGIN
                   STGR_LINHA_3_C1.Cells [1,VI_COMBINACOES1] := 'F';
               END; // if (STGR_LINHA_3_TODOS.Cells[1,VI_CONTAR]
          ...
          FOR VI_COMBINACOES1:= 1 TO (STGR_LINHA_3_C1.RowCount-1) DO
          BEGIN
               IF  (STRtoINT(STGR_LINHA_3_C1.Cells[2,VI_COMBINACOES1]) = STRtoINT(ED_EXC_05.Text))
                   THEN
               BEGIN
                   STGR_LINHA_3_C1.Cells [1,VI_COMBINACOES1] := 'F';
               END; // if (STGR_LINHA_3_TODOS.Cells[1,VI_CONTAR]
     ...
     BEGIN
          ...
          BEGIN
               ...
               STGR_LINHA_3_TODOS.Cells [4, VI_LINHAS2] := STGR_LINHA_3_C2.Cells[2,VI_COMBINACOES1];
                    // ==> os numeros das próximas celulas não são visiveis, poreém não saõ ordenados, pois correspondem as
                         // as colunas N.LINHA, bC1,bC2,bC3,bC4,bC5,bC6,bC6
                    ...
                    STGR_LINHA_3_TODOS.Cells [10, VI_LINHAS2] := STGR_LINHA_3_C2.Cells[2,VI_COMBINACOES1];
                    STGR_LINHA_3_TODOS.Cells [11, VI_LINHAS2] := STGR_LINHA_3_C3.Cells[1,VI_COMBINACOES1];
                    STGR_LINHA_3_TODOS.Cells [12, VI_LINHAS2] := STGR_LINHA_3_C3.Cells[2,VI_COMBINACOES1];
               VI_LINHAS2 := VI_LINHAS2 +1;
     ...
     BEGIN
          ...
          BEGIN
               ...
               BEGIN
                         ...
                         IF (POS(STGR_BASE_L4.Cells[VI_COMBINACOES2,0], VS_NUMEROSPRINCIPAIS)=0) AND (VI_COMBINACOES1<>VI_COMBINACOES3) THEN
                         BEGIN
                              STGR_LINHA_4_C2.Cells[1,VI_LINHAS2] := STGR_BASE_L4.Cells[VI_COMBINACOES2,0];
                              STGR_LINHA_4_C2.Cells[2,VI_LINHAS2] := STGR_BASE_L4.Cells[VI_COMBINACOES3,0];
                         END;
                              ...
                              STGR_BASE_L4.Cells[VI_COMBINACOES3,0];
                                   ...
                                   BEGIN
                                        ...
                                        BEGIN
                                             ...
                                             IF (VI_CONTAR=1) THEN
                                             BEGIN
                                                  STGR_LINHA_4_C3.Cells[1,VI_LINHAS2] := STGR_BASE_L4.Cells[VI_CONTADOR,0];
                                                  VS_NUMEROSPRINCIPAIS:= VS_NUMEROSPRINCIPAIS+ '-' +
                                   ...
                                   BEGIN
                                        ...
                                        BEGIN
                                             VI_CONTAR := VI_CONTAR +1;
                                             IF (VI_CONTAR=1) THEN
                                                  STGR_LINHA_4_C3.Cells[2,VI_LINHAS2] := STGR_BASE_L4.Cells[VI_CONTADOR,0];
                                        END;
                                   END; // FOR VI_CONTADOR
                              // ---------------------------------------
                              VI_LINHAS2 := VI_LINHAS2 +1;
     ...
     BEGIN
          ...
          BEGIN
               ...
               STGR_LINHA_4_TODOS.Cells [4, VI_LINHAS2] := STGR_LINHA_4_C2.Cells[2,VI_COMBINACOES1];
                    // ==> os numeros das próximas celulas não são visiveis, poreém não saõ ordenados, pois correspondem as
                         // as colunas N.LINHA, bC1,bC2,bC3,bC4,bC5,bC6,bC6
                    ...
                    STGR_LINHA_4_TODOS.Cells [10, VI_LINHAS2] := STGR_LINHA_4_C2.Cells[2,VI_COMBINACOES1];
                    STGR_LINHA_4_TODOS.Cells [11, VI_LINHAS2] := STGR_LINHA_4_C3.Cells[1,VI_COMBINACOES1];
                    STGR_LINHA_4_TODOS.Cells [12, VI_LINHAS2] := STGR_LINHA_4_C3.Cells[2,VI_COMBINACOES1];
               VI_LINHAS2 := VI_LINHAS2 +1;
     ...
     BEGIN
          ...
          BEGIN
               ...
               BEGIN
                         ...
                         IF (POS(STGR_BASE_L5.Cells[VI_COMBINACOES2,0], VS_NUMEROSPRINCIPAIS)=0) AND (VI_COMBINACOES1<>VI_COMBINACOES3) THEN
                         BEGIN
                              STGR_LINHA_5_C2.Cells[1,VI_LINHAS2] := STGR_BASE_L5.Cells[VI_COMBINACOES2,0];
                              STGR_LINHA_5_C2.Cells[2,VI_LINHAS2] := STGR_BASE_L5.Cells[VI_COMBINACOES3,0];
                         END;
                              ...
                              STGR_BASE_L5.Cells[VI_COMBINACOES3,0];
                                   ...
                                   BEGIN
                                        ...
                                        BEGIN
                                             ...
                                             IF (VI_CONTAR=1) THEN
                                             BEGIN
                                                  STGR_LINHA_5_C3.Cells[1,VI_LINHAS2] := STGR_BASE_L5.Cells[VI_CONTADOR,0];
                                                  VS_NUMEROSPRINCIPAIS:= VS_NUMEROSPRINCIPAIS+ '-' +
                                   ...
                                   BEGIN
                                        ...
                                        BEGIN
                                             VI_CONTAR := VI_CONTAR +1;
                                             IF (VI_CONTAR=1) THEN
                                                  STGR_LINHA_5_C3.Cells[2,VI_LINHAS2] := STGR_BASE_L5.Cells[VI_CONTADOR,0];
                                        END;
                                   END; // FOR VI_CONTADOR
                              // ---------------------------------------
                              VI_LINHAS2 := VI_LINHAS2 +1;
     ...
     STGR_LINHA_5_C3.Repaint;
          ...
          FOR VI_COMBINACOES1:= 1 TO (STGR_LINHA_5_C1.RowCount-1) DO
          BEGIN
               IF  (STRtoINT(STGR_LINHA_5_C1.Cells[2,VI_COMBINACOES1]) = STRtoINT(ED_EXC_04.Text))
                   THEN
               BEGIN
                   STGR_LINHA_5_C1.Cells [1,VI_COMBINACOES1] := 'F';
               END; // if (STGR_LINHA_5_TODOS.Cells[1,VI_CONTAR]
          ...
          FOR VI_COMBINACOES1:= 1 TO (STGR_LINHA_5_C1.RowCount-1) DO
          BEGIN
               IF  (STRtoINT(STGR_LINHA_5_C1.Cells[2,VI_COMBINACOES1]) = STRtoINT(ED_EXC_05.Text))
                   THEN
               BEGIN
                   STGR_LINHA_5_C1.Cells [1,VI_COMBINACOES1] := 'F';
               END; // if (STGR_LINHA_5_TODOS.Cells[1,VI_CONTAR]
     ...
     BEGIN
          ...
          BEGIN
               ...
               STGR_LINHA_5_TODOS.Cells [4, VI_LINHAS2] := STGR_LINHA_5_C2.Cells[2,VI_COMBINACOES1];
                    // ==> os numeros das próximas celulas não são visiveis, poreém não saõ ordenados, pois correspondem as
                         // as colunas N.LINHA, bC1,bC2,bC3,bC4,bC5,bC6,bC6
                    ...
                    STGR_LINHA_5_TODOS.Cells [10, VI_LINHAS2] := STGR_LINHA_5_C2.Cells[2,VI_COMBINACOES1];
                    STGR_LINHA_5_TODOS.Cells [11, VI_LINHAS2] := STGR_LINHA_5_C3.Cells[1,VI_COMBINACOES1];
                    STGR_LINHA_5_TODOS.Cells [12, VI_LINHAS2] := STGR_LINHA_5_C3.Cells[2,VI_COMBINACOES1];
               VI_LINHAS2 := VI_LINHAS2 +1;
...
procedure T_F_EMULADOR_10_EXC_2.BBT_GERAR_MENUClick(Sender: TObject);
    ...
    BEGIN
        ...
        BEGIN
            ...
            VC_QUERY  := VC_QUERY + #39 +',' +#39+ ED_SOMAS_C3_INI.Text    + #39 +','+#39+ ED_SOMAS_C3_FINAL.Text  + #39 +',' +#39+ '0'    + #39 +','+#39+ '0'  + #39 +',' +#39+ '0'    + #39 +','+#39+ '0'  + #39 +',' +#39+ '0'    + #39 +','+#39+ '0'  + #39 +','+#39+ ED_EXC_01.Text          + #39 +','+#39+ ED_EXC_02.Text          + #39 +','+#39+ ED_EXC_03.Text       + #39 +','+#39+ ED_EXC_04.Text          + #39 +','+#39+ ED_EXC_05.Text       + #39 +','+#39+ INTtoSTR(VI_COMBINACOES_C1)       + #39 +','+#39+ INTtoSTR(VI_TOTCOMBINACOES_C1);
        ...
        IF ((VI_LINHAS2/8995) = (VI_LINHAS2 DIV 8995))
            or ((VI_LINHAS2/8997) = (VI_LINHAS2 DIV 8997))
...
begin
    ...
    // =================== AQUI
     FOR VI_COMBINACOES1 := 1{23} TO TRUNC((STGR_LINHA_1_TODOS.RowCount-1)/1) DO
     BEGIN
     VI_CONTAR_COMB1 := VI_CONTAR_COMB1 +1 ;
          FOR VI_COMBINACOES2 := 1{1} TO  (STGR_LINHA_2_TODOS.RowCount-1) DO
          BEGIN
               FOR VsI_COMBINACOES3 := 1 {25} TO {28}(STGR_LINHA_3_TODOS.RowCount-1) DO
               BEGIN
                    FOR VsI_COMBINACOES4 := 1{12} TO {14} (STGR_LINHA_4_TODOS.RowCount-1) DO
                    BEGIN
                         // ---------------------------------------
                         // --  MONTANDO O RESULTADO POR COLUNA  --
                         // ---------------------------------------
                         FOR VsI_COMBINACOES5 := 1 {6} TO (STGR_LINHA_5_TODOS.RowCount-1) DO
                         BEGIN
                              // ---------------------------------------
                              // --  COLUNA 1 e 2 -
                              // ---------------------------------------
                             ...
                             VsI_SOMA1 := STRtoINT(STGR_LINHA_1_TODOS.Cells[3, VI_COMBINACOES1])
                              ...
                              + STRtoINT(STGR_LINHA_1_TODOS.Cells[4, VI_COMBINACOES1])
                             ...
                             VsI_SOMA2 := STRtoINT(STGR_LINHA_1_TODOS.Cells[11, VI_COMBINACOES1])
                              ...
                              IF (VsI_SOMA2 >= (STRtoINT(ED_SOMAS_C3_INI.Text))) AND (VsI_SOMA2 <= (STRtoINT(ED_SOMAS_C3_FINAL.Text))) THEN
                              BEGIN
                              ...
                              IF (VsI_FLAG_SOMATORIA1=1) AND (VsI_FLAG_SOMATORIA2=1) AND (VsI_FLAG_SOMATORIA3=1) THEN
                              BEGIN
...
//c                                   STGR_BASE_5.Repaint;
                                   ...
                                   // ---------------------------------------
                                   // --  Todas as Possibilidades p/ Coluna 2 - 1
                                   // ---------------------------------------
                                   VI_LINHAS_3:=1;
                                   ...
                                   // ---------------------------------------
                                   // --  Todas as Possibilidades p/ Coluna 2 -2
                                   // ---------------------------------------
                                   VI_LINHAS_4:=1;
                                   FOR VsI_COMBINACOES6 :=1 TO 5 DO
                                   BEGIN
                                        FOR VsI_COMBINACOES7 :=VsI_COMBINACOES6+1 TO 5 DO
                                        BEGIN
                                             STGR_COL_03.Cells[0,VI_LINHAS_4] := INTtoSTR(VI_LINHAS_4);
                                             STGR_COL_03.Cells[1,VI_LINHAS_4] := STGR_BASE_5.Cells[3, VsI_COMBINACOES6];
                                             STGR_COL_03.Cells[2,VI_LINHAS_4] := STGR_BASE_5.Cells[3, VsI_COMBINACOES7];
                                             STGR_COL_03.Cells[3,VI_LINHAS_4] := INTtoSTR(VsI_COMBINACOES6);
                                             STGR_COL_03.Cells[4,VI_LINHAS_4] := INTtoSTR(VsI_COMBINACOES7);
                                             VI_LINHAS_4:= VI_LINHAS_4+1;
                                        END; // FOR
                                   END; // FOR
                                   STGR_COL_03.RowCount := VI_LINHAS_4;
                                   // ---------------------------------------
                                   // --  Todas as Possibilidades p/ Coluna 2 - 3
                                   // ---------------------------------------
                                   //VI_LINHAS_3:=VI_LINHAS_3 + 1;
                                   FOR VsI_COMBINACOES6 :=1 TO 5 DO
                                   BEGIN
                                        ...
                                        BEGIN
                                             ...
                                             BEGIN
                                                  STGR_COL_02.Cells[0,VI_LINHAS_3] := INTtoSTR(VI_LINHAS_3);
                                                  STGR_COL_02.Cells[1,VI_LINHAS_3] := STGR_BASE_5.Cells[3, VsI_COMBINACOES6];
                                                  STGR_COL_02.Cells[2,VI_LINHAS_3] := STGR_BASE_5.Cells[3, VsI_COMBINACOES7];
                                                  STGR_COL_02.Cells[3,VI_LINHAS_3] := STGR_BASE_5.Cells[3, VsI_COMBINACOES8];
                                                  STGR_COL_02.Cells[4,VI_LINHAS_3] := INTtoSTR(VsI_COMBINACOES6);
                                                  STGR_COL_02.Cells[5,VI_LINHAS_3] := INTtoSTR(VsI_COMBINACOES7);
                                                  STGR_COL_02.Cells[6,VI_LINHAS_3] := INTtoSTR(VsI_COMBINACOES8);
                                                  VI_LINHAS_3:= VI_LINHAS_3+1;
                                   ...
                                   STGR_COL_02.RowCount := VI_LINHAS_3;
                                   // ---------------------------------------
                                   // --  Todas as Possibilidades p/ Coluna 2 -4
                                   // ---------------------------------------
                                   //VI_LINHAS_4:=VI_LINHAS_4 + 1;
                                   FOR VsI_COMBINACOES6 :=1 TO 5 DO
                                   BEGIN
                                        ...
                                        BEGIN
                                             STGR_COL_03.Cells[0,VI_LINHAS_4] := INTtoSTR(VI_LINHAS_4);
                                             STGR_COL_03.Cells[1,VI_LINHAS_4] := STGR_BASE_5.Cells[2, VsI_COMBINACOES6];
                                             STGR_COL_03.Cells[2,VI_LINHAS_4] := STGR_BASE_5.Cells[2, VsI_COMBINACOES7];
                                             STGR_COL_03.Cells[3,VI_LINHAS_4] := INTtoSTR(VsI_COMBINACOES6);
                                             STGR_COL_03.Cells[4,VI_LINHAS_4] := INTtoSTR(VsI_COMBINACOES7);
                                             VI_LINHAS_4:= VI_LINHAS_4+1;
                                        END; // FOR
                                   END; // FOR
                                   STGR_COL_03.RowCount := VI_LINHAS_4;
                                 {  IF  (VI_COMBINACOES1=16) AND (VI_COMBINACOES2=5) AND (VsI_COMBINACOES3=23) AND (VsI_COMBINACOES4=7) AND (VsI_COMBINACOES5=27) THEN
                                   BEGIN
                                        STGR_BASE_5F.Repaint;
                                        SHOWMESSAGE('PRIMEIRO');
                                   END;//    }
                                   // ---------------------------------------
                                   ...
                                   BEGIN
                                        ...
                                        BEGIN
                                             ...
                                             BEGIN
                                 {  IF  (VI_COMBINACOES1=16) AND (VI_COMBINACOES2=5) AND (VsI_COMBINACOES3=23) AND (VsI_COMBINACOES4=7) AND (VsI_COMBINACOES5=27) AND (VsI_COMBINACOES6>=12) AND (VsI_COMBINACOES7>=15) THEN
                                   BEGIN
                                        STGR_BASE_5F.Repaint;
                                        SHOWMESSAGE('SEGUNDO');
                                   END;//  }
                                             ...
                                             END; // IF
                                             IF (VI_LINHAS2 MOD 699)=0 THEN
                                             BEGIN
                                                       PA_RESULTADO.Repaint;
                                                       STGR_BASE_5.Repaint;
                                                       STGR_COMB10.RowCount := VI_LINHAS2;
                                                       STGR_COMB10.Repaint;
                                                       LA_TOTAL_COMB.Caption := '% PROCESSADOS: '+  INTtoSTR(TRUNC(VI_COMBINACOES2/(STGR_LINHA_2_TODOS.RowCount)*100))+ ' %  ';//INTtoSTR(VI_CONTAR_COMB1*VI_COMBINACOES2*VsI_COMBINACOES3*VsI_COMBINACOES4*VsI_COMBINACOES5)+'   ';
...
PROCEDURE T_F_EMULADOR_10_EXC_2.PR_SIMULAR_RECUPERANDODADOS(VC_TIPO: STRING);
VAR
...
procedure T_F_EMULADOR_10_EXC_2.BBT_PA_REMOVEUREPETClick(Sender: TObject);
begin
     PA_REMOVEUREPET.Left := 5000;
     BBT_RECOMECAR.Enabled := false;
     BBT_PREPARAR.Enabled := false;
...
procedure T_F_EMULADOR_10_EXC_2.BBT_BLOCO_NOTASClick(Sender: TObject);
var
    VI_AN_COMB1, VI_CONTAR : INTEGER;
...
procedure T_F_EMULADOR_10_EXC_2.BT_REAJUSTARClick(Sender: TObject);
begin
     PA_PREENCHIMENTO.Visible := TRUE;
     PA_PREENCHIMENTO.Enabled := TRUE;
     PA_GABARITO.Visible := TRUE;
...
procedure T_F_EMULADOR_10_EXC_2.BBT_CARREGARClick(Sender: TObject);
begin
...
procedure T_F_EMULADOR_10_EXC_2.BBT_CANCELARClick(Sender: TObject);
begin
            SELF.IBQ_COMBINACOES.SQL.Clear;
            SELF.IBQ_COMBINACOES.SQL.Add('UPDATE FILTRO_00c_10EXC_DEFINICAO SET FLAG_FILTRAR =''N'', FLAG_GRAVAR= ''N'';')  ;
            SELF.IBQ_COMBINACOES.ExecSQL;
...
PROCEDURE T_F_EMULADOR_10_EXC_2.PR_LIMPAR_GRID10 ();
BEGIN
