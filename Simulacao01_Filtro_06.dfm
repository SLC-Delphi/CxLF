object _F_SIM_01_FILTRO_06: T_F_SIM_01_FILTRO_06
  Left = 21
  Top = 130
  BorderIcons = []
  ...
  object SCBX_GABARITO: TScrollBox
    ...
    object Label7: TLabel
      ...
      Width = 343
      Height = 22
      Caption = 'LINHA 5 - 7 comb. - 2 Duplas  + 3'
      Color = 5242904
      Font.Charset = DEFAULT_CHARSET
      Font.Color = 14217199
      Font.Height = -18
    ...
    object Label14: TLabel
      ...
      Width = 337
      Height = 22
      Caption = 'LINHA 5 - 7 comb. - 1 Duplas + 5'
      Color = 5242904
      Font.Charset = DEFAULT_CHARSET
      Font.Color = 14217199
      Font.Height = -18
    ...
    object LA_LINHA5_Comb7_1: TLabel
      Left = 2849
      Top = 16
      Width = 50
      Height = 17
    ...
    object STGR_LINHA_1234_TODOS: TStringGrid
      Left = 1040
      Top = 34
      Width = 687
      Height = 200
    ...
    object STGR_LINHA_5_Comb7: TStringGrid
      Left = 1757
      Top = 36
      Width = 641
      Height = 199
    ...
    object STGR_LINHA_5_Comb7_1: TStringGrid
      Left = 2427
      Top = 34
      Width = 642
      Height = 200
  ...
  object PA_RESULTADO: TPanel
    ...
    object PA_EXECUTAR_FILTRO: TPanel
      ...
      object BBT_GERAR_FILTRO: TBitBtn
        Left = 7
        Top = 55
        Width = 137
        Height = 41
  ...
  object PA_PREPARAR_MENU: TPanel
    Left = 209
    Top = 138
    Width = 442
    Height = 489
    ...
    object Label12: TLabel
      ...
      Height = 144
      Caption = 
        'LINHA 1 - PEGA 2 N'#186#13#13'LINHA 2 - PEGA DE 1 A 2 N'#186'  -> Destes'#13'LINHA' +
        ' 3 - PEGA DE 1 A 2 N'#186'  -> pegam-se 3 n'#186#13#13'LINHA 4 - PEGA 3 N'#186' SEN' +
        'DO 2 Imp E 1 Par'#13#13'TOTAL DE 8 N'#186' SENDO 5 Impares e 3 Pares'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -15
      Font.Name = 'Verdana'
    ...
    object Label5: TLabel
      ...
      Height = 144
      Caption = 
        'LINHA 1 - PEGA 1 N'#186' Par'#13#13'LINHA 2 - PEGA DE 1 A 3 N'#186'  -> Destes p' +
        'egam-se'#13'LINHA 3 - PEGA DE 1 A 3 N'#186'  ->  4 n'#186' '#205'mpares'#13#13'LINHA 4 - ' +
        'PEGA 3 N'#186' SENDO 1 Impar E 2 Pares'#13#13'TOTAL DE 8 N'#186' SENDO 5 Impares' +
        ' e 3 Pares'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -15
    ...
    object RB_PREPARAR_1: TRadioButton
      Left = 7
      Top = 97
      Width = 26
      Height = 20
    ...
    object RB_PREPARAR_2: TRadioButton
      Left = 7
      Top = 278
      Width = 26
      Height = 20
