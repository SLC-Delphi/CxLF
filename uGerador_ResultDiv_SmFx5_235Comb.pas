...
begin
      ...
      begin
          LA_Titulo.Caption             := 'GERADOR Resultados Diversos a Partir das Somas Fixas 5- cj235 modelo 1';
          CB_Tipo.ItemIndex := 2;
          CB_Tipo.Enabled := false;
      END ELSE
      BEGIN
          LA_Titulo.Caption             := 'SIMULAR modelo 7 - Resultados Diversos a Partir das Somas Fixas 5- cj235 modelo 1';
...
begin
    ...
    WHILE vi_Combinacoes1 <= (TRUNC((STGR_Base.RowCount-1)/5)) do
    BEGIN
...
begin
    ...
    vi_Combinacoes1 := 1 ;
     //3254 gravar
    WHILE vi_Combinacoes1 <= (TRUNC((STGR_Comb12_p3.RowCount-1)/11)) do
    BEGIN
        ...
        vi_Combinacoes1 := vi_Combinacoes1 + 1;
        vi_Contar_Comb1 := vi_Contar_Comb1 + 1;
        IF ((vi_Contar_Comb1 mod 600) =0 ) or (vi_Contar_Comb1 =TRUNC((STGR_Comb12_p3.RowCount-1)/11)) then    //1000
        begin
            ...
            vi_Linhas08 := 1;
            PGBR_Etapa_02.Position := TRUNC (vi_Combinacoes1/((STGR_Comb12_p3.RowCount-1)/11)*100);
            PGBR_Etapa_02.Repaint;
            SELF.WindowState := wsMinimized;
            SELF.WindowState :=  wsNormal;
            SELF.Repaint;
...
begin
    ...
    BEGIN
        ...
        try
            if  (vi_Combinacoes1 mod 330) = 0 then  // 220
            begin
        ...
        Try
            if  (vi_Combinacoes1 mod 6600) = 0 then //8800
            begin
