unit Ranqueadorr_020_Jogos_21_NumerosMod1;
...
Type
   T_F_Ranqueador_020d21M1 = Class(TForm)
      Pa_INICIAL: TPanel;
      Label55: TLabel;
...
var
  _F_Ranqueador_020d21M1: T_F_Ranqueador_020d21M1;
...
Procedure T_F_Ranqueador_020d21M1.FormCreate(Sender: TObject);
Begin
...
Procedure T_F_Ranqueador_020d21M1.FormClose(Sender: TObject; Var Action: TCloseAction);
Begin
   TRY
      BEGIN
...
procedure T_F_Ranqueador_020d21M1.Bbt_CLOSEClick(Sender: TObject);
begin
     SELF.Close;
end;
...
Procedure T_F_Ranqueador_020d21M1.Bt_NOVA_SIMULACAOClick(Sender: TObject);
Begin
...
procedure T_F_Ranqueador_020d21M1.Bbt_SAIRClick(Sender: TObject);
begin
     SELF.Close;
end;
...
procedure T_F_Ranqueador_020d21M1.BitBtn1Click(Sender: TObject);
var
   Lista : Tlist<string>;
   qtd: integer;
begin
...
Procedure T_F_Ranqueador_020d21M1.Bbt_PREPARAR1Click(Sender: TObject);
Begin
   PreenchimentoInicialPadrao;
...
Procedure T_F_Ranqueador_020d21M1.Bbt_GerarComb05();
Begin
...
procedure T_F_Ranqueador_020d21M1.Bbt_CarregarSorteio15NClick(Sender: TObject);
VAR
   viContar1: integer;
Begin
...
Procedure T_F_Ranqueador_020d21M1.Bbt_CarregarSort(Sender: TObject);
VAR
   viContar1: integer;
Begin
   Ibq_E_SORTEIO_15N.Close;
...
procedure T_F_Ranqueador_020d21M1.Bbt_RankClick(Sender: TObject);
var
...
//   end;
   for viContar21Combinacoes := Trunc((Stgr_Base21.RowCount-1)/1) downto 1 do
   begin
      ...
      Stgr_EstatisticasSorteiosAtrasados15.Cells[0, Stgr_Base21.RowCount-viContar21Combinacoes] :=  li_QtdAtrasados15[viContar21Combinacoes-1];
   end;
...
procedure T_F_Ranqueador_020d21M1.BBT_RECOMECARClick(Sender: TObject);
begin
   PreenchimentoInicialPadrao;
...
Procedure T_F_Ranqueador_020d21M1.PreenchimentoInicialPadrao;
var
  viContar: Integer;
begin
   ...
   Stgr_Base21.Cells[02, 01] := '01';
   Stgr_Base21.Cells[03, 01] := '02';
   Stgr_Base21.Cells[04, 01] := '03';
   Stgr_Base21.Cells[05, 01] := '04';
   Stgr_Base21.Cells[06, 01] := '05';
   Stgr_Base21.Cells[07, 01] := '06';
   Stgr_Base21.Cells[08, 01] := '07';
   Stgr_Base21.Cells[09, 01] := '08';
   Stgr_Base21.Cells[10, 01] := '09';
   Stgr_Base21.Cells[11, 01] := '10';
   Stgr_Base21.Cells[12, 01] := '11';
   Stgr_Base21.Cells[13, 01] := '13';
   Stgr_Base21.Cells[14, 01] := '14';
   Stgr_Base21.Cells[15, 01] := '15';
   Stgr_Base21.Cells[16, 01] := '17';
   Stgr_Base21.Cells[17, 01] := '19';
   Stgr_Base21.Cells[18, 01] := '20';
   Stgr_Base21.Cells[19, 01] := '21';
   Stgr_Base21.Cells[20, 01] := '22';
   ...
   Stgr_Base21.Cells[03, 02] := '02';
   Stgr_Base21.Cells[04, 02] := '03';
   Stgr_Base21.Cells[05, 02] := '04';
   Stgr_Base21.Cells[06, 02] := '05';
   Stgr_Base21.Cells[07, 02] := '06';
   Stgr_Base21.Cells[08, 02] := '07';
   Stgr_Base21.Cells[09, 02] := '08';
   Stgr_Base21.Cells[10, 02] := '09';
   Stgr_Base21.Cells[11, 02] := '11';
   Stgr_Base21.Cells[12, 02] := '12';
   Stgr_Base21.Cells[13, 02] := '13';
   Stgr_Base21.Cells[14, 02] := '14';
   Stgr_Base21.Cells[15, 02] := '15';
   Stgr_Base21.Cells[16, 02] := '17';
   Stgr_Base21.Cells[17, 02] := '18';
   Stgr_Base21.Cells[18, 02] := '20';
   Stgr_Base21.Cells[19, 02] := '21';
   Stgr_Base21.Cells[20, 02] := '22';
   Stgr_Base21.Cells[21, 02] := '23';
   ...
   Stgr_Base21.Cells[04, 03] := '03';
   Stgr_Base21.Cells[05, 03] := '04';
   Stgr_Base21.Cells[06, 03] := '05';
   Stgr_Base21.Cells[07, 03] := '06';
   Stgr_Base21.Cells[08, 03] := '07';
   Stgr_Base21.Cells[09, 03] := '09';
   Stgr_Base21.Cells[10, 03] := '10';
   Stgr_Base21.Cells[11, 03] := '11';
   Stgr_Base21.Cells[12, 03] := '12';
   Stgr_Base21.Cells[13, 03] := '13';
   Stgr_Base21.Cells[14, 03] := '14';
   Stgr_Base21.Cells[15, 03] := '15';
   Stgr_Base21.Cells[16, 03] := '16';
   Stgr_Base21.Cells[17, 03] := '17';
   Stgr_Base21.Cells[18, 03] := '20';
   Stgr_Base21.Cells[19, 03] := '21';
   Stgr_Base21.Cells[20, 03] := '23';
   Stgr_Base21.Cells[21, 03] := '24';
   ...
   Stgr_Base21.Cells[05, 04] := '04';
   Stgr_Base21.Cells[06, 04] := '05';
   Stgr_Base21.Cells[07, 04] := '06';
   Stgr_Base21.Cells[08, 04] := '07';
   Stgr_Base21.Cells[09, 04] := '09';
   Stgr_Base21.Cells[10, 04] := '10';
   Stgr_Base21.Cells[11, 04] := '11';
   Stgr_Base21.Cells[12, 04] := '12';
   Stgr_Base21.Cells[13, 04] := '13';
   Stgr_Base21.Cells[14, 04] := '14';
   Stgr_Base21.Cells[15, 04] := '16';
   Stgr_Base21.Cells[16, 04] := '17';
   Stgr_Base21.Cells[17, 04] := '18';
   Stgr_Base21.Cells[18, 04] := '19';
   Stgr_Base21.Cells[19, 04] := '20';
   Stgr_Base21.Cells[20, 04] := '21';
   Stgr_Base21.Cells[21, 04] := '22';
   Stgr_Base21.Cells[22, 04] := '25';
   //05
   Stgr_Base21.Cells[00, 05] := '05';
   Stgr_Base21.Cells[01, 05] := 'V';
   Stgr_Base21.Cells[02, 05] := '01';
   Stgr_Base21.Cells[03, 05] := '02';
   Stgr_Base21.Cells[04, 05] := '03';
   Stgr_Base21.Cells[05, 05] := '04';
   Stgr_Base21.Cells[06, 05] := '05';
   Stgr_Base21.Cells[07, 05] := '06';
   Stgr_Base21.Cells[08, 05] := '08';
   Stgr_Base21.Cells[09, 05] := '10';
   Stgr_Base21.Cells[10, 05] := '12';
   ...
   Stgr_Base21.Cells[17, 05] := '19';
   Stgr_Base21.Cells[18, 05] := '20';
   Stgr_Base21.Cells[19, 05] := '21';
   Stgr_Base21.Cells[20, 05] := '22';
   Stgr_Base21.Cells[21, 05] := '23';
   Stgr_Base21.Cells[22, 05] := '24';
   //06
   Stgr_Base21.Cells[00, 06] := '06';
   Stgr_Base21.Cells[01, 06] := 'V';
   Stgr_Base21.Cells[02, 06] := '01';
   Stgr_Base21.Cells[03, 06] := '02';
   Stgr_Base21.Cells[04, 06] := '03';
   Stgr_Base21.Cells[05, 06] := '04';
   Stgr_Base21.Cells[06, 06] := '05';
   Stgr_Base21.Cells[07, 06] := '07';
   Stgr_Base21.Cells[08, 06] := '08';
   Stgr_Base21.Cells[09, 06] := '09';
   Stgr_Base21.Cells[10, 06] := '10';
   Stgr_Base21.Cells[11, 06] := '11';
   Stgr_Base21.Cells[12, 06] := '12';
   Stgr_Base21.Cells[13, 06] := '13';
   Stgr_Base21.Cells[14, 06] := '15';
   Stgr_Base21.Cells[15, 06] := '16';
   Stgr_Base21.Cells[16, 06] := '17';
   Stgr_Base21.Cells[17, 06] := '18';
   Stgr_Base21.Cells[18, 06] := '19';
   Stgr_Base21.Cells[19, 06] := '20';
   Stgr_Base21.Cells[20, 06] := '22';
   Stgr_Base21.Cells[21, 06] := '23';
   Stgr_Base21.Cells[22, 06] := '24';
   //07
   Stgr_Base21.Cells[00, 07] := '07';
   Stgr_Base21.Cells[01, 07] := 'V';
   Stgr_Base21.Cells[02, 07] := '01';
   Stgr_Base21.Cells[03, 07] := '02';
   Stgr_Base21.Cells[04, 07] := '03';
   Stgr_Base21.Cells[05, 07] := '04';
   Stgr_Base21.Cells[06, 07] := '05';
   Stgr_Base21.Cells[07, 07] := '07';
   Stgr_Base21.Cells[08, 07] := '08';
   Stgr_Base21.Cells[09, 07] := '10';
   ...
   Stgr_Base21.Cells[11, 08] := '11';
   Stgr_Base21.Cells[12, 08] := '12';
   Stgr_Base21.Cells[13, 08] := '13';
   Stgr_Base21.Cells[14, 08] := '14';
   ...
   Stgr_Base21.Cells[08, 09] := '09';
   Stgr_Base21.Cells[09, 09] := '11';
   Stgr_Base21.Cells[10, 09] := '13';
   Stgr_Base21.Cells[11, 09] := '14';
   Stgr_Base21.Cells[12, 09] := '15';
   Stgr_Base21.Cells[13, 09] := '16';
   Stgr_Base21.Cells[14, 09] := '17';
   Stgr_Base21.Cells[15, 09] := '18';
   Stgr_Base21.Cells[16, 09] := '19';
   Stgr_Base21.Cells[17, 09] := '20';
   Stgr_Base21.Cells[18, 09] := '21';
   Stgr_Base21.Cells[19, 09] := '22';
   Stgr_Base21.Cells[20, 09] := '23';
   ...
   Stgr_Base21.Cells[05, 10] := '05';
   Stgr_Base21.Cells[06, 10] := '06';
   ...
   Stgr_Base21.Cells[12, 10] := '13';
   Stgr_Base21.Cells[13, 10] := '14';
   Stgr_Base21.Cells[14, 10] := '15';
   Stgr_Base21.Cells[15, 10] := '16';
   Stgr_Base21.Cells[16, 10] := '17';
   Stgr_Base21.Cells[17, 10] := '18';
   Stgr_Base21.Cells[18, 10] := '19';
   Stgr_Base21.Cells[19, 10] := '20';
   Stgr_Base21.Cells[20, 10] := '21';
   ...
   Stgr_Base21.Cells[05, 11] := '05';
   Stgr_Base21.Cells[06, 11] := '06';
   Stgr_Base21.Cells[07, 11] := '07';
   Stgr_Base21.Cells[08, 11] := '08';
   Stgr_Base21.Cells[09, 11] := '09';
   Stgr_Base21.Cells[10, 11] := '11';
   Stgr_Base21.Cells[11, 11] := '12';
   Stgr_Base21.Cells[12, 11] := '13';
   Stgr_Base21.Cells[13, 11] := '14';
   Stgr_Base21.Cells[14, 11] := '16';
   Stgr_Base21.Cells[15, 11] := '17';
   Stgr_Base21.Cells[16, 11] := '19';
   Stgr_Base21.Cells[17, 11] := '20';
   Stgr_Base21.Cells[18, 11] := '21';
   Stgr_Base21.Cells[19, 11] := '22';
   Stgr_Base21.Cells[20, 11] := '23';
   Stgr_Base21.Cells[21, 11] := '24';
   Stgr_Base21.Cells[22, 11] := '25';
   //12
   Stgr_Base21.Cells[00, 12] := '12';
   Stgr_Base21.Cells[01, 12] := 'V';
   Stgr_Base21.Cells[02, 12] := '01';
   Stgr_Base21.Cells[03, 12] := '02';
   Stgr_Base21.Cells[04, 12] := '03';
   ...
   Stgr_Base21.Cells[11, 12] := '12';
   Stgr_Base21.Cells[12, 12] := '13';
   Stgr_Base21.Cells[13, 12] := '14';
   Stgr_Base21.Cells[14, 12] := '15';
   Stgr_Base21.Cells[15, 12] := '16';
   Stgr_Base21.Cells[16, 12] := '17';
   Stgr_Base21.Cells[17, 12] := '18';
   Stgr_Base21.Cells[18, 12] := '20';
   Stgr_Base21.Cells[19, 12] := '21';
   Stgr_Base21.Cells[20, 12] := '22';
   ...
   Stgr_Base21.Cells[07, 13] := '07';
   Stgr_Base21.Cells[08, 13] := '08';
   Stgr_Base21.Cells[09, 13] := '10';
   Stgr_Base21.Cells[10, 13] := '12';
   Stgr_Base21.Cells[11, 13] := '13';
   Stgr_Base21.Cells[12, 13] := '14';
   ...
   Stgr_Base21.Cells[04, 15] := '04';
   Stgr_Base21.Cells[05, 15] := '05';
   Stgr_Base21.Cells[06, 15] := '08';
   Stgr_Base21.Cells[07, 15] := '09';
   Stgr_Base21.Cells[08, 15] := '10';
   Stgr_Base21.Cells[09, 15] := '12';
   Stgr_Base21.Cells[10, 15] := '13';
   Stgr_Base21.Cells[11, 15] := '14';
   Stgr_Base21.Cells[12, 15] := '15';
   Stgr_Base21.Cells[13, 15] := '16';
   Stgr_Base21.Cells[14, 15] := '17';
   Stgr_Base21.Cells[15, 15] := '18';
   Stgr_Base21.Cells[16, 15] := '19';
   Stgr_Base21.Cells[17, 15] := '20';
   Stgr_Base21.Cells[18, 15] := '21';
   Stgr_Base21.Cells[19, 15] := '22';
   Stgr_Base21.Cells[20, 15] := '23';
   Stgr_Base21.Cells[21, 15] := '24';
   Stgr_Base21.Cells[22, 15] := '25';
   //16
   Stgr_Base21.Cells[00, 16] := '16';
   Stgr_Base21.Cells[01, 16] := 'V';
   Stgr_Base21.Cells[02, 16] := '01';
   ...
   Stgr_Base21.Cells[08, 16] := '08';
   Stgr_Base21.Cells[09, 16] := '09';
   Stgr_Base21.Cells[10, 16] := '10';
   Stgr_Base21.Cells[11, 16] := '11';
   Stgr_Base21.Cells[12, 16] := '12';
   Stgr_Base21.Cells[13, 16] := '14';
   Stgr_Base21.Cells[14, 16] := '15';
   Stgr_Base21.Cells[15, 16] := '16';
   Stgr_Base21.Cells[16, 16] := '18';
   Stgr_Base21.Cells[17, 16] := '19';
   ...
   Stgr_Base21.Cells[02, 17] := '02';
   Stgr_Base21.Cells[03, 17] := '03';
   ...
   Stgr_Base21.Cells[10, 17] := '10';
   Stgr_Base21.Cells[11, 17] := '11';
   Stgr_Base21.Cells[12, 17] := '13';
   Stgr_Base21.Cells[13, 17] := '14';
   Stgr_Base21.Cells[14, 17] := '16';
   Stgr_Base21.Cells[15, 17] := '17';
   Stgr_Base21.Cells[16, 17] := '18';
   Stgr_Base21.Cells[17, 17] := '20';
   Stgr_Base21.Cells[18, 17] := '21';
   ...
   Stgr_Base21.Cells[02, 18] := '02';
   Stgr_Base21.Cells[03, 18] := '03';
   Stgr_Base21.Cells[04, 18] := '04';
   Stgr_Base21.Cells[05, 18] := '05';
   Stgr_Base21.Cells[06, 18] := '06';
   Stgr_Base21.Cells[07, 18] := '07';
   Stgr_Base21.Cells[08, 18] := '08';
   Stgr_Base21.Cells[09, 18] := '09';
   Stgr_Base21.Cells[10, 18] := '11';
   Stgr_Base21.Cells[11, 18] := '12';
   ...
   Stgr_Base21.Cells[18, 18] := '19';
   Stgr_Base21.Cells[19, 18] := '20';
   Stgr_Base21.Cells[20, 18] := '21';
   Stgr_Base21.Cells[21, 18] := '24';
   Stgr_Base21.Cells[22, 18] := '25';
   //19
   Stgr_Base21.Cells[00, 19] := '19';
   Stgr_Base21.Cells[01, 19] := 'V';
   Stgr_Base21.Cells[02, 19] := '02';
   Stgr_Base21.Cells[03, 19] := '03';
   Stgr_Base21.Cells[04, 19] := '04';
   Stgr_Base21.Cells[05, 19] := '06';
   Stgr_Base21.Cells[06, 19] := '07';
   Stgr_Base21.Cells[07, 19] := '08';
   Stgr_Base21.Cells[08, 19] := '09';
   Stgr_Base21.Cells[09, 19] := '10';
   Stgr_Base21.Cells[10, 19] := '11';
   Stgr_Base21.Cells[11, 19] := '12';
   Stgr_Base21.Cells[12, 19] := '13';
   Stgr_Base21.Cells[13, 19] := '14';
   Stgr_Base21.Cells[14, 19] := '15';
   Stgr_Base21.Cells[15, 19] := '16';
   Stgr_Base21.Cells[16, 19] := '17';
   Stgr_Base21.Cells[17, 19] := '19';
   Stgr_Base21.Cells[18, 19] := '20';
   Stgr_Base21.Cells[19, 19] := '21';
   Stgr_Base21.Cells[20, 19] := '22';
   Stgr_Base21.Cells[21, 19] := '23';
   Stgr_Base21.Cells[22, 19] := '25';
   //20
   Stgr_Base21.Cells[00, 20] := '20';
   Stgr_Base21.Cells[01, 20] := 'V';
   Stgr_Base21.Cells[02, 20] := '02';
   Stgr_Base21.Cells[03, 20] := '03';
   Stgr_Base21.Cells[04, 20] := '05';
   Stgr_Base21.Cells[05, 20] := '06';
   Stgr_Base21.Cells[06, 20] := '07';
   Stgr_Base21.Cells[07, 20] := '09';
   Stgr_Base21.Cells[08, 20] := '10';
   Stgr_Base21.Cells[09, 20] := '11';
   Stgr_Base21.Cells[10, 20] := '12';
   Stgr_Base21.Cells[11, 20] := '13';
   Stgr_Base21.Cells[12, 20] := '14';
   Stgr_Base21.Cells[13, 20] := '15';
   Stgr_Base21.Cells[14, 20] := '17';
   Stgr_Base21.Cells[15, 20] := '18';
   Stgr_Base21.Cells[16, 20] := '19';
   Stgr_Base21.Cells[17, 20] := '20';
...
procedure T_F_Ranqueador_020d21M1.Zerar_FLAGTodosNumeros();
var
  viContar: Integer;
begin
...
procedure T_F_Ranqueador_020d21M1.Falso_Linha1TodosNumeros();
var
  viContar: Integer;
begin
  for viContar := 1 to 25 do
...
procedure T_F_Ranqueador_020d21M1.Falso_Linha2TodosNumeros();
var
  viContar: Integer;
begin
  for viContar := 1 to 25 do
...
procedure T_F_Ranqueador_020d21M1.Falso_Linha1TodosNumerosP17();
begin
end;

procedure T_F_Ranqueador_020d21M1.Falso_Linha2TodosNumerosP17();
begin
end;


function T_F_Ranqueador_020d21M1.IIf(Expressao: Variant; ParteTRUE, ParteFALSE: Variant): Variant;
 begin
   if Expressao then
      Result := ParteTRUE
   else
