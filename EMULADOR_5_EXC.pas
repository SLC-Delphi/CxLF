...
type
  T_F_EMULADOR_5_EXC = class(TForm)
...
var
  _F_EMULADOR_5_EXC: T_F_EMULADOR_5_EXC;

implementation

{$R *.dfm}

procedure T_F_EMULADOR_5_EXC.FormCreate(Sender: TObject);
VAR
    VI_CONTAR : INTEGER;
begin
   ...
   //  SELF.Visible := TRUE;
    ...
    BEGIN
        STGR_COMB5.Cells [VI_CONTAR,1] := '0';
    END;
    STGR_COMB5.RowCount := 2;
    FOR VI_CONTAR := 1 TO 5 DO
    BEGIN
    ...
    END;
    STGR_COMB5.Cells[0,0] := 'QTD';
    FOR VI_CONTAR := 1 TO 5 DO
    BEGIN
        STGR_COMB5.Cells [VI_CONTAR,0] := '-'+INTtoSTR(VI_CONTAR)+'-';
    END;
    ...
    PA_EXECUTAR_FILTRO.Enabled := false;
            ...
            SELF.IBQ_COMBINACOES.SQL.Add('UPDATE FILTRO_00A_5EXC_DEFINICAO SET FLAG_FILTRAR =''N'', FLAG_GRAVAR= ''N'';')  ;
...
procedure T_F_EMULADOR_5_EXC.FormClose(Sender: TObject;
...
procedure T_F_EMULADOR_5_EXC.BBT_CLOSEClick(Sender: TObject);
begin
     SELF.Close;
end;


procedure T_F_EMULADOR_5_EXC.BBT_701Click(Sender: TObject);
begin
...
procedure T_F_EMULADOR_5_EXC.BBT_702Click(Sender: TObject);
begin
...
procedure T_F_EMULADOR_5_EXC.BBT_703Click(Sender: TObject);
begin
...
procedure T_F_EMULADOR_5_EXC.BBT_704Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(4);
    BBT_704.Enabled := FALSE;
end;

procedure T_F_EMULADOR_5_EXC.BBT_705Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(5);
    BBT_705.Enabled := FALSE;
end;

procedure T_F_EMULADOR_5_EXC.BBT_706Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(6);
    BBT_706.Enabled := FALSE;
end;

procedure T_F_EMULADOR_5_EXC.BBT_707Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(7);
    BBT_707.Enabled := FALSE;
end;

procedure T_F_EMULADOR_5_EXC.BBT_708Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(8);
    BBT_708.Enabled := FALSE;
end;

procedure T_F_EMULADOR_5_EXC.BBT_710Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(10);
    BBT_710.Enabled := FALSE;
end;

procedure T_F_EMULADOR_5_EXC.BBT_709Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(9);
    BBT_709.Enabled := FALSE;
end;

procedure T_F_EMULADOR_5_EXC.BBT_711Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(11);
    BBT_711.Enabled := FALSE;
end;

procedure T_F_EMULADOR_5_EXC.BBT_712Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(12);
    BBT_712.Enabled := FALSE;
end;

procedure T_F_EMULADOR_5_EXC.BBT_713Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(13);
    BBT_713.Enabled := FALSE;
end;

procedure T_F_EMULADOR_5_EXC.BBT_714Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(14);
    BBT_714.Enabled := FALSE;
end;

procedure T_F_EMULADOR_5_EXC.BBT_715Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(15);
    BBT_715.Enabled := FALSE;
end;

procedure T_F_EMULADOR_5_EXC.BBT_716Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(16);
    BBT_716.Enabled := FALSE;
end;

procedure T_F_EMULADOR_5_EXC.BBT_717Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(17);
    BBT_717.Enabled := FALSE;
end;

procedure T_F_EMULADOR_5_EXC.BBT_718Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(18);
    BBT_718.Enabled := FALSE;
end;

procedure T_F_EMULADOR_5_EXC.BBT_719Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(19);
    BBT_719.Enabled := FALSE;
end;

procedure T_F_EMULADOR_5_EXC.BBT_720Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(20);
    BBT_720.Enabled := FALSE;
end;

procedure T_F_EMULADOR_5_EXC.BBT_721Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(21);
    BBT_721.Enabled := FALSE;
end;

procedure T_F_EMULADOR_5_EXC.BBT_722Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(22);
    BBT_722.Enabled := FALSE;
end;

procedure T_F_EMULADOR_5_EXC.BBT_723Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(23);
    BBT_723.Enabled := FALSE;
end;

procedure T_F_EMULADOR_5_EXC.BBT_724Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(24);
    BBT_724.Enabled := FALSE;
end;

procedure T_F_EMULADOR_5_EXC.BBT_725Click(Sender: TObject);
begin
...
PROCEDURE T_F_EMULADOR_5_EXC.PR_BOTOES_MODELO_12345 (VI_NUMERO: INTEGER);
VAR
...
procedure T_F_EMULADOR_5_EXC.BT_NOVA_SIMULACAOClick(Sender: TObject);
VAR
     VsI_CONTAR : SMALLINT;
begin
     ...
     STGR_COMB5.Visible := TRUE;
     STGR_COMB5.Enabled := TRUE;
...
procedure T_F_EMULADOR_5_EXC.RB_RES_GABARITOSClick(Sender: TObject);
begin
...
procedure T_F_EMULADOR_5_EXC.RB_GABARITOClick(Sender: TObject);
begin
     WITH SCBX_GABARITO DO
     BEGIN
           Left := 1   ;
...
procedure T_F_EMULADOR_5_EXC.RB_RESULTADOSClick(Sender: TObject);
begin
     SCBX_GABARITO.Visible := false;
     PA_RESULTADO.Visible  := TRUE;
end;
...
procedure T_F_EMULADOR_5_EXC.TRB_C2_FINALChange(Sender: TObject);
begin
     IF TRB_C2_FINAL.Position = 1 THEN
          ED_SOMAS_C2_FINAL.Text := '57';
     IF TRB_C2_FINAL.Position = 2 THEN
          ED_SOMAS_C2_FINAL.Text := '58';
     IF TRB_C2_FINAL.Position = 3 THEN
          ED_SOMAS_C2_FINAL.Text := '59';
...
procedure T_F_EMULADOR_5_EXC.BBT_RECOMECARClick(Sender: TObject);
VAR
    VI_CONTAR : INTEGER;
begin
...
procedure T_F_EMULADOR_5_EXC.BBT_CLICK_TUDOClick(Sender: TObject);
begin
     BBT_701.Click;
     BBT_702.Click;
     BBT_713.Click;
...
procedure T_F_EMULADOR_5_EXC.BBT_PREPARARClick(Sender: TObject);
var
...
begin
      FOR VI_CONTAR := 1 TO 5 DO
     BEGIN
        STGR_COMB5.Cells [VI_CONTAR+2,0] := '-'+INTtoSTR(VI_CONTAR)+'-';
        STGR_COMB5.Cells [VI_CONTAR+2,1] := '00';
     END;
     STGR_COMB5.RowCount := 2;
     STGR_COMB5.Repaint;
    ...
    // ======================================================
     ...
     BEGIN
          ...
          BEGIN
               ...
               BEGIN
                    FOR VI_COMBINACOES4:= VI_COMBINACOES3+1 TO 5 DO
                    BEGIN
                         ...
                         STGR_LINHA_1_C1.Cells [4,VI_LINHAS2]:= STGR_BASE_L1.Cells[VI_COMBINACOES4,0];
                         // ---------------------------------------------
          ...
          BEGIN
               ...
               BEGIN
                    ...
                    BEGIN
                         ...
                         STGR_LINHA_2_C1.Cells [4,VI_LINHAS2]:= STGR_BASE_L2.Cells[VI_COMBINACOES4,0];
                         // ---------------------------------------------
                         // -- CAPTURAR O NÚMERO QUE FALTA NA COLUNA 2 --
                         // ---------------------------------------------
                         VS_NUMEROSPRINCIPAIS:= STGR_BASE_L1.Cells[VI_COMBINACOES1,0] + '-' +
                         ...
                         BEGIN
                              STGR_LINHA_2_C2.Cells[1,VI_LINHAS2] := STGR_BASE_L1.Cells[VI_COMBINACOES3,0];
          ...
          BEGIN
               ...
               BEGIN
                    ...
                    BEGIN
                         ...
                         STGR_LINHA_3_C1.Cells [4,VI_LINHAS2]:= STGR_BASE_L3.Cells[VI_COMBINACOES4,0];
                         // ---------------------------------------------
                         // -- CAPTURAR O NÚMERO QUE FALTA NA COLUNA 2 --
                         // ---------------------------------------------
                         VS_NUMEROSPRINCIPAIS:= STGR_BASE_L1.Cells[VI_COMBINACOES1,0] + '-' +
                         ...
                         BEGIN
                              STGR_LINHA_3_C2.Cells[1,VI_LINHAS2] := STGR_BASE_L1.Cells[VI_COMBINACOES3,0];
          ...
          BEGIN
               ...
               BEGIN
                    ...
                    BEGIN
                         ...
                         STGR_LINHA_4_C1.Cells [4,VI_LINHAS2]:= STGR_BASE_L4.Cells[VI_COMBINACOES4,0];
                         // ---------------------------------------------
                         // -- CAPTURAR O NÚMERO QUE FALTA NA COLUNA 2 --
                         // ---------------------------------------------
                         VS_NUMEROSPRINCIPAIS:= STGR_BASE_L1.Cells[VI_COMBINACOES1,0] + '-' +
                         ...
                         BEGIN
                              STGR_LINHA_4_C2.Cells[1,VI_LINHAS2] := STGR_BASE_L1.Cells[VI_COMBINACOES3,0];
          ...
          BEGIN
               ...
               BEGIN
                    ...
                    BEGIN
                         ...
                         STGR_LINHA_5_C1.Cells [4,VI_LINHAS2]:= STGR_BASE_L5.Cells[VI_COMBINACOES4,0];
                         // ---------------------------------------------
                         // -- CAPTURAR O NÚMERO QUE FALTA NA COLUNA 2 --
                         // ---------------------------------------------
                         VS_NUMEROSPRINCIPAIS:= STGR_BASE_L1.Cells[VI_COMBINACOES1,0] + '-' +
                         ...
                         BEGIN
                              STGR_LINHA_5_C2.Cells[1,VI_LINHAS2] := STGR_BASE_L1.Cells[VI_COMBINACOES3,0];
     ...
     SELF.Repaint;
            ...
            SELF.IBQ_COMBINACOES.SQL.Clear;
            SELF.IBQ_COMBINACOES.SQL.Add('DELETE FROM FILTRO_00A_5EXC_DEFINICAO')  ;
            SELF.IBQ_COMBINACOES.ExecSQL;
            SELF.IBQ_COMBINACOES.SQL.Clear;
            SELF.IBQ_COMBINACOES.SQL.Add('DELETE FROM FILTRO_00A_5EXC_DADOS')  ;
            SELF.IBQ_COMBINACOES.ExecSQL;
            SELF.IBQ_COMBINACOES.SQL.Clear;
            SELF.IBQ_COMBINACOES.SQL.Add('COMMIT')  ;
            SELF.IBQ_COMBINACOES.ExecSQL;
            SELF.IBQ_COMBINACOES.SQL.Clear;
            SELF.IBQ_COMBINACOES.SQL.Add('SELECT * FROM FILTRO_00A_5EXC_DEFINICAO; ')  ;
            SELF.IBQ_COMBINACOES.Open;
            SELF.IBQ_COMBINACOES.SQL.Clear;
            SELF.IBQ_COMBINACOES.SQL.Add('UPDATE FILTRO_00A_5EXC_DEFINICAO SET FLAG_FILTRAR =''N'', FLAG_GRAVAR= ''N'';')  ;
            SELF.IBQ_COMBINACOES.ExecSQL;
...
procedure T_F_EMULADOR_5_EXC.BBT_GERAR_MENUClick(Sender: TObject);
    ...
    begin
        ...
        FOR VI_CONTAR :=1 TO 5 DO
        BEGIN
            STRGR_TODOS_NUMEROS.Cells [ (STRtoINT(STGR_COMB5.Cells[VI_CONTAR,VI_LINHAS9])) ,1]:='V';
        END; // FOR VI_CONTAR1
        VI_CNTCELULAS := 1;
        FOR VI_CONTAR :=1 TO 25 DO
        BEGIN
            ...
            BEGIN
                STGR_COMB5.Cells [VI_CNTCELULAS, VI_LINHAS9] := RIGHTSTR ('0'+(STRGR_TODOS_NUMEROS.Cells[VI_CONTAR,0]),2) ;
    ...
    BEGIN
        ...
        BEGIN
            ...
            VC_DADOS5 := RIGHTSTR ('0'+STGR_BASE_L5.Cells[1,0],2) + ' ' + RIGHTSTR ('0'+STGR_BASE_L5.Cells[2,0],2) + ' '  + RIGHTSTR ('0'+STGR_BASE_L5.Cells[3,0],2) + ' '  + RIGHTSTR ('0'+STGR_BASE_L5.Cells[4,0],2) + ' '  + RIGHTSTR ('0'+STGR_BASE_L5.Cells[5,0],2);
                SELF.IBQ_COMBINACOES.SQL.Clear;
            VC_QUERY  := 'INSERT INTO FILTRO_00A_5EXC_DEFINICAO (LINHA_1, LINHA_2, LINHA_3, LINHA_4, LINHA_5, SOMA_COL_1_INI, SOMA_COL_1_FINAL, SOMA_COL_2_INI, ';
            VC_QUERY  := VC_QUERY +' SOMA_COL_2_FINAL, EXC_1, EXC_2, EXC_3, CONTADOR_C1, TOTAL_CONTADOR_C1, ';
            VC_QUERY  := VC_QUERY +' DATA_DEFINICAO, HORA_DEFINICAO) VALUES('+#39+ VC_DADOS1 + #39 +','  +#39+ VC_DADOS2 + #39 +','  +#39+ VC_DADOS3 + #39 +','  +#39+ VC_DADOS4 + #39 +','  +#39+ VC_DADOS5 ;
        ...
        BEGIN
           ...
           // SHOWMESSAGE ('DADOS-1 -> Gerar o Banco de Dados');
            FOR VI_AN_COMB1:= 1 TO  TRUNC((STGR_COMB5.RowCount-1)/1) DO
            BEGIN
                // obs: verificar o evento BeFOREInSERT DA ibq_COMBINACOES
                VC_COMBINACOES :='';
                FOR VI_CNTCELULAS := 1 TO 5 DO
                BEGIN
                    VC_COMBINACOES := VC_COMBINACOES + STGR_COMB5.Cells[VI_CNTCELULAS,VI_AN_COMB1] +' ';
                END; // FOR VI_CNTCELULAS
                VC_QUERY  := 'INSERT INTO FILTRO_00A_5EXC_DADOS (EXC1, EXC2, EXC3, EXC4, EXC5, DADOS) VALUES(' +#39+ STGR_COMB5.Cells[1,VI_AN_COMB1] + #39 +','+#39+ STGR_COMB5.Cells[2,VI_AN_COMB1]
                     + #39 +','+#39+STGR_COMB5.Cells[3,VI_AN_COMB1] + #39 +','+#39+STGR_COMB5.Cells[4,VI_AN_COMB1] + #39 +','+#39+STGR_COMB5.Cells[5,VI_AN_COMB1]  + #39 +','+#39+VC_COMBINACOES + #39 +');';
                SELF.IBQ_COMBINACOES.SQL.Clear;
                SELF.IBQ_COMBINACOES.SQL.Add(VC_QUERY)  ;
                SELF.IBQ_COMBINACOES.ExecSQL;
            END;
            SELF.IBQ_COMBINACOES.SQL.Clear;
            VC_QUERY  := 'UPDATE FILTRO_00A_5EXC_DEFINICAO SET CONTADOR_C1 =' + #39+ INTtoSTR(VI_COMBINACOES_C1) +#39+';';
            SELF.IBQ_COMBINACOES.SQL.Add(VC_QUERY)  ;
            SELF.IBQ_COMBINACOES.ExecSQL;
            VI_LINHAS2:=1;
            STGR_COMB5.RowCount := VI_LINHAS2;
             SELF.IBQ_COMBINACOES.SQL.Clear;
             SELF.IBQ_COMBINACOES.SQL.Add('COMMIT')  ;
             SELF.IBQ_COMBINACOES.ExecSQL;
...
var
     ...
     VI_SOMA1: SMALLINT;
     VI_FLAG_SOMATORIA1, VI_FLAG_SOMATORIA2: SMALLINT;
begin
     IF (STRtoINT(ED_SOMAS_C1_INI.Text) > STRtoINT(ED_SOMAS_C1_FINAL.Text ) ) THEN
     BEGIN
          SHOWMESSAGE ('O NÚMERO INICIAL TEM DE SER MENOR QUE O FINAL.');
     ...
     FOR VI_CONTASEL1 := 1 TO 5 DO
     BEGIN
        STGR_COMB5.Cells [VI_CONTASEL1+0,0] := '-'+INTtoSTR(VI_CONTASEL1)+'-';
        STGR_COMB5.Cells [VI_CONTASEL1+0,1] := '00';
     END;
     STGR_COMB5.RowCount := 2;
     STGR_COMB5.Repaint;
     PGBR_GERARCOMB.Position := 0;
    ...
    // =================== AQUI
               ...
               BEGIN
                    ...
                    BEGIN
                         ...
                         BEGIN
                             ...
                             BEGIN
                                  IF (VI_COMBINACOES4 MOD 2)=0 THEN SLEEP (3);
                             ...
                             BEGIN
                                  ...
                                  CONTINUE;
                             END; // IF (VI_SOMA1
                                            VI_SOMA1 := STRtoINT(STGR_LINHA_1_C1.Cells[1,VI_COMBINACOES1]) + STRtoINT(STGR_LINHA_1_C1.Cells[2,VI_COMBINACOES1])  + STRtoINT(STGR_LINHA_1_C1.Cells[3,VI_COMBINACOES1]) + STRtoINT(STGR_LINHA_1_C1.Cells[4,VI_COMBINACOES1])
                                             + STRtoINT(STGR_LINHA_2_C1.Cells[1,VI_COMBINACOES2]) + STRtoINT(STGR_LINHA_2_C1.Cells[2,VI_COMBINACOES2]) + STRtoINT(STGR_LINHA_2_C1.Cells[3,VI_COMBINACOES2]) + STRtoINT(STGR_LINHA_2_C1.Cells[4,VI_COMBINACOES2])
                                             + STRtoINT(STGR_LINHA_3_C1.Cells[1,VI_COMBINACOES3]) + STRtoINT(STGR_LINHA_3_C1.Cells[2,VI_COMBINACOES3]) + STRtoINT(STGR_LINHA_3_C1.Cells[3,VI_COMBINACOES3]) + STRtoINT(STGR_LINHA_3_C1.Cells[4,VI_COMBINACOES3])
                                             + STRtoINT(STGR_LINHA_4_C1.Cells[1,VI_COMBINACOES4]) + STRtoINT(STGR_LINHA_4_C1.Cells[2,VI_COMBINACOES4]) + STRtoINT(STGR_LINHA_4_C1.Cells[3,VI_COMBINACOES4]) + STRtoINT(STGR_LINHA_4_C1.Cells[4,VI_COMBINACOES4])
                                             + STRtoINT(STGR_LINHA_5_C1.Cells[1,VI_COMBINACOES5]) + STRtoINT(STGR_LINHA_5_C1.Cells[2,VI_COMBINACOES5]) + STRtoINT(STGR_LINHA_5_C1.Cells[3,VI_COMBINACOES5]) + STRtoINT(STGR_LINHA_5_C1.Cells[4,VI_COMBINACOES5]);
                                            ...
                                            BEGIN
                                                 ...
                                                 CONTINUE;
                                            END; // IF (VI_SOMA1
                              STGR_COMB5.Cells[1,VI_LINHAS2] := STGR_LINHA_1_C2.Cells[1,VI_COMBINACOES1];
                              STGR_COMB5.Cells[2,VI_LINHAS2] := STGR_LINHA_2_C2.Cells[1,VI_COMBINACOES2];
                              STGR_COMB5.Cells[3,VI_LINHAS2] := STGR_LINHA_3_C2.Cells[1,VI_COMBINACOES3];
                              STGR_COMB5.Cells[4,VI_LINHAS2] := STGR_LINHA_4_C2.Cells[1,VI_COMBINACOES4];
                              STGR_COMB5.Cells[5,VI_LINHAS2] := STGR_LINHA_5_C2.Cells[1,VI_COMBINACOES5];
                              STGR_COMB5.Cells[0,VI_LINHAS2] := INTtoSTR(VI_LINHAS2);

                              IF (VI_FLAG_SOMATORIA1 =1) AND (VI_FLAG_SOMATORIA2 =1)
                              THEN
                              BEGIN
     ...
     SELF.PR_SIMULAR_RECUPERANDODADOS('');
               SELF.IBQ_COMBINACOES.SQL.Clear;
               SELF.IBQ_COMBINACOES.SQL.Add('SELECT COUNT(distinct(dados)) AS SOMADADOS FROM FILTRO_00A_5EXC_DADOS;')  ;
               SELF.IBQ_COMBINACOES.Open;
               IBQ_COMBINACOES.First;
               VI_CONTAR_COMB1 := IBQ_COMBINACOES.FIELDBYNAME('SOMADADOS').AsInteger;
            SELF.IBQ_COMBINACOES.SQL.Clear;
            SELF.IBQ_COMBINACOES.SQL.Add('UPDATE FILTRO_00A_5EXC_DEFINICAO SET HORA_TERMINO ='''+FORMATDATETIME('h:n:s',time())+''', QTD_DADOS= ''' +INTtoSTR(VI_CONTAR_COMB1)+ ''';')  ;
            SELF.IBQ_COMBINACOES.ExecSQL;
            SELF.IBQ_COMBINACOES.SQL.Clear;
            SELF.IBQ_COMBINACOES.SQL.Add('COMMIT')  ;
            SELF.IBQ_COMBINACOES.ExecSQL;
     ...
     BBT_BLOCO_NOTAS.SetFocus;
            SELF.IBQ_COMBINACOES.SQL.Clear;
            SELF.IBQ_COMBINACOES.SQL.Add('UPDATE FILTRO_00A_5EXC_DEFINICAO SET FLAG_FILTRAR =''S'', FLAG_GRAVAR= ''S'';')  ;
            SELF.IBQ_COMBINACOES.ExecSQL;
            SELF.IBQ_COMBINACOES.SQL.Clear;
            SELF.IBQ_COMBINACOES.SQL.Add('COMMIT')  ;
            SELF.IBQ_COMBINACOES.ExecSQL;     
...
PROCEDURE T_F_EMULADOR_5_EXC.PR_SIMULAR_RECUPERANDODADOS(VC_TIPO: STRING);
VAR
...
BEGIN
       ...
       SELF.IBQ_COMBINACOES.SQL.Clear;
       SELF.IBQ_COMBINACOES.SQL.Add('SELECT DISTINCT(DADOS), EXC1, EXC2, EXC3, EXC4, EXC5 FROM FILTRO_00A_5EXC_DADOS  ORDER BY DADOS;')  ;
       SELF.IBQ_COMBINACOES.Open;
       ...
       // ********************
           ...
           Self.WindowState :=  wsNormal;
           Self.Repaint;
       STGR_COMB5.RowCount := 0;
       SELF.IBQ_COMBINACOES.First;
       FOR VI_AN_COMB1:= 1 TO  VI_CONTAR DO
       BEGIN
           STGR_COMB5.Cells [0, VI_AN_COMB1] := INTtoSTR(VI_AN_COMB1);
           STGR_COMB5.Cells [1, VI_AN_COMB1] :=  IBQ_COMBINACOES.FIELDBYNAME('EXC1').AsString;
           STGR_COMB5.Cells [2, VI_AN_COMB1] :=  IBQ_COMBINACOES.FIELDBYNAME('EXC2').AsString;
           STGR_COMB5.Cells [3, VI_AN_COMB1] :=  IBQ_COMBINACOES.FIELDBYNAME('EXC3').AsString;
           STGR_COMB5.Cells [4, VI_AN_COMB1] :=  IBQ_COMBINACOES.FIELDBYNAME('EXC4').AsString;
           STGR_COMB5.Cells [5, VI_AN_COMB1] :=  IBQ_COMBINACOES.FIELDBYNAME('EXC5').AsString;
               STGR_COMB5.RowCount := VI_AN_COMB1;
       ...
       LA_TOTAL_100REPET.Caption := INTtoSTR(STGR_COMB5.RowCount);
       STGR_COMB5.REPAINT;
       LA_TOTAL_100REPET.Repaint;
...
procedure T_F_EMULADOR_5_EXC.BBT_PA_REMOVEUREPETClick(Sender: TObject);
begin
     PA_REMOVEUREPET.Left := 5000;
     BBT_RECOMECAR.Enabled := false;
     BBT_PREPARAR.Enabled := false;
...
procedure T_F_EMULADOR_5_EXC.BBT_BLOCO_NOTASClick(Sender: TObject);
var
    VI_AN_COMB1, VI_CONTAR : INTEGER;
    VC_COMBINACOES : string;
begin
    MEM_COMBINACOES_TODAS.Clear;
   	MEM_COMBINACOES_TODAS.Lines.Add('TOTAL: ' + INTtoSTR(STGR_COMB5.RowCount-1)) ;
   	MEM_COMBINACOES_TODAS.Lines.Add('----------------------------') ;
    FOR VI_CONTAR := 1 TO STGR_COMB5.RowCount-1 DO
    BEGIN
		VC_COMBINACOES :=INTtoSTR(VI_CONTAR)+'=> ';
    	FOR VI_AN_COMB1 := 1 TO 5 DO
        BEGIN
			VC_COMBINACOES := VC_COMBINACOES + STGR_COMB5.Cells[VI_AN_COMB1,VI_CONTAR] +' ';
        END; // FOR VI_AN_COMB1
...
procedure T_F_EMULADOR_5_EXC.BT_REAJUSTARClick(Sender: TObject);
begin
     PA_PREENCHIMENTO.Visible := TRUE;
     PA_PREENCHIMENTO.Enabled := TRUE;
     PA_GABARITO.Visible := TRUE;
...
procedure T_F_EMULADOR_5_EXC.BBT_CARREGARClick(Sender: TObject);
begin
...
procedure T_F_EMULADOR_5_EXC.BBT_CANCELARClick(Sender: TObject);
begin
            SELF.IBQ_COMBINACOES.SQL.Clear;
            SELF.IBQ_COMBINACOES.SQL.Add('UPDATE FILTRO_00A_5EXC_DEFINICAO SET FLAG_FILTRAR =''N'', FLAG_GRAVAR= ''N'';')  ;
            SELF.IBQ_COMBINACOES.ExecSQL;
