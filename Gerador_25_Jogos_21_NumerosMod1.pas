unit Gerador_25_Jogos_21_NumerosMod1;
...
Type
   T_F_GERADOR_25d21x4M1 = Class(TForm)
      Pa_INICIAL: TPanel;
      Label55: TLabel;
...
var
  _F_GERADOR_25d21x4M1: T_F_GERADOR_25d21x4M1;
...
Procedure T_F_GERADOR_25d21x4M1.FormCreate(Sender: TObject);
Begin
...
Procedure T_F_GERADOR_25d21x4M1.FormClose(Sender: TObject; Var Action: TCloseAction);
Begin
   TRY
      BEGIN
...
procedure T_F_GERADOR_25d21x4M1.Bbt_CLOSEClick(Sender: TObject);
begin
     SELF.Close;
end;
...
Procedure T_F_GERADOR_25d21x4M1.Bt_NOVA_SIMULACAOClick(Sender: TObject);
Begin
...
procedure T_F_GERADOR_25d21x4M1.Bbt_SAIRClick(Sender: TObject);
begin
     SELF.Close;
end;
...
procedure T_F_GERADOR_25d21x4M1.BitBtn1Click(Sender: TObject);
var
   Lista : Tlist<string>;
   qtd: integer;
begin
...
Procedure T_F_GERADOR_25d21x4M1.Bbt_PREPARAR1Click(Sender: TObject);
Begin
   PreenchimentoInicialPadrao;
...
Procedure T_F_GERADOR_25d21x4M1.Bbt_GerarComb05();
Begin
...
Procedure T_F_GERADOR_25d21x4M1.Bbt_Pa_REMOVEUREPETClick(Sender: TObject);
Begin
...
procedure T_F_GERADOR_25d21x4M1.Bbt_CarregarSorteio15NClick(Sender: TObject);
VAR
   viContar1: integer;
Begin
...
Procedure T_F_GERADOR_25d21x4M1.Bbt_CarregarSort(Sender: TObject);
VAR
   viContar1: integer;
Begin
   Ibq_E_SORTEIO_15N.Close;
...
procedure T_F_GERADOR_25d21x4M1.Bbt_RankClick(Sender: TObject);
var
...
Procedure T_F_GERADOR_25d21x4M1.PreenchimentoInicialPadrao;
var
  viContar: Integer;
begin
   ...
   for viContar := 2 to 5 do
   begin
      Stgr_Base04.Cells[viContar, 0] := INTtoSTR(viContar - 1);
   end;
   //01
...
//   Stgr_Base04.Cells[5, 25] := '11';
   ...
   Stgr_Base04.RowCount := 26;
   Stgr_Base21.Height := Scbx_GABARITO.Height - 55;
   Stgr_Base04.Height := Scbx_GABARITO.Height - 55;
...
procedure T_F_GERADOR_25d21x4M1.Zerar_FLAGTodosNumeros();
var
  viContar: Integer;
begin
...
procedure T_F_GERADOR_25d21x4M1.Falso_Linha1TodosNumeros();
var
  viContar: Integer;
begin
  for viContar := 1 to 25 do
...
procedure T_F_GERADOR_25d21x4M1.Falso_Linha2TodosNumeros();
var
  viContar: Integer;
begin
  for viContar := 1 to 25 do
...
procedure T_F_GERADOR_25d21x4M1.Falso_Linha1TodosNumerosP17();
begin
end;

procedure T_F_GERADOR_25d21x4M1.Falso_Linha2TodosNumerosP17();
begin
end;


function T_F_GERADOR_25d21x4M1.IIf(Expressao: Variant; ParteTRUE, ParteFALSE: Variant): Variant;
 begin
   if Expressao then
      Result := ParteTRUE
   else
