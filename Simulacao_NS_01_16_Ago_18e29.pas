...
procedure T_F_NS_01.BBT_GERAR_SIMULACAOClick(Sender: TObject);
VAR
    ...
    BEGIN
        ...
        IF ((VI_LINHAS2/2998) = (VI_LINHAS2 DIV 2998))
            or ((VI_LINHAS2/2999) = (VI_LINHAS2 DIV 2999))
            or ((VI_LINHAS2/3000) = (VI_LINHAS2 DIV 3000))
        ...
        BEGIN
           ...
           // SHOWMESSAGE ('DADOS-1 -> Gerar o Banco de Dados');
            ...
            BEGIN
                ...
                SELF.IBQ_COMBINACOES.ExecSQL;
            END;
            IF ((VI_LINHAS2/5998) = (VI_LINHAS2 DIV 5998))
                or ((VI_LINHAS2/5999) = (VI_LINHAS2 DIV 5999))
                or ((VI_LINHAS2/6000) = (VI_LINHAS2 DIV 6000))
                OR (VC_BEGIN_END = 'FIM') THEN
            BEGIN
                  SELF.IBQ_COMBINACOES.SQL.Clear;
...
begin
     ...
     VI_LINHAS2 := 1;
     PGBR_GERARCOMB.Position := 0 ;
     FOR VI_COMB01 := 1{ 427} TO STGR_TODOS_15.RowCount-1 {427} DO
     BEGIN
          ...
          FOR VI_COMB02 := 1 TO STGR_BASE_5.RowCount-1 DO
          BEGIN
               VI_CONTAR_A :=0;
               VI_CONTAR_B :=0;
               VI_CONTAR_C :=0;
...
begin
     ...
     BEGIN
          IF (STGR_TODOS_15.Cells[1,VI_COMBINACOES1] = 'V')
           ...
           ELSE
               STGR_TODOS_15.Cells [1,VI_COMBINACOES1] := 'F';
     END;
...
begin
     ...
     BEGIN
        IF (STGR_TODOS_15.Cells[1,VI_COMBINACOES1] = 'V')  THEN
        BEGIN
            FOR VI_CONTAR := 1 TO 15 DO
            BEGIN
               ...
               IF VI_CONTAR <11 THEN
                    _FRM_SIM_LOTOFACIL01.STGR_COMBINACOES_15.Cells [VI_CONTAR+17,VI_LINHAS2] := STGR_10_NS.Cells [VI_CONTAR+2,VI_COMBINACOES1];
            END; //FOR
           VI_LINHAS2 := VI_LINHAS2 +1 ;
