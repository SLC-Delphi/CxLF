object _F_Cjtos13Linhas8por5Impares: T_F_Cjtos13Linhas8por5Impares
  Left = 206
  Top = 154
  BorderIcons = []
  BorderStyle = bsSingle
  Caption = '_F_Cjtos13Linhas8por5Impares'
  ClientHeight = 496
  ClientWidth = 1158
  Color = 1319707
  ...
  object Pa_Topo: TPanel
    ...
    object La_Titulo: TLabel
      ...
      Width = 585
      Height = 34
      Caption = 'Conjunto 13 N'#250'meros de 8 por 5 - '#205'mpares'
      Color = clBlack
      Font.Charset = DEFAULT_CHARSET
      Font.Color = 15068110
      Font.Height = -29
  ...
  object Scbx_Gabarito: TScrollBox
    ...
    object Label1: TLabel
      ...
      Width = 214
      Height = 17
      Caption = 'Coluna de 08 n'#250'meros '#237'mpares'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clCream
      Font.Height = -14
      Font.Name = 'Tahoma'
    ...
    object Label2: TLabel
      ...
      Width = 214
      Height = 17
      Caption = 'Coluna de 05 n'#250'meros '#237'mpares'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clCream
      Font.Height = -14
      Font.Name = 'Tahoma'
    ...
    object stgr_Base08: TStringGrid
      Left = 3
      Top = 37
      Width = 280
      Height = 405
    ...
    object stgr_Base05: TStringGrid
      Left = 305
      Top = 36
      Width = 195
      Height = 405
    ...
    object Pa_NumeroLinhaAlterar: TPanel
      Left = 506
      Top = 35
      Width = 324
      Height = 73
      ...
      object bbt_OkLinhaAlterar: TBitBtn
        Left = 223
        Top = 36
        Width = 92
        Height = 25
        ...
        ParentFont = False
        TabOrder = 0
        OnClick = bbt_OkLinhaAlterarClick
      end
      object bbt_CancelarLinhaAlterar: TBitBtn
        Left = 9
        Top = 36
        Width = 92
        Height = 25
        ...
        ParentFont = False
        TabOrder = 1
        OnClick = bbt_CancelarLinhaAlterarClick
      end
      object edt_NumeroLinhaAlterar: TEdit
        Left = 134
        Top = 7
        Width = 25
        Height = 22
  ...
  object Pa_PreencherAlterar: TPanel
    Left = 506
    Top = 154
    Width = 440
    Height = 179
    ...
    object bbt_RecomecarAlterar: TBitBtn
      Left = 8
      Top = 7
      Width = 93
      Height = 26
      ...
      ParentFont = False
      TabOrder = 0
      OnClick = bbt_RecomecarAlterarClick
    end
    ...
    object bbt_EncerrarAlterar: TBitBtn
      Left = 340
      Top = 144
      Width = 92
      Height = 25
      ...
      ParentFont = False
      TabOrder = 26
      OnClick = bbt_EncerrarAlterarClick
    end
    object bbt_CancelarAlterar: TBitBtn
      Left = 9
      Top = 144
      Width = 92
      Height = 25
      ...
      ParentFont = False
      TabOrder = 27
      OnClick = bbt_CancelarAlterarClick
    end
  end
end
