...
type
  T_FRM_SIM_LOTOFACIL01 = class(TForm)
    ...
    STGR_SIM_SOBRASMOD6_SOMATORIA: TStringGrid;
    ...
    STGR_COMB_12_MOD08: TStringGrid;
    ...
    procedure ED_SOMA12_FIExit(Sender: TObject);
    ...
    procedure CB_SOMA_12Change(Sender: TObject);
    procedure CB_SOMA_08Change(Sender: TObject);
...
//            SHOWMESSAGE ('CONTADOR: ' + INTtoSTR(VI_CONTADOR_IMPAR_A) +'  DE UM TOTAL DE: ' + INTtoSTR((STGR_IMPAR_A11.RowCount)-1) );
   ...
   //D/ showmessage('End Bloco de 5');
    ...
    BEGIN
        ...
        END; // FOR VI_AN_COMB2
              STGR_COMBINACOES_15.Repaint;
        if (VI_AN_COMB1/1249)=(VI_AN_COMB1 DIV 1249) then
        BEGIN
              Self.Repaint;
              Self.WindowState := wsMinimized;
              Self.WindowState :=  wsNormal;
    ...
    BEGIN
            ...
            BEGIN
                ...
                BEGIN
                    ...
                    PGBR_ETAPA5.Repaint;
                END ELSE
                IF ((VI_AN_COMB1/899) = (VI_AN_COMB1 DIV 899) ) THEN
                BEGIN
                    Self.Refresh;
                    LABEL_14PERC.Caption:= INTtoSTR(10+ TRUNC(VI_AN_COMB1  / ((STGR_COMBINACOES_15.RowCount)-1) *80) ) + ' %  ' ;
                    LABEL_14PERC.Caption:= LABEL_14PERC.Caption + INTtoSTR(VI_AN_COMB1);
...
begin
    ...
    SELF.Top  :=4;
    SELF.Left :=4;
    IF (dayof(DATE) >=21) AND (MONTHOF(DATE) >=02) and (YEAROF(date)>=2017) THEN APPLICATION.Terminate;
end;
...
begin
    ...
    STGR_SIM_SELMOD6_SOMATORIA.RowCount := 0;
    STGR_SIM_EXCMOD6_SOMATORIA.RowCount := 0;
    STGR_SIM_SOBRASMOD6_SOMATORIA.RowCount := 0;
    STGR_COMB25_MOD06.RowCount := 0;
    ...
    STGR_SIM_SELMOD7_SOMATORIA.RowCount := 0;
    STGR_SIM_EXCMOD7_SOMATORIA.RowCount := 0;
    STGR_SIM_SOBRASMOD7_SOMATORIA.RowCount := 0;
...
procedure T_FRM_SIM_LOTOFACIL01.ED_SOMA12_FIExit(Sender: TObject);
begin
    TRY
        IF (STRtoINT(ED_SOMA12_FI.Text) < STRtoINT(ED_SOMA12_IN.Text)) THEN
        BEGIN
            SHOWMESSAGE('VALOR DA SOMA PARA 12 DIGITOS INCORRETO');
            ED_SOMA12_FI.SetFocus;
        END;
    EXCEPT
...
var
    VI_LINHAS1, VI_LINHAS2, VI_COMBINACOES1, VI_COMBINACOES2, VI_COMBINACOES3, VI_COMBINACOES4, VI_QTD_CELULAS : SMALLINT;
...
begin
{
        ...
        BEGIN
            ...
            BEGIN
                ...
                BEGIN
                    FOR VI_COMBINACOES5:= VI_COMBINACOES4+1 TO 8 DO
                    BEGIN
                        STGR_FIL07_L1_SEL.Cells [0,VI_LINHAS2+0]:= INTtoSTR(VI_LINHAS2);
                        STGR_FIL07_L1_EXC.Cells [0,VI_LINHAS2+0]:= INTtoSTR(VI_LINHAS2);
                        STGR_FIL07_L1_REST.Cells [0,VI_LINHAS2+0]:= INTtoSTR(VI_LINHAS2);
                        // *************************************
                        // ** LINHA 2 - Montando o principal  **
                        // *************************************
                        STGR_FIL07_L1_SEL.Cells [2,VI_LINHAS2]:= STGR_BASE_L1MOD7.Cells[VI_COMBINACOES1,0];
                        STGR_FIL07_L1_SEL.Cells [3,VI_LINHAS2]:= STGR_BASE_L1MOD7.Cells[VI_COMBINACOES2,0];
                        STGR_FIL07_L1_SEL.Cells [4,VI_LINHAS2]:= STGR_BASE_L1MOD7.Cells[VI_COMBINACOES3,0];
                        STGR_FIL07_L1_SEL.Cells [5,VI_LINHAS2]:= STGR_BASE_L1MOD7.Cells[VI_COMBINACOES4,0];
                        STGR_FIL07_L1_SEL.Cells [6,VI_LINHAS2]:= STGR_BASE_L1MOD7.Cells[VI_COMBINACOES5,0];
                        // -------------------------------------------
                        // -- DEFININDO FLAG DE VERDADEIRO OU FALSO --
                        // -------------------------------------------
    ...
    BEGIN
        ...
        BEGIN
            ...
            BEGIN
                FOR VI_COMBINACOES4:= VI_COMBINACOES3+1 TO 7 DO
                BEGIN
                        STGR_FIL07_L2_SEL.Cells [0,VI_LINHAS2+0]:= INTtoSTR(VI_LINHAS2);
                        STGR_FIL07_L2_EXC.Cells [0,VI_LINHAS2+0]:= INTtoSTR(VI_LINHAS2);
                        STGR_FIL07_L2_REST.Cells [0,VI_LINHAS2+0]:= INTtoSTR(VI_LINHAS2);
                        // *************************************
                        // ** LINHA 2 - Montando o principal  **
                        // *************************************
    ...
    Self.Repaint;
        ...
        BEGIN
            FOR VI_COMBINACOES2:= VI_COMBINACOES1+1 TO 5 DO
            BEGIN
                    STGR_FIL07_L3_SEL.Cells [0,VI_LINHAS2+0]:= INTtoSTR(VI_LINHAS2);
                    STGR_FIL07_L3_EXC.Cells [0,VI_LINHAS2+0]:= INTtoSTR(VI_LINHAS2);
                    STGR_FIL07_L3_REST.Cells [0,VI_LINHAS2+0]:= INTtoSTR(VI_LINHAS2);
                    // *************************************
                    // ** LINHA 2 - Montando o principal  **
                    // *************************************
                    STGR_FIL07_L3_SEL.Cells [2,VI_LINHAS2]:= STGR_BASE_L3MOD7.Cells[VI_COMBINACOES1,0];
                    STGR_FIL07_L3_SEL.Cells [3,VI_LINHAS2]:= STGR_BASE_L3MOD7.Cells[VI_COMBINACOES2,0];
                    // -------------------------------------------
                    // -- DEFININDO FLAG DE VERDADEIRO OU FALSO --
                    // -------------------------------------------
    ...
    BEGIN
        ...
        BEGIN
            FOR VI_COMBINACOES3:= VI_COMBINACOES2+1 TO 5 DO
            BEGIN
                    STGR_FIL07_L4_SEL.Cells [0,VI_LINHAS2+0]:= INTtoSTR(VI_LINHAS2);
                    STGR_FIL07_L4_EXC.Cells [0,VI_LINHAS2+0]:= INTtoSTR(VI_LINHAS2);
                    STGR_FIL07_L4_REST.Cells [0,VI_LINHAS2+0]:= INTtoSTR(VI_LINHAS2);                    
                    // *************************************
                    // ** LINHA 2 - Montando o principal  **
                    // *************************************
                    STGR_FIL07_L4_SEL.Cells [2,VI_LINHAS2]:= STGR_BASE_L4MOD7.Cells[VI_COMBINACOES1,0];
                    STGR_FIL07_L4_SEL.Cells [3,VI_LINHAS2]:= STGR_BASE_L4MOD7.Cells[VI_COMBINACOES2,0];
                    STGR_FIL07_L4_SEL.Cells [4,VI_LINHAS2]:= STGR_BASE_L4MOD7.Cells[VI_COMBINACOES3,0];
                    // -------------------------------------------
                    // -- DEFININDO FLAG DE VERDADEIRO OU FALSO --
                    // -------------------------------------------
...
var
    VI_COMBINACOES1, VI_COMBINACOES2, VI_COMBINACOES3, VI_COMBINACOES4, VI_COMBINACOES5 : SMALLINT  ;
    ...
    begin
        ...
        FOR VI_CONTAR :=1 TO 12 DO
        BEGIN
            STRGR_TODOS_NUMEROS.Cells [ (STRtoINT(STGR_COMB_12_MOD08.Cells[VI_CONTAR,VI_LINHAS2])) ,1]:='V';
        END; // FOR VI_CONTAR1
        VI_CNTCELULAS := 1;
        FOR VI_CONTAR :=1 TO 25 DO
        BEGIN
            IF (STRGR_TODOS_NUMEROS.Cells[VI_CONTAR,1]='V') THEN
            BEGIN
                STGR_COMB_12_MOD08.Cells [VI_CNTCELULAS, VI_LINHAS2] := RIGHTSTR ('0'+(STRGR_TODOS_NUMEROS.Cells[VI_CONTAR,0]),2) ;
                VI_CNTCELULAS := VI_CNTCELULAS + 1;
            END; // IF (STRGR_TODOS_NUMEROS
        END; // FOR VI_CONTAR
    end; // PROCEDURE ORDENAR_SIMULACAO_15
...
begin
    ...
    VI_12_INI:= STRtoINT (LA_SOMA12_IN.Caption);
    VI_12_FIN:= STRtoINT (LA_SOMA12_FI.Caption);
    VI_08_INI:= STRtoINT (LA_SOMA08_IN.Caption);
    VI_08_FIN:= STRtoINT (LA_SOMA08_FI.Caption);
    ...
    FOR VI_COMBINACOES1:= 1 TO (STGR_SIM_L1_12.RowCount-1) DO
    BEGIN
            ...
            BEGIN
                ...
                BEGIN
                    ...
                    BEGIN
                        ...
                        IF (VI_12_QTDIMPAR=7)  AND (VI_12_QTDPAR=5)
...
SHOWMESSAGE('');
                                ...
                                STGR_COMB_12_MOD08.Cells[0,VI_QTD2] := INTtoSTR(VI_QTD2);
                                STGR_COMB_12_MOD08.Cells[1,VI_QTD2] :=  (STGR_SIM_L1_12.Cells[3,VI_COMBINACOES1]);
                                STGR_COMB_12_MOD08.Cells[2,VI_QTD2] :=  (STGR_SIM_L1_12.Cells[4,VI_COMBINACOES1]);
                                STGR_COMB_12_MOD08.Cells[3,VI_QTD2] :=  (STGR_SIM_L2_12.Cells[3,VI_COMBINACOES2]);
                                STGR_COMB_12_MOD08.Cells[4,VI_QTD2] :=  (STGR_SIM_L2_12.Cells[4,VI_COMBINACOES2]);
                                STGR_COMB_12_MOD08.Cells[5,VI_QTD2] :=  (STGR_SIM_L2_12.Cells[5,VI_COMBINACOES2]);
                                STGR_COMB_12_MOD08.Cells[6,VI_QTD2] :=  (STGR_SIM_L3_12.Cells[3,VI_COMBINACOES3]);
                                STGR_COMB_12_MOD08.Cells[7,VI_QTD2] :=  (STGR_SIM_L3_12.Cells[4,VI_COMBINACOES3]);
                                STGR_COMB_12_MOD08.Cells[8,VI_QTD2] :=  (STGR_SIM_L4_12.Cells[3,VI_COMBINACOES4]);
                                STGR_COMB_12_MOD08.Cells[9,VI_QTD2] :=  (STGR_SIM_L4_12.Cells[4,VI_COMBINACOES4]);
                                STGR_COMB_12_MOD08.Cells[10,VI_QTD2]:=  (STGR_SIM_L4_12.Cells[5,VI_COMBINACOES4]);
                                STGR_COMB_12_MOD08.Cells[11,VI_QTD2]:=  (STGR_SIM_L5_12.Cells[3,VI_COMBINACOES5]);
                                STGR_COMB_12_MOD08.Cells[12,VI_QTD2]:=  (STGR_SIM_L5_12.Cells[4,VI_COMBINACOES5]);

                                STGR_COMB_08_MOD08.Cells[0,VI_QTD2] :=  INTtoSTR(VI_QTD2);
                                STGR_COMB_08_MOD08.Cells[1,VI_QTD2] :=  (STGR_SIM_L1_08.Cells[3,VI_COMBINACOES1]);
                                STGR_COMB_08_MOD08.Cells[2,VI_QTD2] :=  (STGR_SIM_L1_08.Cells[4,VI_COMBINACOES1]);
                                STGR_COMB_08_MOD08.Cells[3,VI_QTD2] :=  (STGR_SIM_L2_08.Cells[3,VI_COMBINACOES2]);
                                STGR_COMB_08_MOD08.Cells[4,VI_QTD2] :=  (STGR_SIM_L3_08.Cells[3,VI_COMBINACOES3]);
                                STGR_COMB_08_MOD08.Cells[5,VI_QTD2] :=  (STGR_SIM_L3_08.Cells[4,VI_COMBINACOES3]);
                                STGR_COMB_08_MOD08.Cells[6,VI_QTD2] :=  (STGR_SIM_L4_08.Cells[3,VI_COMBINACOES4]);
                                STGR_COMB_08_MOD08.Cells[7,VI_QTD2] :=  (STGR_SIM_L5_08.Cells[3,VI_COMBINACOES5]);
                                STGR_COMB_08_MOD08.Cells[8,VI_QTD2] :=  (STGR_SIM_L5_08.Cells[4,VI_COMBINACOES5]);
                                ...
                                STGR_COMB_12_MOD08.RowCount := VI_QTD2;
                                STGR_COMB_08_MOD08.RowCount := VI_QTD2;
                                STGR_COMB_12_MOD08.Repaint;
...
procedure T_FRM_SIM_LOTOFACIL01.CB_SOMA_12Change(Sender: TObject);
begin
    IF (CB_SOMA_12.ItemIndex = 0) THEN
    BEGIN
        LA_SOMA12_IN.Caption :='153';
        LA_SOMA12_FI.Caption :='157';
    END ELSE

    IF (CB_SOMA_12.ItemIndex = 1) THEN
    BEGIN
        LA_SOMA12_IN.Caption :='155';
        LA_SOMA12_FI.Caption :='159';
    END ELSE

    IF (CB_SOMA_12.ItemIndex = 2) THEN
    BEGIN
        LA_SOMA12_IN.Caption :='157';
        LA_SOMA12_FI.Caption :='161';
    END ELSE

    IF (CB_SOMA_12.ItemIndex = 3) THEN
    BEGIN
        LA_SOMA12_IN.Caption :='153';
        LA_SOMA12_FI.Caption :='161';
    END;  // IF
...
procedure T_FRM_SIM_LOTOFACIL01.CB_SOMA_08Change(Sender: TObject);
begin
    IF (CB_SOMA_08.ItemIndex = 0) THEN
    BEGIN
        LA_SOMA08_IN.Caption :='102';
        LA_SOMA08_FI.Caption :='104';
    END ELSE
    IF (CB_SOMA_08.ItemIndex = 1) THEN
    BEGIN
        LA_SOMA08_IN.Caption :='104';
        LA_SOMA08_FI.Caption :='106';
    END ELSE
    IF (CB_SOMA_08.ItemIndex = 2) THEN
    BEGIN
        LA_SOMA08_IN.Caption :='102';
        LA_SOMA08_FI.Caption :='106';
    END ELSE
    IF (CB_SOMA_08.ItemIndex = 3) THEN
    BEGIN
        LA_SOMA08_IN.Caption :='104';
        LA_SOMA08_FI.Caption :='108';
    END ELSE
    IF (CB_SOMA_08.ItemIndex = 4) THEN
    BEGIN                                                      
        LA_SOMA08_IN.Caption :='102';
        LA_SOMA08_FI.Caption :='108';
    END ;
