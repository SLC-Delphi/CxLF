...
type
  T_F_SIM_01_FILTRO_06b = class(TForm)
    PA_TOPO: TPanel;
    BBT_CLOSE: TImage;
    Label34: TLabel;
    PA_GABARITO: TPanel;
...
var
  _F_SIM_01_FILTRO_06b: T_F_SIM_01_FILTRO_06b;
...
procedure T_F_SIM_01_FILTRO_06b.BBT_CLICK_TUDOClick(Sender: TObject);
begin
     BBT_706.Click;
     BBT_712.Click;
     BBT_720.Click;
...
procedure T_F_SIM_01_FILTRO_06b.Button1Click(Sender: TObject);
begin
     BBT_706.Click;
     BBT_710.Click;
     BBT_722.Click;
...
procedure T_F_SIM_01_FILTRO_06b.FormCreate(Sender: TObject);
VAR
    VI_CONTAR : INTEGER;
begin
...
procedure T_F_SIM_01_FILTRO_06b.BBT_CLOSEClick(Sender: TObject);
begin
     SELF.Close;
end;
...
procedure T_F_SIM_01_FILTRO_06b.BBT_701Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(1);
    BBT_701.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_06b.BBT_702Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(2);
    BBT_702.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_06b.BBT_703Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(3);
    BBT_703.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_06b.BBT_704Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(4);
    BBT_704.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_06b.BBT_705Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(5);
    BBT_705.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_06b.BBT_706Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(6);
    BBT_706.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_06b.BBT_707Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(7);
    BBT_707.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_06b.BBT_708Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(8);
    BBT_708.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_06b.BBT_710Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(10);
    BBT_710.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_06b.BBT_709Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(9);
    BBT_709.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_06b.BBT_711Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(11);
    BBT_711.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_06b.BBT_712Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(12);
    BBT_712.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_06b.BBT_713Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(13);
    BBT_713.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_06b.BBT_714Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(14);
    BBT_714.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_06b.BBT_715Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(15);
    BBT_715.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_06b.BBT_716Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(16);
    BBT_716.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_06b.BBT_717Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(17);
    BBT_717.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_06b.BBT_718Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(18);
    BBT_718.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_06b.BBT_719Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(19);
    BBT_719.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_06b.BBT_720Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(20);
    BBT_720.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_06b.BBT_721Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(21);
    BBT_721.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_06b.BBT_722Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(22);
    BBT_722.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_06b.BBT_723Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(23);
    BBT_723.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_06b.BBT_724Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(24);
    BBT_724.Enabled := FALSE;
end;

procedure T_F_SIM_01_FILTRO_06b.BBT_725Click(Sender: TObject);
begin
...
PROCEDURE T_F_SIM_01_FILTRO_06b.PR_BOTOES_MODELO_12345 (VI_NUMERO: INTEGER);
VAR
...
procedure T_F_SIM_01_FILTRO_06b.BBT_RECOMECARClick(Sender: TObject);
VAR
    VI_CONTAR : INTEGER;
begin
...
procedure T_F_SIM_01_FILTRO_06b.BBT_PREPARARClick(Sender: TObject);
var
...
begin
     ...
     END; // FOR
     IF (VSI_QTD_PAR < 2)  THEN
     BEGIN
          SHOWMESSAGE ('Preenchimento incorreto.' +#13+ 'Linha 1 tem de ter ao menos 2 pares' );
          EXIT;
     END; // IF
     ...
     BEGIN
          ...
          ELSE
               VSI_QTD_IMPAR := VSI_QTD_IMPAR + 1 ;
     END; // FOR
     IF (VSI_QTD_IMPAR < 4)  THEN
     BEGIN
          SHOWMESSAGE ('Preenchimento incorreto.' +#13+ 'A quantidade de números ímpares na linha 2 e 3 tem de ser no mínimo de 4.' );
          EXIT;
     END; // IF
     ...
     BEGIN
          ...
          ELSE
               VSI_QTD_IMPAR := VSI_QTD_IMPAR + 1 ;
     END; // FOR
     IF ((VSI_QTD_PAR < 1) OR (VSI_QTD_IMPAR < 1 )) THEN
     BEGIN
          SHOWMESSAGE ('preenchimento incorreto.' +#13+ 'Linha 4 tem de ter ao menos 1 impar e/ou 1 par' );
          EXIT;
     END; // IF
        // ***************************
     ...
     STGR_LINHA_1_C1.Cells[1,1] := '2';
     STGR_LINHA_1_C1.Cells[0,2] := '2';
     STGR_LINHA_1_C1.Cells[1,2] := '2';
     STGR_LINHA_1_C1.Cells[0,3] := '3';
     STGR_LINHA_1_C1.Cells[1,3] := '2';
     ...
     STGR_LINHA_1_C1.Cells[2,3] := STGR_BASE_L1.Cells[3,0];
      STGR_LINHA_1_C1.Cells[3,1] := STGR_BASE_L1.Cells[3,0];
      STGR_LINHA_1_C1.Cells[3,2] := STGR_BASE_L1.Cells[1,0];
      STGR_LINHA_1_C1.Cells[3,3] := STGR_BASE_L1.Cells[2,0];
     ...
     STGR_LINHA_4_C1.Cells[0,5] := '05';
     STGR_LINHA_4_C1.Cells[1,5] := 'V';
     STGR_LINHA_4_C1.Cells[2,5] := '2';
     STGR_LINHA_4_C1.Cells[3,5] :=STGR_BASE_L4.Cells[2,0];
     STGR_LINHA_4_C1.Cells[4,5] :=STGR_BASE_L4.Cells[4,0];
     STGR_LINHA_4_C1.Cells[5,5] := '00';
     STGR_LINHA_4_C1.Cells[6,5] := '00';
     STGR_LINHA_4_C1.Cells[0,6] := '06';
     STGR_LINHA_4_C1.Cells[1,6] := 'V';
     STGR_LINHA_4_C1.Cells[2,6] := '2';
     STGR_LINHA_4_C1.Cells[3,6] :=STGR_BASE_L4.Cells[3,0];
     STGR_LINHA_4_C1.Cells[4,6] :=STGR_BASE_L4.Cells[4,0];
     STGR_LINHA_4_C1.Cells[5,6] := '00';
     STGR_LINHA_4_C1.Cells[6,6] := '00';
     LA_LINHA_4_100REP.Caption :='6';
     STGR_LINHA_4_C1.RowCount := 7;
                    ...
                    BEGIN
                     ...
                     //    IF (VI_CNTCELULAS=1) THEN
                      //   BEGIN
                         ...
                         END ELSE
                         BEGIN
                              IF ( VSI_QTD_IMPAR = 5 ) AND ( VSI_QTD_PAR = 3 ) AND (VSI_QTD_PAR_L1 = 2) AND (VSI_QTD_IMPAR_L2e3=4) THEN
                                   STGR_LINHA_1234_TODOS.Cells[12,VI_LINHAS2] := 'V'
                              ELSE
                                   STGR_LINHA_1234_TODOS.Cells[12,VI_LINHAS2] := 'F';                         
                         END; // IF (RB_PREPARAR_!
     ...
     BEGIN
          ...
          BEGIN
                    ...
                    STGR_LINHA_5_Comb7_1.Cells[5,VI_LINHAS2] := STGR_BASE_L5.Cells[1,VI_COMBINACOES02];
                    STGR_LINHA_5_Comb7_1.Cells[6,VI_LINHAS2] := STGR_BASE_L5.Cells[2,VI_COMBINACOES02];
                    FOR VI_COMBINACOES03:= VI_COMBINACOES02+1 TO 6 DO
                    BEGIN
                     //    FOR VI_COMBINACOES04:=1 TO 2 DO
                      //   BEGIN
                              STGR_LINHA_5_Comb7_1.Cells[2,VI_LINHAS2] := '7';
                              ...
                              STGR_LINHA_5_Comb7_1.Cells[5,VI_LINHAS2] := STGR_BASE_L5.Cells[1,VI_COMBINACOES02];
                              STGR_LINHA_5_Comb7_1.Cells[6,VI_LINHAS2] := STGR_BASE_L5.Cells[2,VI_COMBINACOES02];
                              STGR_LINHA_5_Comb7_1.Cells[7,VI_LINHAS2] := STGR_BASE_L5.Cells[1,VI_COMBINACOES03];
                              STGR_LINHA_5_Comb7_1.Cells[8,VI_LINHAS2] := STGR_BASE_L5.Cells[2,VI_COMBINACOES03];
                             { IF  (STGR_LINHA_5_Comb7.Cells[7,VI_LINHAS2] = STGR_LINHA_5_Comb7.Cells[3,VI_LINHAS2]) OR (STGR_LINHA_5_Comb7.Cells[7,VI_LINHAS2] = STGR_LINHA_5_Comb7.Cells[4,VI_LINHAS2]) OR
                                  (STGR_LINHA_5_Comb7.Cells[7,VI_LINHAS2] = STGR_LINHA_5_Comb7.Cells[5,VI_LINHAS2]) OR (STGR_LINHA_5_Comb7.Cells[7,VI_LINHAS2] = STGR_LINHA_5_Comb7.Cells[6,VI_LINHAS2])
                                  or  (STGR_LINHA_5_Comb7.Cells[8,VI_LINHAS2] = STGR_LINHA_5_Comb7.Cells[3,VI_LINHAS2]) OR (STGR_LINHA_5_Comb7.Cells[8,VI_LINHAS2] = STGR_LINHA_5_Comb7.Cells[4,VI_LINHAS2]) OR
                                  (STGR_LINHA_5_Comb7.Cells[8,VI_LINHAS2] = STGR_LINHA_5_Comb7.Cells[5,VI_LINHAS2]) OR (STGR_LINHA_5_Comb7.Cells[8,VI_LINHAS2] = STGR_LINHA_5_Comb7.Cells[6,VI_LINHAS2])
                              then
                                   CONTINUE; }
                              ...
                              BEGIN
                                   ...
                                   BEGIN
                                        ...
                                        STGR_LINHA_5_Comb7_1.Cells[7,VI_LINHAS2] := STGR_BASE_L5.Cells[1,VI_COMBINACOES03];
                                        STGR_LINHA_5_Comb7_1.Cells[8,VI_LINHAS2] := STGR_BASE_L5.Cells[2,VI_COMBINACOES03];
                                        STGR_LINHA_5_Comb7_1.Cells[9,VI_LINHAS2] := STGR_BASE_L5.Cells[VI_COMBINACOES06,VI_COMBINACOES05];
                                        IF  (STGR_LINHA_5_Comb7.Cells[9,VI_LINHAS2] = STGR_LINHA_5_Comb7.Cells[3,VI_LINHAS2]) OR (STGR_LINHA_5_Comb7.Cells[9,VI_LINHAS2] = STGR_LINHA_5_Comb7.Cells[4,VI_LINHAS2]) OR
                                            (STGR_LINHA_5_Comb7.Cells[9,VI_LINHAS2] = STGR_LINHA_5_Comb7.Cells[5,VI_LINHAS2]) OR (STGR_LINHA_5_Comb7.Cells[9,VI_LINHAS2] = STGR_LINHA_5_Comb7.Cells[6,VI_LINHAS2]) OR
                                            (STGR_LINHA_5_Comb7.Cells[9,VI_LINHAS2] = STGR_LINHA_5_Comb7.Cells[7,VI_LINHAS2]) OR (STGR_LINHA_5_Comb7.Cells[9,VI_LINHAS2] = STGR_LINHA_5_Comb7.Cells[8,VI_LINHAS2])
                                        THEN
                                             CONTINUE;
                                        IF (VI_COMBINACOES01 = VI_COMBINACOES05) or (VI_COMBINACOES02 = VI_COMBINACOES05) or (VI_COMBINACOES03 = VI_COMBINACOES05) THEN
                                             CONTINUE;
                                        STGR_LINHA_5_Comb7_1.Cells[0,VI_LINHAS2] := INTtoSTR(VI_LINHAS2);
...
procedure T_F_SIM_01_FILTRO_06b.BBT_GERAR_FILTROClick(Sender: TObject);
begin
     PA_GERAR.Enabled := TRUE;
     PA_GERAR.Left := 650;
end;

procedure T_F_SIM_01_FILTRO_06b.BBT_GERARClick(Sender: TObject);
...
var
     ...
     VI_SOMA1: SMALLINT;
     VI_FLAG_SOMATORIA1, VI_FLAG_SOMATORIA2, VI_FLAG_SOMATORIA3, VI_FLAG_SOMATORIA4, VI_FINAL_FOR: SMALLINT;
begin
    ...
    // =================== AQUI
     ...
     BEGIN
          ...
          IF (RB_PREPARAR_1.Checked = TRUE) THEN
          BEGIN
               // **********************
               // **   7 - 2 duplas + 3
               // **********************
               VI_FINAL_FOR := (STGR_LINHA_5_Comb7.RowCount-1)  ;
               FOR VI_COMBINACOES02 := 1{16} TO {18} VI_FINAL_FOR DO
               BEGIN
          ...
          BEGIN
               ...
               // **   7 - 3 duplas + 1
               // **********************
               VI_FINAL_FOR := (STGR_LINHA_5_Comb7_1.RowCount-1);
               FOR VI_COMBINACOES02 := 1{16} TO {18} VI_FINAL_FOR DO
               BEGIN
                    IF ((STGR_LINHA_1234_TODOS.Cells[1,VI_COMBINACOES01]='V') AND (STGR_LINHA_1234_TODOS.Cells[12,VI_COMBINACOES01]='V')) AND ((STGR_LINHA_5_Comb7_1.Cells[10,VI_COMBINACOES02]='V') AND (STGR_LINHA_5_Comb7_1.Cells[1,VI_COMBINACOES02]='V')) THEN
                    BEGIN
                    // ***************************************************************************************************
...
PROCEDURE T_F_SIM_01_FILTRO_06b.PR_SIMULAR_RECUPERANDODADOS(VC_TIPO: STRING);
VAR
...
procedure T_F_SIM_01_FILTRO_06b.BBT_ENCERRARClick(Sender: TObject);
VAR
...
procedure T_F_SIM_01_FILTRO_06b.BBT_PA_REMOVEUREPETClick(Sender: TObject);
begin
...
procedure T_F_SIM_01_FILTRO_06b.BBT_FIMFILTROClick(Sender: TObject);
begin
...
procedure T_F_SIM_01_FILTRO_06b.BBT_GERAR_VOLTARClick(Sender: TObject);
begin
     PA_GERAR.Enabled := TRUE;
     PA_GERAR.Left := 4500;
     PA_PREPARAR_MENU.Enabled := false;
...
procedure T_F_SIM_01_FILTRO_06b.BT_NOVA_SIMULACAOClick(Sender: TObject);
begin
...
procedure T_F_SIM_01_FILTRO_06b.BT_CARREGAR_SIMULACAOClick(Sender: TObject);
begin
     BBT_RECOMECAR.Click;
...
procedure T_F_SIM_01_FILTRO_06b.FormClose(Sender: TObject;
...
procedure T_F_SIM_01_FILTRO_06b.BBT_CANCELARClick(Sender: TObject);
begin
            SELF.IBQ_COMBINACOES.SQL.Clear;
            SELF.IBQ_COMBINACOES.SQL.Add('UPDATE FILTRO_06_DEFINICAO SET FLAG_FILTRAR =''N'', FLAG_GRAVAR= ''N'';')  ;
            SELF.IBQ_COMBINACOES.ExecSQL;
...
procedure T_F_SIM_01_FILTRO_06b.Set_SET_FLAG_AUTOEXECUTAR(
  const Value: STRING);
begin
...
procedure T_F_SIM_01_FILTRO_06b.BBT_PREPARAR_MENUClick(Sender: TObject);
begin
