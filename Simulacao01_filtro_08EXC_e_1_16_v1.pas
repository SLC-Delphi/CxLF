unit Simulacao01_filtro_08EXC_e_1_16_v1;
...
type
  T_F_FILTRO_08_NS1_16_v1 = class(TForm)
    PA_TOPO: TPanel;
    BBT_CLOSE: TImage;
    Label34: TLabel;
    PA_GABARITO: TPanel;
...
var
  _F_FILTRO_08_NS1_16_v1: T_F_FILTRO_08_NS1_16_v1;

implementation

{$R *.dfm}

procedure T_F_FILTRO_08_NS1_16_v1.FormCreate(Sender: TObject);
VAR
    VI_CONTAR : INTEGER;
begin
    ...
    END;
     ...
     SELF.IBQ_COMBINACOES.SQL.Add('UPDATE FILTRO_0008EXC1_DEFINICAO SET FLAG_FILTRAR =''N'', FLAG_GRAVAR= ''N'';')  ;
...
procedure T_F_FILTRO_08_NS1_16_v1.FormShow(Sender: TObject);
begin
     PA_REMOVEUREPET.Left := 5000;
     PA_FIMFILTRO.Left := 5000;
     PA_GABARITO.Visible := false;
...
procedure T_F_FILTRO_08_NS1_16_v1.FormClose(Sender: TObject;
...
procedure T_F_FILTRO_08_NS1_16_v1.BBT_CLOSEClick(Sender: TObject);
begin
     SELF.Close;
end;
...
procedure T_F_FILTRO_08_NS1_16_v1.TRB_SOMA7_INIChange(Sender: TObject);
begin
...
procedure T_F_FILTRO_08_NS1_16_v1.TRB_SOMA7_FinalChange(Sender: TObject);
begin
     CASE CB_SOMATORIA_8_NumerosBase.ItemIndex OF
          0:
          BEGIN
...
procedure T_F_FILTRO_08_NS1_16_v1.TRB_SOMA12_INIChange(Sender: TObject);
begin
...
procedure T_F_FILTRO_08_NS1_16_v1.TRB_SOMA12_FinalChange(Sender: TObject);
begin
...
procedure T_F_FILTRO_08_NS1_16_v1.BBT_RECOMECARClick(Sender: TObject);
VAR
    VI_CONTAR : INTEGER;
begin
...
procedure T_F_FILTRO_08_NS1_16_v1.BBT_RECOMECAR_Q2Click(Sender: TObject);
VAR
    VI_CONTAR : INTEGER;
begin
...
procedure T_F_FILTRO_08_NS1_16_v1.BBT_CLICK_TUDOClick(Sender: TObject);
begin
     BBT_701.Click;
     BBT_702.Click;
     BBT_707.Click;
...
procedure T_F_FILTRO_08_NS1_16_v1.BBT_PREPARAR1Click(Sender: TObject);
var
     VI_CONTADOR, VI_CONTAR, VI_LINHAS2, VI_COMBINACOES1, VI_COMBINACOES2: integer;
     VI_COMBINACOES3, VI_COMBINACOES4, VI_COMBINACOES5, VI_COMBINACOES6, VI_COMBINACOES7,  VI_COMBINACOES8 : SMALLINT;
     ...
     STGR_LINHA_1_C2.Repaint;
          ...
          BEGIN
               IF  (STRtoINT(STGR_LINHA_1_C1.Cells[2,VI_COMBINACOES1]) = STRtoINT(ED_EXC_04.Text)) OR
                   (STRtoINT(STGR_LINHA_1_C1.Cells[3,VI_COMBINACOES1]) = STRtoINT(ED_EXC_04.Text))
                   THEN
               BEGIN
                   STGR_LINHA_1_C1.Cells [1,VI_COMBINACOES1] := 'F';
               END; // if (STGR_LINHA_1_TODOS.Cells[1,VI_CONTAR]
          ...
          BEGIN
               IF  (STRtoINT(STGR_LINHA_1_C1.Cells[2,VI_COMBINACOES1]) = STRtoINT(ED_EXC_05.Text)) OR
                   (STRtoINT(STGR_LINHA_1_C1.Cells[3,VI_COMBINACOES1]) = STRtoINT(ED_EXC_05.Text))
                   THEN
               BEGIN
                   STGR_LINHA_1_C1.Cells [1,VI_COMBINACOES1] := 'F';
               END; // if (STGR_LINHA_1_TODOS.Cells[1,VI_CONTAR]
     ...
     STGR_LINHA_4_C2.Repaint;
          ...
          BEGIN
               IF  (STRtoINT(STGR_LINHA_4_C1.Cells[2,VI_COMBINACOES1]) = STRtoINT(ED_EXC_04.Text))  OR
                   (STRtoINT(STGR_LINHA_4_C1.Cells[3,VI_COMBINACOES1]) = STRtoINT(ED_EXC_04.Text))
                   THEN
               BEGIN
                   STGR_LINHA_4_C1.Cells [1,VI_COMBINACOES1] := 'F';
               END; // if (STGR_LINHA_4_TODOS.Cells[1,VI_CONTAR]
          ...
          BEGIN
               IF  (STRtoINT(STGR_LINHA_4_C1.Cells[2,VI_COMBINACOES1]) = STRtoINT(ED_EXC_05.Text)) OR
                   (STRtoINT(STGR_LINHA_4_C1.Cells[3,VI_COMBINACOES1]) = STRtoINT(ED_EXC_05.Text))
                   THEN
               BEGIN
                   STGR_LINHA_4_C1.Cells [1,VI_COMBINACOES1] := 'F';
               END; // if (STGR_LINHA_4_TODOS.Cells[1,VI_CONTAR]
    ...
    // =====================================
     ...
     BEGIN
          ...
          BEGIN
               ...
               BEGIN
                    FOR VI_COMBINACOES7:= VI_COMBINACOES5+1 TO 6 DO
                    BEGIN
                         // coluna 2
                         ...
                         BEGIN
                              ...
                              BEGIN
                                   ...
                                   BEGIN
                                        FOR VI_COMBINACOES8:= VI_COMBINACOES6+1 TO 6 DO
                                        BEGIN
                                             ...
                                             STGR_VCOLUNAS_1_2.Cells [4,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [1,VI_COMBINACOES7];
                                             STGR_VCOLUNAS_1_2.Cells [5,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [2,VI_COMBINACOES3];
                                             STGR_VCOLUNAS_1_2.Cells [6,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [2,VI_COMBINACOES4];
                                             STGR_VCOLUNAS_1_2.Cells [7,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [2,VI_COMBINACOES6];
                                             STGR_VCOLUNAS_1_2.Cells [8,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [2,VI_COMBINACOES8];
                                             VI_LINHAS2:= VI_LINHAS2 + 1;
     ...
     BEGIN
          ...
          BEGIN
               ...
               BEGIN
                    // coluna 2
                    FOR VI_COMBINACOES7:=1 TO 4 DO
                    BEGIN
                         FOR VI_COMBINACOES3:= VI_COMBINACOES7+1 TO 5 DO
                         BEGIN
                              FOR VI_COMBINACOES4:= VI_COMBINACOES3+1 TO 6 DO
                              BEGIN
                                   FOR VI_COMBINACOES6:= VI_COMBINACOES4+1 TO 6 DO
                                   BEGIN
                                        ...
                                        BEGIN
                                             ...
                                             STGR_VCOLUNAS_1_2.Cells [4,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [2,VI_COMBINACOES7];
                                             STGR_VCOLUNAS_1_2.Cells [5,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [2,VI_COMBINACOES3];
                                             STGR_VCOLUNAS_1_2.Cells [6,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [2,VI_COMBINACOES4];
                                             STGR_VCOLUNAS_1_2.Cells [7,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [2,VI_COMBINACOES6];
                                             STGR_VCOLUNAS_1_2.Cells [8,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [2,VI_COMBINACOES8];
     ...
     BEGIN
          ...
          BEGIN
               ...
               BEGIN
                    FOR VI_COMBINACOES7:= VI_COMBINACOES5+1 TO 6 DO
                    BEGIN
                         FOR VI_COMBINACOES3:= VI_COMBINACOES7+1 TO 6 DO
                         BEGIN
                              // coluna 2
                              FOR VI_COMBINACOES4:= 1 TO 4 DO
                              BEGIN
                                   FOR VI_COMBINACOES6:= VI_COMBINACOES4+1 TO 5 DO
                                   BEGIN
                                        FOR VI_COMBINACOES8:= VI_COMBINACOES6+1 TO 6 DO
                                        BEGIN
                                             STGR_VCOLUNAS_1_2.Cells [0,VI_LINHAS2] := INTtoSTR(VI_LINHAS2);
                                             ...
                                             STGR_VCOLUNAS_1_2.Cells [3,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [1,VI_COMBINACOES5];
                                             STGR_VCOLUNAS_1_2.Cells [4,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [1,VI_COMBINACOES7];
                                             STGR_VCOLUNAS_1_2.Cells [5,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [1,VI_COMBINACOES3];
                              ...
                              BEGIN
                                   ...
                                   BEGIN
                                        ...
                                        BEGIN
                                             ...
                                             STGR_VCOLUNAS_1_3.Cells [4,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [1,VI_COMBINACOES7];
                                             STGR_VCOLUNAS_1_3.Cells [5,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [3,VI_COMBINACOES3];
                                             STGR_VCOLUNAS_1_3.Cells [6,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [3,VI_COMBINACOES4];
                                             STGR_VCOLUNAS_1_3.Cells [7,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [3,VI_COMBINACOES6];
                                             STGR_VCOLUNAS_1_3.Cells [8,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [3,VI_COMBINACOES8];
                                             VI_LINHAS2:= VI_LINHAS2 + 1;
                                        end; // for VI_COMBINACOES8
                                   end; // for VI_COMBINACOES6
                              end;//FOR  VI_COMBINACOES4
                              ...
                              BEGIN
                                   ...
                                   BEGIN
                                        ...
                                        BEGIN
                                             ...
                                             STGR_VCOLUNAS_1_3.Cells [4,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [3,VI_COMBINACOES7];
                                             STGR_VCOLUNAS_1_3.Cells [5,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [3,VI_COMBINACOES3];
                                             STGR_VCOLUNAS_1_3.Cells [6,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [3,VI_COMBINACOES4];
                                             STGR_VCOLUNAS_1_3.Cells [7,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [3,VI_COMBINACOES6];
                                             STGR_VCOLUNAS_1_3.Cells [8,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [3,VI_COMBINACOES8];
                              ...
                              BEGIN
                                   ...
                                   BEGIN
                                        ...
                                        BEGIN
                                             ...
                                             STGR_VCOLUNAS_1_3.Cells [3,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [1,VI_COMBINACOES5];
                                             STGR_VCOLUNAS_1_3.Cells [4,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [1,VI_COMBINACOES7];
                                             STGR_VCOLUNAS_1_3.Cells [5,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [1,VI_COMBINACOES3];
                              ...
                              BEGIN
                                   ...
                                   BEGIN
                                        ...
                                        BEGIN
                                             ...
                                             STGR_VCOLUNAS_1_4.Cells [4,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [1,VI_COMBINACOES7];
                                             STGR_VCOLUNAS_1_4.Cells [5,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [4,VI_COMBINACOES3];
                                             STGR_VCOLUNAS_1_4.Cells [6,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [4,VI_COMBINACOES4];
                                             STGR_VCOLUNAS_1_4.Cells [7,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [4,VI_COMBINACOES6];
                                             STGR_VCOLUNAS_1_4.Cells [8,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [4,VI_COMBINACOES8];
                                             VI_LINHAS2:= VI_LINHAS2 + 1;
                                        end; // for VI_COMBINACOES8
                                   end; // for VI_COMBINACOES6
                              end;//FOR  VI_COMBINACOES4
                              ...
                              BEGIN
                                   ...
                                   BEGIN
                                        ...
                                        BEGIN
                                             ...
                                             STGR_VCOLUNAS_1_4.Cells [4,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [4,VI_COMBINACOES7];
                                             STGR_VCOLUNAS_1_4.Cells [5,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [4,VI_COMBINACOES3];
                                             STGR_VCOLUNAS_1_4.Cells [6,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [4,VI_COMBINACOES4];
                                             STGR_VCOLUNAS_1_4.Cells [7,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [4,VI_COMBINACOES6];
                                             STGR_VCOLUNAS_1_4.Cells [8,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [4,VI_COMBINACOES8];
                              ...
                              BEGIN
                                   ...
                                   BEGIN
                                        ...
                                        BEGIN
                                             ...
                                             STGR_VCOLUNAS_1_4.Cells [3,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [1,VI_COMBINACOES5];
                                             STGR_VCOLUNAS_1_4.Cells [4,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [1,VI_COMBINACOES7];
                                             STGR_VCOLUNAS_1_4.Cells [5,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [1,VI_COMBINACOES3];
                              ...
                              BEGIN
                                   ...
                                   BEGIN
                                        ...
                                        BEGIN
                                             ...
                                             STGR_VCOLUNAS_2_3.Cells [4,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [2,VI_COMBINACOES7];
                                             STGR_VCOLUNAS_2_3.Cells [5,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [3,VI_COMBINACOES3];
                                             STGR_VCOLUNAS_2_3.Cells [6,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [3,VI_COMBINACOES4];
                                             STGR_VCOLUNAS_2_3.Cells [7,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [3,VI_COMBINACOES6];
                                             STGR_VCOLUNAS_2_3.Cells [8,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [3,VI_COMBINACOES8];
                                             VI_LINHAS2:= VI_LINHAS2 + 1;
                                        end; // for VI_COMBINACOES8
                                   end; // for VI_COMBINACOES6
                              end;//FOR  VI_COMBINACOES4
                              ...
                              BEGIN
                                   ...
                                   BEGIN
                                        ...
                                        BEGIN
                                             ...
                                             STGR_VCOLUNAS_2_3.Cells [4,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [3,VI_COMBINACOES7];
                                             STGR_VCOLUNAS_2_3.Cells [5,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [3,VI_COMBINACOES3];
                                             STGR_VCOLUNAS_2_3.Cells [6,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [3,VI_COMBINACOES4];
                                             STGR_VCOLUNAS_2_3.Cells [7,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [3,VI_COMBINACOES6];
                                             STGR_VCOLUNAS_2_3.Cells [8,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [3,VI_COMBINACOES8];
                              ...
                              BEGIN
                                   ...
                                   BEGIN
                                        ...
                                        BEGIN
                                             ...
                                             STGR_VCOLUNAS_2_3.Cells [3,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [2,VI_COMBINACOES5];
                                             STGR_VCOLUNAS_2_3.Cells [4,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [2,VI_COMBINACOES7];
                                             STGR_VCOLUNAS_2_3.Cells [5,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [2,VI_COMBINACOES3];
                              ...
                              BEGIN
                                   ...
                                   BEGIN
                                        ...
                                        BEGIN
                                             ...
                                             STGR_VCOLUNAS_2_4.Cells [4,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [2,VI_COMBINACOES7];
                                             STGR_VCOLUNAS_2_4.Cells [5,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [4,VI_COMBINACOES3];
                                             STGR_VCOLUNAS_2_4.Cells [6,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [4,VI_COMBINACOES4];
                                             STGR_VCOLUNAS_2_4.Cells [7,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [4,VI_COMBINACOES6];
                                             STGR_VCOLUNAS_2_4.Cells [8,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [4,VI_COMBINACOES8];
                                             VI_LINHAS2:= VI_LINHAS2 + 1;
                                        end; // for VI_COMBINACOES8
                                   end; // for VI_COMBINACOES6
                              end;//FOR  VI_COMBINACOES4
                              ...
                              BEGIN
                                   ...
                                   BEGIN
                                        ...
                                        BEGIN
                                             ...
                                             STGR_VCOLUNAS_2_4.Cells [4,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [4,VI_COMBINACOES7];
                                             STGR_VCOLUNAS_2_4.Cells [5,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [4,VI_COMBINACOES3];
                                             STGR_VCOLUNAS_2_4.Cells [6,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [4,VI_COMBINACOES4];
                                             STGR_VCOLUNAS_2_4.Cells [7,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [4,VI_COMBINACOES6];
                                             STGR_VCOLUNAS_2_4.Cells [8,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [4,VI_COMBINACOES8];
                              ...
                              BEGIN
                                   ...
                                   BEGIN
                                        ...
                                        BEGIN
                                             ...
                                             STGR_VCOLUNAS_2_4.Cells [3,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [2,VI_COMBINACOES5];
                                             STGR_VCOLUNAS_2_4.Cells [4,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [2,VI_COMBINACOES7];
                                             STGR_VCOLUNAS_2_4.Cells [5,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [2,VI_COMBINACOES3];
                              ...
                              BEGIN
                                   ...
                                   BEGIN
                                        ...
                                        BEGIN
                                             ...
                                             STGR_VCOLUNAS_3_4.Cells [4,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [3,VI_COMBINACOES7];
                                             STGR_VCOLUNAS_3_4.Cells [5,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [4,VI_COMBINACOES3];
                                             STGR_VCOLUNAS_3_4.Cells [6,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [4,VI_COMBINACOES4];
                                             STGR_VCOLUNAS_3_4.Cells [7,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [4,VI_COMBINACOES6];
                                             STGR_VCOLUNAS_3_4.Cells [8,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [4,VI_COMBINACOES8];
                                             VI_LINHAS2:= VI_LINHAS2 + 1;
                                        end; // for VI_COMBINACOES8
                                   end; // for VI_COMBINACOES6
                              end;//FOR  VI_COMBINACOES4
                              ...
                              BEGIN
                                   ...
                                   BEGIN
                                        ...
                                        BEGIN
                                             ...
                                             STGR_VCOLUNAS_3_4.Cells [4,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [4,VI_COMBINACOES7];
                                             STGR_VCOLUNAS_3_4.Cells [5,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [4,VI_COMBINACOES3];
                                             STGR_VCOLUNAS_3_4.Cells [6,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [4,VI_COMBINACOES4];
                                             STGR_VCOLUNAS_3_4.Cells [7,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [4,VI_COMBINACOES6];
                                             STGR_VCOLUNAS_3_4.Cells [8,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [4,VI_COMBINACOES8];
                              ...
                              BEGIN
                                   ...
                                   BEGIN
                                        ...
                                        BEGIN
                                             ...
                                             STGR_VCOLUNAS_3_4.Cells [3,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [3,VI_COMBINACOES5];
                                             STGR_VCOLUNAS_3_4.Cells [4,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [3,VI_COMBINACOES7];
                                             STGR_VCOLUNAS_3_4.Cells [5,VI_LINHAS2] := STGR_BASE_SUBFILTRO_1.Cells [3,VI_COMBINACOES3];
 ...
 (*
     ...
     BEGIN
          ...
          BEGIN
               ...
               STGR_VCOLUNAS_TODAS.Cells [0,VI_LINHAS2+2] := INTtoSTR(VI_LINHAS2+2);                        
     ...
     STGR_VCOLUNAS_TODAS.RowCount := VI_LINHAS2;
            ...
            SELF.IBQ_COMBINACOES.SQL.Clear;
            SELF.IBQ_COMBINACOES.SQL.Add('DELETE FROM FILTRO_0008EXC1_DEFINICAO')  ;
            SELF.IBQ_COMBINACOES.ExecSQL;
            SELF.IBQ_COMBINACOES.SQL.Clear;
            SELF.IBQ_COMBINACOES.SQL.Add('DELETE FROM FILTRO_0008EXC1_DADOS')  ;
            SELF.IBQ_COMBINACOES.ExecSQL;
            SELF.IBQ_COMBINACOES.SQL.Clear;
            SELF.IBQ_COMBINACOES.SQL.Add('COMMIT')  ;
            SELF.IBQ_COMBINACOES.ExecSQL;
            SELF.IBQ_COMBINACOES.SQL.Clear;
            SELF.IBQ_COMBINACOES.SQL.Add('SELECT * FROM FILTRO_0008EXC1_DEFINICAO; ')  ;
            SELF.IBQ_COMBINACOES.Open;
            SELF.IBQ_COMBINACOES.SQL.Clear;
            SELF.IBQ_COMBINACOES.SQL.Add('UPDATE FILTRO_0008EXC1_DEFINICAO SET FLAG_FILTRAR =''N'', FLAG_GRAVAR= ''N'';')  ;
            SELF.IBQ_COMBINACOES.ExecSQL;
...
procedure T_F_FILTRO_08_NS1_16_v1.BT_NOVA_SIMULACAOClick(Sender: TObject);
begin
...
PROCEDURE T_F_FILTRO_08_NS1_16_v1.PR_BOTOES_MODELO_12345 (VI_NUMERO: INTEGER);
VAR
...
PROCEDURE T_F_FILTRO_08_NS1_16_v1.PR_BOTOES_MODELO_1234 (VI_NUMERO: INTEGER);
VAR
...
procedure T_F_FILTRO_08_NS1_16_v1.BBT_701Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(1);
    BBT_701.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_702Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(2);
    BBT_702.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_703Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(3);
    BBT_703.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_704Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(4);
    BBT_704.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_705Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(5);
    BBT_705.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_706Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(6);
    BBT_706.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_707Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(7);
    BBT_707.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_708Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(8);
    BBT_708.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_710Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(10);
    BBT_710.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_709Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(9);
    BBT_709.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_711Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(11);
    BBT_711.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_712Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(12);
    BBT_712.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_713Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(13);
    BBT_713.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_714Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(14);
    BBT_714.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_715Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(15);
    BBT_715.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_716Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(16);
    BBT_716.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_717Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(17);
    BBT_717.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_718Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(18);
    BBT_718.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_719Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(19);
    BBT_719.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_720Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(20);
    BBT_720.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_721Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(21);
    BBT_721.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_722Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(22);
    BBT_722.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_723Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(23);
    BBT_723.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_724Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_12345(24);
    BBT_724.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_725Click(Sender: TObject);
begin
...
procedure T_F_FILTRO_08_NS1_16_v1.BBT_GERAR_MENUClick(Sender: TObject);
begin
    {IF (STRtoINT(STGR_BASE_L4.Cells [5,0] ) =0) THEN
    BEGIN
       SHOWMESSAGE ('TERMINE O PREENCHIMENTO.');
...
procedure T_F_FILTRO_08_NS1_16_v1.BBT_GERARClick(Sender: TObject);
var
     ...
     Vsi_COMB12_1, Vsi_COMB12_2, Vsi_COMB12_3, Vsi_COMB12_4, Vsi_COMB12_5, Vsi_COMB12_6, Vsi_COMB12_7, Vsi_COMB12_8, Vsi_COMB12_9, Vsi_COMB12_0, Vsi_COMB12_A, Vsi_COMB12_B, Vsi_COMB12_C, VI_LINHAS12: SMALLINT;
    ...
    BEGIN
        ...
        BEGIN
            ...
            VC_DADOS4 := RIGHTSTR ('0'+STGR_BASE_L4.Cells[1,0],2) + ' ' + RIGHTSTR ('0'+STGR_BASE_L4.Cells[2,0],2) + ' '  + RIGHTSTR ('0'+STGR_BASE_L4.Cells[3,0],2) + ' '  + RIGHTSTR ('0'+STGR_BASE_L4.Cells[4,0],2) + ' '  + RIGHTSTR ('0'+STGR_BASE_L4.Cells[5,0],2) + ' '  + RIGHTSTR ('0'+STGR_BASE_L4.Cells[6,0],2);
                SELF.IBQ_COMBINACOES.SQL.Clear;
            VC_QUERY  := 'INSERT INTO FILTRO_0008EXC1_DEFINICAO (LINHA_1, LINHA_2, LINHA_3, LINHA_4, SOMA_COL_1_INI, SOMA_COL_1_FINAL,';
            VC_QUERY  := VC_QUERY +' EXC_1, EXC_2, EXC_3, CONTADOR_C1, TOTAL_CONTADOR_C1, ';
            VC_QUERY  := VC_QUERY +' EXC_OBR_1, EXC_OBR_2, EXC_OBR_3, EXC_OBR_4, EXC_OBR_5, DATA_DEFINICAO, HORA_DEFINICAO, SOMA_12N_INI, SOMA_12N_FINAL, QTD_DADOS) VALUES('+#39+ VC_DADOS1 + #39 +','  +#39+ VC_DADOS2 + #39 +','  +#39+ VC_DADOS3 + #39 +','  +#39+ VC_DADOS4;
        ...
        BEGIN  }
           ...
           // SHOWMESSAGE ('DADOS-1 -> Gerar o Banco de Dados');
            ...
            BEGIN
                ...
                VC_QUERY  := 'INSERT INTO FILTRO_0008EXC1_DADOS_temp (EXC1, EXC2, EXC3, EXC4, EXC5, EXC6, EXC7, EXC8, EXC9, DADOS, DADOS16,'
            ...
            END;
            SELF.IBQ_COMBINACOES.SQL.Clear;
            VC_QUERY  := 'UPDATE FILTRO_0008EXC1_DEFINICAO SET CONTADOR_C1 =' + #39+ INTtoSTR(VI_COMBINACOES_C1) +#39+';';
            SELF.IBQ_COMBINACOES.SQL.Add(VC_QUERY)  ;
            SELF.IBQ_COMBINACOES.ExecSQL;
                  SELF.IBQ_COMBINACOES.SQL.Clear;
                  SELF.IBQ_COMBINACOES.SQL.Add('COMMIT')  ;
            ...
            STGR_COMB10.RowCount := VI_LINHAS2;
             SELF.IBQ_COMBINACOES.SQL.Clear;
               ...
               BEGIN
                    ...
                    SELF.IBQ_COMBINACOES.ExecSQL;
                    SELF.IBQ_COMBINACOES.SQL.Clear;
                    SELF.IBQ_COMBINACOES.SQL.Add('execute procedure FILTRO_0_08EXC1_DADOS_100REPET' )  ;
                    SELF.IBQ_COMBINACOES.ExecSQL;
                    SELF.IBQ_COMBINACOES.SQL.Clear;
                    SELF.IBQ_COMBINACOES.SQL.Add('DELETE FROM FILTRO_0008EXC1_DADOS_temp')  ;
                    SELF.IBQ_COMBINACOES.ExecSQL;
                       SELF.IBQ_COMBINACOES.SQL.Clear;
                       SELF.IBQ_COMBINACOES.SQL.Add('COMMIT')  ;
                       SELF.IBQ_COMBINACOES.ExecSQL;
...
BEGIN
          ...
          BEGIN
               ...
               BEGIN
                    ...
                    BEGIN
                         ...
                         STGR_BASE_SOMA1.Cells[3,1] := STGR_LINHA_2_C1.Cells[2,VI_COMBINACOES2];
                         STGR_BASE_SOMA1.Cells[4,1] := STGR_LINHA_2_C1.Cells[3,VI_COMBINACOES2];
                         STGR_BASE_SOMA1.Cells[5,1] := STGR_LINHA_3_C1.Cells[2,VsI_COMBINACOES3];
                         STGR_BASE_SOMA1.Cells[6,1] := STGR_LINHA_3_C1.Cells[3,VsI_COMBINACOES3];
                         STGR_BASE_SOMA1.Cells[7,1] := STGR_LINHA_4_C1.Cells[2,VsI_COMBINACOES4];
                         STGR_BASE_SOMA1.Cells[8,1] := STGR_LINHA_4_C1.Cells[3,VsI_COMBINACOES4];
                         ...
                         STGR_BASE_SOMA12_1.Cells[4,1] := STGR_LINHA_1_C2.Cells[5,VI_COMBINACOES1];
                         STGR_BASE_SOMA12_1.Cells[5,1] := STGR_LINHA_2_C2.Cells[2,VI_COMBINACOES2];
                         STGR_BASE_SOMA12_1.Cells[6,1] := STGR_LINHA_2_C2.Cells[3,VI_COMBINACOES2];
                         STGR_BASE_SOMA12_1.Cells[7,1] := STGR_LINHA_2_C2.Cells[4,VI_COMBINACOES2];
                         STGR_BASE_SOMA12_1.Cells[8,1] := STGR_LINHA_2_C2.Cells[5,VI_COMBINACOES2];
                         STGR_BASE_SOMA12_1.Cells[9,1] := STGR_LINHA_3_C2.Cells[2,VsI_COMBINACOES3];
                         STGR_BASE_SOMA12_1.Cells[10,1] := STGR_LINHA_3_C2.Cells[3,VsI_COMBINACOES3];
                         STGR_BASE_SOMA12_1.Cells[11,1] := STGR_LINHA_3_C2.Cells[4,VsI_COMBINACOES3];
                         STGR_BASE_SOMA12_1.Cells[12,1] := STGR_LINHA_3_C2.Cells[5,VsI_COMBINACOES3];
                         STGR_BASE_SOMA12_1.Cells[13,1] := STGR_LINHA_4_C2.Cells[2,VsI_COMBINACOES4];
                         STGR_BASE_SOMA12_1.Cells[14,1] := STGR_LINHA_4_C2.Cells[3,VsI_COMBINACOES4];
                         STGR_BASE_SOMA12_1.Cells[15,1] := STGR_LINHA_4_C2.Cells[4,VsI_COMBINACOES4];
                         STGR_BASE_SOMA12_1.Cells[16,1] := STGR_LINHA_4_C2.Cells[5,VsI_COMBINACOES4];
                         // --------------------------------------------------------------
                         // --  MONTANDO AS COMBINAÇÕES POSSÍVEL PARA REALIZAR A SOMA 6 --
                         // --------------------------------------------------------------
                         VI_LINHAS7 := 1;
                         ...
                         IF (STGR_BASE_SOMA2.Cells[1,0] = 'F') THEN
                              CONTINUE;
                         // ---------------------------------------------------------------
                         // --  MONTANDO AS COMBINAÇÕES POSSÍVEL PARA REALIZAR A SOMA 13 --
                         // ---------------------------------------------------------------
                         VI_LINHAS12 := 1;
                         ...
                         STGR_COMB10.Cells[4,VI_LINHAS2] := STGR_LINHA_2_C1.Cells[2,VI_COMBINACOES2];
                         STGR_COMB10.Cells[5,VI_LINHAS2] := STGR_LINHA_2_C1.Cells[3,VI_COMBINACOES2];
                         STGR_COMB10.Cells[6,VI_LINHAS2] := STGR_LINHA_3_C1.Cells[2,VsI_COMBINACOES3];
                         STGR_COMB10.Cells[7,VI_LINHAS2] := STGR_LINHA_3_C1.Cells[3,VsI_COMBINACOES3];
                         STGR_COMB10.Cells[8,VI_LINHAS2] := STGR_LINHA_4_C1.Cells[2,VsI_COMBINACOES4];
                         STGR_COMB10.Cells[9,VI_LINHAS2] := STGR_LINHA_4_C1.Cells[3,VsI_COMBINACOES4];
                         STGR_COMB10.Cells[10,VI_LINHAS2] := ED_fixoS_1.Text;                         
                             ...
                             STGR_COMB15.Cells[5,VI_LINHAS2]  := STGR_LINHA_1_C2.Cells[5,VI_COMBINACOES1];
                             STGR_COMB15.Cells[6,VI_LINHAS2]  := STGR_LINHA_2_C2.Cells[2,VI_COMBINACOES2];
                             STGR_COMB15.Cells[7,VI_LINHAS2]  := STGR_LINHA_2_C2.Cells[3,VI_COMBINACOES2];
                             STGR_COMB15.Cells[8,VI_LINHAS2]  := STGR_LINHA_2_C2.Cells[4,VI_COMBINACOES2];
                             STGR_COMB15.Cells[9,VI_LINHAS2]  := STGR_LINHA_2_C2.Cells[5,VI_COMBINACOES2];
                             STGR_COMB15.Cells[10,VI_LINHAS2] := STGR_LINHA_3_C2.Cells[2,VsI_COMBINACOES3];
                             STGR_COMB15.Cells[11,VI_LINHAS2] := STGR_LINHA_3_C2.Cells[3,VsI_COMBINACOES3];
                             STGR_COMB15.Cells[12,VI_LINHAS2] := STGR_LINHA_3_C2.Cells[4,VsI_COMBINACOES3];
                             STGR_COMB15.Cells[13,VI_LINHAS2] := STGR_LINHA_3_C2.Cells[5,VsI_COMBINACOES3];
                             STGR_COMB15.Cells[14,VI_LINHAS2] := STGR_LINHA_4_C2.Cells[2,VsI_COMBINACOES4];
                             STGR_COMB15.Cells[15,VI_LINHAS2] := STGR_LINHA_4_C2.Cells[3,VsI_COMBINACOES4];
                             STGR_COMB15.Cells[16,VI_LINHAS2] := STGR_LINHA_4_C2.Cells[4,VsI_COMBINACOES4];
                             STGR_COMB15.Cells[17,VI_LINHAS2] := STGR_LINHA_4_C2.Cells[5,VsI_COMBINACOES4];


                             PR_ORDENAR_SIMULACAO_10 (VI_LINHAS2);
                             PR_ORDENAR_SIMULACAO_15 (VI_LINHAS2);
                             // *********************************************
                             // CONFERE SOMA 8º E 9º NÚMERO
                             // *********************************************
    ...
    { PR_GRAVAR_DADOS ('FIM', VI_LINHAS2, VI_COMBINACOES01, TRUNC(STGR_LINHA_1_C1.RowCount-1));  }
     ...
     SELF.PR_SIMULAR_RECUPERANDODADOS('');
                   SELF.IBQ_COMBINACOES.SQL.Clear;
               SELF.IBQ_COMBINACOES.SQL.Add('SELECT COUNT(distinct(dados)) AS SOMADADOS FROM FILTRO_0008EXC1_DADOS;')  ;
               SELF.IBQ_COMBINACOES.Open;
               IBQ_COMBINACOES.First;
               VI_CONTAR_COMB1 := IBQ_COMBINACOES.FIELDBYNAME('SOMADADOS').AsInteger;
            SELF.IBQ_COMBINACOES.SQL.Clear;
            SELF.IBQ_COMBINACOES.SQL.Add('UPDATE FILTRO_0008EXC1_DEFINICAO SET HORA_TERMINO ='''+FORMATDATETIME('h:n:s',time())+''', QTD_DADOS= ''' +INTtoSTR(VI_CONTAR_COMB1)+ ''';')  ;
            SELF.IBQ_COMBINACOES.ExecSQL;
            SELF.IBQ_COMBINACOES.SQL.Clear;
            SELF.IBQ_COMBINACOES.SQL.Add('COMMIT')  ;
            SELF.IBQ_COMBINACOES.ExecSQL;
     ...
     LA_gFIM_100REPET.Caption := DATEtoSTR(DATE())+ ' - '+ TIMEtoSTR(TIME()) ;
            SELF.IBQ_COMBINACOES.SQL.Clear;
            SELF.IBQ_COMBINACOES.SQL.Add('UPDATE FILTRO_0008EXC1_DEFINICAO SET FLAG_FILTRAR =''S'', FLAG_GRAVAR= ''S'';')  ;
            SELF.IBQ_COMBINACOES.ExecSQL;
            SELF.IBQ_COMBINACOES.SQL.Clear;
            SELF.IBQ_COMBINACOES.SQL.Add('COMMIT')  ;
            SELF.IBQ_COMBINACOES.ExecSQL;
...
PROCEDURE T_F_FILTRO_08_NS1_16_v1.PR_LIMPAR_GRID10 ();
BEGIN
...
PROCEDURE T_F_FILTRO_08_NS1_16_v1.PR_SIMULAR_RECUPERANDODADOS(VC_TIPO: STRING);
VAR
...
BEGIN
       ...
       SELF.IBQ_COMBINACOES.SQL.Clear;
       SELF.IBQ_COMBINACOES.SQL.Add('SELECT DISTINCT(DADOS), EXC1, EXC2, EXC3, EXC4, EXC5, EXC6, EXC7, EXC8, EXC9, N01, N02, N03, N04, N05, N06, N07, N08, N09, N10, N11, N12, N13, N14, N15, N16  FROM FILTRO_0008EXC1_DADOS  ORDER BY DADOS;')  ;
       SELF.IBQ_COMBINACOES.Open;
...
procedure T_F_FILTRO_08_NS1_16_v1.BBT_GERAR_SAIRClick(Sender: TObject);
begin
     SELF.Close;
end;
...
procedure T_F_FILTRO_08_NS1_16_v1.BBT_PA_REMOVEUREPETClick(Sender: TObject);
begin
     PA_REMOVEUREPET.Left := 5000;
...
procedure T_F_FILTRO_08_NS1_16_v1.BT_CARREGAR_SIMULACAOClick(Sender: TObject);
begin
     SELF.PR_LIMPAR_GRID10();
     BBT_RECOMECAR.Click;
     PA_PREENCHIMENTO.Visible := false;
...
procedure T_F_FILTRO_08_NS1_16_v1.RB_RESULTADOSClick(Sender: TObject);
begin
     SCBX_GABARITO.Visible := false;
     PA_RESULTADO.Visible  := TRUE;
end;
...
procedure T_F_FILTRO_08_NS1_16_v1.BBT_101Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_1234 (1);
    BBT_101.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_102Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_1234(2);
    BBT_102.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_103Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_1234(3);
    BBT_103.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_104Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_1234(4);
    BBT_104.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_105Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_1234(5);
    BBT_105.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_106Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_1234(6);
    BBT_106.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_107Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_1234(7);
    BBT_107.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_108Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_1234(8);
    BBT_108.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_110Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_1234(10);
    BBT_110.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_109Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_1234(9);
    BBT_109.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_111Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_1234(11);
    BBT_111.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_112Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_1234(12);
    BBT_112.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_113Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_1234(13);
    BBT_113.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_114Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_1234(14);
    BBT_114.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_115Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_1234(15);
    BBT_115.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_116Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_1234(16);
    BBT_116.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_117Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_1234(17);
    BBT_117.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_118Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_1234(18);
    BBT_118.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_119Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_1234(19);
    BBT_119.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_120Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_1234(20);
    BBT_120.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_121Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_1234(21);
    BBT_121.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_122Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_1234(22);
    BBT_122.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_123Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_1234(23);
    BBT_123.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_124Click(Sender: TObject);
begin
    SELF.PR_BOTOES_MODELO_1234(24);
    BBT_124.Enabled := FALSE;
end;

procedure T_F_FILTRO_08_NS1_16_v1.BBT_125Click(Sender: TObject);
begin
...
procedure T_F_FILTRO_08_NS1_16_v1.BBT_BLOCO_NOTASClick(Sender: TObject);
var
    VI_AN_COMB1, VI_CONTAR : INTEGER;
...
procedure T_F_FILTRO_08_NS1_16_v1.BBT_PREPARAR_MENUClick(Sender: TObject);
begin
...
procedure T_F_FILTRO_08_NS1_16_v1.BitBtn2Click(Sender: TObject);
begin
     PA_PREPARAR.Visible := false;
     PA_PREPARAR.Enabled := false;
     PA_PREPARAR.Top  := 245;         
...
procedure T_F_FILTRO_08_NS1_16_v1.BBT_GERAR_VOLTARClick(Sender: TObject);
begin
     PA_GERAR.Visible := false;
     PA_GERAR.Enabled := false;
     PA_GERAR.Left := 4500;
...
procedure T_F_FILTRO_08_NS1_16_v1.CB_SOMATORIA_8_NumerosBaseChange(
  Sender: TObject);
begin
     CASE CB_SOMATORIA_8_NumerosBase.ItemIndex OF
          0:
